...
/**
 * Main controller class. Uses a pseudo-JavaBeans paradigm. The only real logic
 * here is listener registration.
 * 
 * TODO: Preview mode TODO: Command transactions TODO: Add ability to flash
 * selection
 * 
 * @author yetanotherx
...
public class WorldEditCUI {
	...
	public void initialise(MinecraftClient minecraft) {
		...
		this.chunkBorderRenderer = new RenderChunkBoundary(ConfiguredColour.CHUNKBOUNDARY.style(),
				ConfiguredColour.CHUNKGRID.style(), minecraft);
	}
