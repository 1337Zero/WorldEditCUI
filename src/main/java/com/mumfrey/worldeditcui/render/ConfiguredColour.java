...
public enum ConfiguredColour {
	...
	public String getDisplayName() {		
		...
		return CUIConfiguration.instance.getColourName(this.displayName);
	}
	...
	private void updateLines() {
		this.normal = new LineStyle(RenderType.VISIBLE, 3.0f, this.colour.red(), this.colour.green(),
				this.colour.blue(), this.colour.alpha());
		this.hidden = new LineStyle(RenderType.HIDDEN, 3.0f, this.colour.red() * 0.75F, this.colour.green() * 0.75F,
