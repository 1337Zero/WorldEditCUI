...
public class CylinderRegion extends Region {
	...
	public CylinderRegion(WorldEditCUI controller) {
		super(controller, ConfiguredColour.CYLINDERBOX.style(), ConfiguredColour.CYLINDERGRID.style(),
				ConfiguredColour.CYLINDERCENTRE.style());
	}

	@Override
	public void render(Vector3 cameraPos, float partialTicks) {
		System.out.println("render CylinderRegion");
		if (this.centre != null) {
