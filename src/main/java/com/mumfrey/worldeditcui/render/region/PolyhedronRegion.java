...
public class PolyhedronRegion extends Region {
	...
	public PolyhedronRegion(WorldEditCUI controller) {
		super(controller, ConfiguredColour.POLYBOX.style(), ConfiguredColour.POLYPOINT.style(),
				ConfiguredColour.CUBOIDPOINT1.style());
	}

	@Override
	public void render(Vector3 cameraPos, float partialTicks) {
		System.out.println("render polyhederon");
