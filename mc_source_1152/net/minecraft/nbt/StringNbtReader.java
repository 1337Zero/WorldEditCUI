...
public class StringNbtReader {
   ...
   public static final Dynamic2CommandExceptionType LIST_MIXED = new Dynamic2CommandExceptionType((object, object2) -> {
      return new TranslatableText("argument.nbt.list.mixed", new Object[]{object, object2});
   });
   public static final Dynamic2CommandExceptionType ARRAY_MIXED = new Dynamic2CommandExceptionType((object, object2) -> {
      return new TranslatableText("argument.nbt.array.mixed", new Object[]{object, object2});
   });
   public static final DynamicCommandExceptionType ARRAY_INVALID = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("argument.nbt.array.invalid", new Object[]{object});
   });
