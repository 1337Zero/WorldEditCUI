...
public class EntitySelector {
   ...
   public List<? extends Entity> getEntities(ServerCommandSource serverCommandSource) throws CommandSyntaxException {
      ...
      if (!this.includesNonPlayers) {
         ...
         return (List)(serverPlayerEntity == null ? Collections.emptyList() : Lists.newArrayList(new ServerPlayerEntity[]{serverPlayerEntity}));
         ...
         if (this.senderOnly) {
            return (List)(serverCommandSource.getEntity() != null && predicate.test(serverCommandSource.getEntity()) ? Lists.newArrayList(new Entity[]{serverCommandSource.getEntity()}) : Collections.emptyList());
         } else {
   ...
   public List<ServerPlayerEntity> getPlayers(ServerCommandSource serverCommandSource) throws CommandSyntaxException {
      ...
      if (this.playerName != null) {
         ...
         return (List)(serverPlayerEntity2 == null ? Collections.emptyList() : Lists.newArrayList(new ServerPlayerEntity[]{serverPlayerEntity2}));
      } else if (this.uuid != null) {
