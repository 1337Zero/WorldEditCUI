...
public class EntitySelectorReader {
   ...
   private static void suggestSelector(SuggestionsBuilder builder) {
      builder.suggest("@p", new TranslatableText("argument.entity.selector.nearestPlayer", new Object[0]));
      builder.suggest("@a", new TranslatableText("argument.entity.selector.allPlayers", new Object[0]));
      builder.suggest("@r", new TranslatableText("argument.entity.selector.randomPlayer", new Object[0]));
      builder.suggest("@s", new TranslatableText("argument.entity.selector.self", new Object[0]));
      builder.suggest("@e", new TranslatableText("argument.entity.selector.allEntities", new Object[0]));
   }
