...
public class EntitySelectorOptions {
   ...
   public static void register() {
      if (options.isEmpty()) {
         putOption("name", (entitySelectorReader) -> {
            ...
            if (entitySelectorReader.excludesName() && !bl) {
               ...
               entitySelectorReader.setPredicate((entity) -> {
                  return entity.getName().asString().equals(string) != bl;
               });
            }
         }, (entitySelectorReader) -> {
            return !entitySelectorReader.selectsName();
         }, new TranslatableText("argument.entity.options.name.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.distance.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.level.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.x.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.y.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.z.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.dx.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.dy.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.dz.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.x_rotation.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.y_rotation.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.limit.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.sort.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.gamemode.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.team.description", new Object[0]));
         putOption("type", (entitySelectorReader) -> {
            ...
            if (entitySelectorReader.excludesEntityType() && !bl) {
               ...
               if (entitySelectorReader.readTagCharacter()) {
                  ...
                  entitySelectorReader.setPredicate((entity) -> {
                     return tag.contains(entity.getType()) != bl;
                  });
               } else {
                  identifier = Identifier.fromCommandInput(entitySelectorReader.getReader());
         ...
         }, new TranslatableText("argument.entity.options.type.description", new Object[0]));
         putOption("tag", (entitySelectorReader) -> {
            ...
            return true;
         }, new TranslatableText("argument.entity.options.tag.description", new Object[0]));
         putOption("nbt", (entitySelectorReader) -> {
            ...
            return true;
         }, new TranslatableText("argument.entity.options.nbt.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.scores.description", new Object[0]));
         ...
         }, new TranslatableText("argument.entity.options.advancements.description", new Object[0]));
         putOption("predicate", (entitySelectorReader) -> {
            ...
            entitySelectorReader.setPredicate((entity) -> {
               if (!(entity.world instanceof ServerWorld)) {
                  ...
                  if (lootCondition == null) {
                     ...
                     LootContext lootContext = (new LootContext.Builder(serverWorld)).put(LootContextParameters.THIS_ENTITY, entity).put(LootContextParameters.POSITION, new BlockPos(entity)).build(LootContextTypes.SELECTOR);
            ...
            return true;
         }, new TranslatableText("argument.entity.options.predicate.description", new Object[0]));
      }
   }
