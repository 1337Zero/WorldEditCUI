...
public class TimeArgumentType implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType INVALID_COUNT_EXCEPTION = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("argument.time.invalid_tick_count", new Object[]{object});
   });
