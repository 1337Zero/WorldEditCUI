...
public class ArgumentTypes {
   ...
   public static <T extends ArgumentType<?>> void register(String string, Class<T> var1, ArgumentSerializer<T> argumentSerializer) {
      Identifier identifier = new Identifier(string);
      if (classMap.containsKey(var1)) {
         ...
         ArgumentTypes.Entry<T> entry = new ArgumentTypes.Entry(var1, argumentSerializer, identifier);
         classMap.put(var1, entry);
   ...
   static class Entry<T extends ArgumentType<?>> {
      ...
      private Entry(Class<T> var1, ArgumentSerializer<T> argumentSerializer, Identifier identifier) {
         this.argClass = var1;
