...
public class ScoreboardSlotArgumentType implements ArgumentType<Integer> {
   ...
   public static final DynamicCommandExceptionType INVALID_SLOT_EXCEPTION = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("argument.scoreboardDisplaySlot.invalid", new Object[]{object});
   });
