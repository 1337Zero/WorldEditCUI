...
public class ItemStringReader {
   ...
   private CompletableFuture<Suggestions> suggestTag(SuggestionsBuilder suggestionsBuilder) {
      return CommandSource.suggestIdentifiers((Iterable)ItemTags.getContainer().getKeys(), suggestionsBuilder.createOffset(this.cursor));
   }
   ...
   public CompletableFuture<Suggestions> getSuggestions(SuggestionsBuilder builder) {
      return (CompletableFuture)this.suggestions.apply(builder.createOffset(this.reader.getCursor()));
   }
}
