...
public class TextArgumentType implements ArgumentType<Text> {
   ...
   public static final DynamicCommandExceptionType INVALID_COMPONENT_EXCEPTION = new DynamicCommandExceptionType((object) -> {
      return new TranslatableText("argument.component.invalid", new Object[]{object});
   });
