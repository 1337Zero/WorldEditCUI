...
public class CommandSyntaxProvider implements DataProvider {
   ...
   public void run(DataCache dataCache) throws IOException {
      ...
      MinecraftServer minecraftServer = new MinecraftDedicatedServer(file, serverPropertiesLoader, Schemas.getFixer(), yggdrasilAuthenticationService, minecraftSessionService, gameProfileRepository, userCache, WorldGenerationProgressLogger::new, serverPropertiesLoader.getPropertiesHandler().levelName);
      ...
      DataProvider.writeToPath(GSON, dataCache, ArgumentTypes.toJson((CommandDispatcher)commandDispatcher, (CommandNode)commandDispatcher.getRoot()), path);
   }
