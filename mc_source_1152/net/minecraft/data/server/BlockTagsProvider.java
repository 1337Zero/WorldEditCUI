...
public class BlockTagsProvider extends AbstractTagProvider<Block> {
   ...
   protected void configure() {
      ...
      this.getOrCreateTagBuilder(BlockTags.PLANKS).add((Object[])(Blocks.OAK_PLANKS, Blocks.SPRUCE_PLANKS, Blocks.BIRCH_PLANKS, Blocks.JUNGLE_PLANKS, Blocks.ACACIA_PLANKS, Blocks.DARK_OAK_PLANKS));
      ...
      this.getOrCreateTagBuilder(BlockTags.WOODEN_BUTTONS).add((Object[])(Blocks.OAK_BUTTON, Blocks.SPRUCE_BUTTON, Blocks.BIRCH_BUTTON, Blocks.JUNGLE_BUTTON, Blocks.ACACIA_BUTTON, Blocks.DARK_OAK_BUTTON));
      this.getOrCreateTagBuilder(BlockTags.BUTTONS).add(BlockTags.WOODEN_BUTTONS).add((Object)Blocks.STONE_BUTTON);
      ...
      this.getOrCreateTagBuilder(BlockTags.WOODEN_DOORS).add((Object[])(Blocks.OAK_DOOR, Blocks.SPRUCE_DOOR, Blocks.BIRCH_DOOR, Blocks.JUNGLE_DOOR, Blocks.ACACIA_DOOR, Blocks.DARK_OAK_DOOR));
      this.getOrCreateTagBuilder(BlockTags.WOODEN_STAIRS).add((Object[])(Blocks.OAK_STAIRS, Blocks.SPRUCE_STAIRS, Blocks.BIRCH_STAIRS, Blocks.JUNGLE_STAIRS, Blocks.ACACIA_STAIRS, Blocks.DARK_OAK_STAIRS));
      this.getOrCreateTagBuilder(BlockTags.WOODEN_SLABS).add((Object[])(Blocks.OAK_SLAB, Blocks.SPRUCE_SLAB, Blocks.BIRCH_SLAB, Blocks.JUNGLE_SLAB, Blocks.ACACIA_SLAB, Blocks.DARK_OAK_SLAB));
      this.getOrCreateTagBuilder(BlockTags.WOODEN_FENCES).add((Object[])(Blocks.OAK_FENCE, Blocks.ACACIA_FENCE, Blocks.DARK_OAK_FENCE, Blocks.SPRUCE_FENCE, Blocks.BIRCH_FENCE, Blocks.JUNGLE_FENCE));
      this.getOrCreateTagBuilder(BlockTags.DOORS).add(BlockTags.WOODEN_DOORS).add((Object)Blocks.IRON_DOOR);
      ...
      this.getOrCreateTagBuilder(BlockTags.LOGS).add(BlockTags.DARK_OAK_LOGS).add(BlockTags.OAK_LOGS).add(BlockTags.ACACIA_LOGS).add(BlockTags.BIRCH_LOGS).add(BlockTags.JUNGLE_LOGS).add(BlockTags.SPRUCE_LOGS);
      ...
      this.getOrCreateTagBuilder(BlockTags.CORALS).add(BlockTags.CORAL_PLANTS).add((Object[])(Blocks.TUBE_CORAL_FAN, Blocks.BRAIN_CORAL_FAN, Blocks.BUBBLE_CORAL_FAN, Blocks.FIRE_CORAL_FAN, Blocks.HORN_CORAL_FAN));
      ...
      this.getOrCreateTagBuilder(BlockTags.WOODEN_TRAPDOORS).add((Object[])(Blocks.ACACIA_TRAPDOOR, Blocks.BIRCH_TRAPDOOR, Blocks.DARK_OAK_TRAPDOOR, Blocks.JUNGLE_TRAPDOOR, Blocks.OAK_TRAPDOOR, Blocks.SPRUCE_TRAPDOOR));
      this.getOrCreateTagBuilder(BlockTags.TRAPDOORS).add(BlockTags.WOODEN_TRAPDOORS).add((Object)Blocks.IRON_TRAPDOOR);
      this.getOrCreateTagBuilder(BlockTags.UNDERWATER_BONEMEALS).add((Object)Blocks.SEAGRASS).add(BlockTags.CORALS).add(BlockTags.WALL_CORALS);
      this.getOrCreateTagBuilder(BlockTags.BAMBOO_PLANTABLE_ON).add((Object)Blocks.BAMBOO).add((Object)Blocks.BAMBOO_SAPLING).add((Object)Blocks.GRAVEL).add(BlockTags.SAND).add((Object)Blocks.DIRT).add((Object)Blocks.GRASS_BLOCK).add((Object)Blocks.PODZOL).add((Object)Blocks.COARSE_DIRT).add((Object)Blocks.MYCELIUM);
      this.getOrCreateTagBuilder(BlockTags.STANDING_SIGNS).add((Object[])(Blocks.OAK_SIGN, Blocks.SPRUCE_SIGN, Blocks.BIRCH_SIGN, Blocks.ACACIA_SIGN, Blocks.JUNGLE_SIGN, Blocks.DARK_OAK_SIGN));
      this.getOrCreateTagBuilder(BlockTags.WALL_SIGNS).add((Object[])(Blocks.OAK_WALL_SIGN, Blocks.SPRUCE_WALL_SIGN, Blocks.BIRCH_WALL_SIGN, Blocks.ACACIA_WALL_SIGN, Blocks.JUNGLE_WALL_SIGN, Blocks.DARK_OAK_WALL_SIGN));
      ...
      this.getOrCreateTagBuilder(BlockTags.FENCES).add(BlockTags.WOODEN_FENCES).add((Object)Blocks.NETHER_BRICK_FENCE);
      ...
      this.getOrCreateTagBuilder(BlockTags.BEE_GROWABLES).add(BlockTags.CROPS).add((Object)Blocks.SWEET_BERRY_BUSH);
