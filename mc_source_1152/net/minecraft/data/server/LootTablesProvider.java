...
public class LootTablesProvider implements DataProvider {
   ...
   public LootTablesProvider(DataGenerator dataGenerator) {
      this.lootTypeGenerators = ImmutableList.of(Pair.of(FishingLootTableGenerator::new, LootContextTypes.FISHING), Pair.of(ChestLootTableGenerator::new, LootContextTypes.CHEST), Pair.of(EntityLootTableGenerator::new, LootContextTypes.ENTITY), Pair.of(BlockLootTableGenerator::new, LootContextTypes.BLOCK), Pair.of(GiftLootTableGenerator::new, LootContextTypes.GIFT));
