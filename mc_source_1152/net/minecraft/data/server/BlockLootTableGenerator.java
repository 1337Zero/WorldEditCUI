...
public class BlockLootTableGenerator implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
   ...
   private static LootTable.Builder create(ItemConvertible itemConvertible) {
      return LootTable.builder().withPool((LootPool.Builder)addSurvivesExplosionLootCondition(itemConvertible, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(itemConvertible))));
   }

   private static LootTable.Builder create(Block block, LootCondition.Builder conditionBuilder, LootEntry.Builder<?> child) {
      return LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(((LeafEntry.Builder)ItemEntry.builder(block).withCondition(conditionBuilder)).withChild(child)));
   }
   ...
   private static LootTable.Builder create(ItemConvertible itemConvertible, LootTableRange count) {
      return LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder)addExplosionDecayLootFunction(itemConvertible, ItemEntry.builder(itemConvertible).withFunction(SetCountLootFunction.builder(count)))));
   }
   ...
   private static LootTable.Builder createForBlockWithItemDrops(Block block, ItemConvertible lootWithoutSilkTouch, LootTableRange count) {
      return createForNeedingSilkTouch(block, (LootEntry.Builder)addExplosionDecayLootFunction(block, ItemEntry.builder(lootWithoutSilkTouch).withFunction(SetCountLootFunction.builder(count))));
   }
   ...
   private static <T extends Comparable<T> & StringIdentifiable> LootTable.Builder createForMultiblock(Block block, Property<T> property, T comparable) {
      return LootTable.builder().withPool((LootPool.Builder)addSurvivesExplosionLootCondition(block, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(block).withCondition(BlockStatePropertyLootCondition.builder(block).method_22584(StatePredicate.Builder.create().exactMatch(property, comparable))))));
   }

   private static LootTable.Builder createForNameableContainer(Block block) {
      return LootTable.builder().withPool((LootPool.Builder)addSurvivesExplosionLootCondition(block, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(block).withFunction(CopyNameLootFunction.builder(CopyNameLootFunction.Source.BLOCK_ENTITY)))));
   }
   ...
   public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
      ...
      this.register(Blocks.FARMLAND, (ItemConvertible)Blocks.DIRT);
      this.register(Blocks.TRIPWIRE, (ItemConvertible)Items.STRING);
      this.register(Blocks.GRASS_PATH, (ItemConvertible)Blocks.DIRT);
      this.register(Blocks.KELP_PLANT, (ItemConvertible)Blocks.KELP);
      this.register(Blocks.BAMBOO_SAPLING, (ItemConvertible)Blocks.BAMBOO);
      this.registerWithFunction(Blocks.STONE, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.COBBLESTONE);
      });
      this.registerWithFunction(Blocks.GRASS_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DIRT);
      });
      this.registerWithFunction(Blocks.PODZOL, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DIRT);
      });
      this.registerWithFunction(Blocks.MYCELIUM, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DIRT);
      });
      this.registerWithFunction(Blocks.TUBE_CORAL_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DEAD_TUBE_CORAL_BLOCK);
      });
      this.registerWithFunction(Blocks.BRAIN_CORAL_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DEAD_BRAIN_CORAL_BLOCK);
      });
      this.registerWithFunction(Blocks.BUBBLE_CORAL_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DEAD_BUBBLE_CORAL_BLOCK);
      });
      this.registerWithFunction(Blocks.FIRE_CORAL_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DEAD_FIRE_CORAL_BLOCK);
      });
      this.registerWithFunction(Blocks.HORN_CORAL_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.DEAD_HORN_CORAL_BLOCK);
      });
      this.registerWithFunction(Blocks.BOOKSHELF, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Items.BOOK, ConstantLootTableRange.create(3));
      });
      this.registerWithFunction(Blocks.CLAY, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Items.CLAY_BALL, ConstantLootTableRange.create(4));
      });
      this.registerWithFunction(Blocks.ENDER_CHEST, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Blocks.OBSIDIAN, ConstantLootTableRange.create(8));
      });
      this.registerWithFunction(Blocks.SNOW_BLOCK, (blockx) -> {
         return createForBlockWithItemDrops(blockx, Items.SNOWBALL, ConstantLootTableRange.create(4));
      });
      ...
      this.registerWithFunction(Blocks.ACACIA_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.BIRCH_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.DARK_OAK_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.IRON_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.JUNGLE_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.OAK_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.SPRUCE_DOOR, (blockx) -> {
         return createForMultiblock(blockx, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.BLACK_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.BLUE_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.BROWN_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.CYAN_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.GRAY_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.GREEN_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.LIGHT_BLUE_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.LIGHT_GRAY_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.LIME_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.MAGENTA_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.PURPLE_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.ORANGE_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.PINK_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.RED_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.WHITE_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.YELLOW_BED, (blockx) -> {
         return createForMultiblock(blockx, BedBlock.PART, BedPart.HEAD);
      });
      this.registerWithFunction(Blocks.LILAC, (blockx) -> {
         return createForMultiblock(blockx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.SUNFLOWER, (blockx) -> {
         return createForMultiblock(blockx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.PEONY, (blockx) -> {
         return createForMultiblock(blockx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerWithFunction(Blocks.ROSE_BUSH, (blockx) -> {
         return createForMultiblock(blockx, TallPlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.register(Blocks.TNT, LootTable.builder().withPool((LootPool.Builder)addSurvivesExplosionLootCondition(Blocks.TNT, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(Blocks.TNT).withCondition(BlockStatePropertyLootCondition.builder(Blocks.TNT).method_22584(StatePredicate.Builder.create().exactMatch(TntBlock.UNSTABLE, false)))))));
      this.registerWithFunction(Blocks.COCOA, (blockx) -> {
         return LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.COCOA_BEANS).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(3)).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(CocoaBlock.AGE, 2)))))));
      });
      this.registerWithFunction(Blocks.SEA_PICKLE, (blockx) -> {
         return LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry((LootEntry.Builder)addExplosionDecayLootFunction(Blocks.SEA_PICKLE, ItemEntry.builder(blockx).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(2)).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 2)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(3)).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 3)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(4)).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SeaPickleBlock.PICKLES, 4)))))));
      });
      this.registerWithFunction(Blocks.COMPOSTER, (blockx) -> {
         return LootTable.builder().withPool(LootPool.builder().withEntry((LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.COMPOSTER)))).withPool(LootPool.builder().withEntry(ItemEntry.builder(Items.BONE_MEAL)).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(ComposterBlock.LEVEL, 8))));
      });
      ...
      this.registerWithFunction(Blocks.PLAYER_HEAD, (blockx) -> {
         return LootTable.builder().withPool((LootPool.Builder)addSurvivesExplosionLootCondition(blockx, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(blockx).withFunction(CopyNbtLootFunction.builder(CopyNbtLootFunction.Source.BLOCK_ENTITY).withOperation("Owner", "SkullOwner")))));
      });
      ...
      this.registerWithFunction(Blocks.BIRCH_LEAVES, (blockx) -> {
         return createForLeaves(blockx, Blocks.BIRCH_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES);
      });
      this.registerWithFunction(Blocks.ACACIA_LEAVES, (blockx) -> {
         return createForLeaves(blockx, Blocks.ACACIA_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES);
      });
      this.registerWithFunction(Blocks.JUNGLE_LEAVES, (blockx) -> {
         return createForLeaves(blockx, Blocks.JUNGLE_SAPLING, JUNGLE_SAPLING_DROP_CHANCES_FROM_LEAVES);
      });
      this.registerWithFunction(Blocks.SPRUCE_LEAVES, (blockx) -> {
         return createForLeaves(blockx, Blocks.SPRUCE_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES);
      });
      this.registerWithFunction(Blocks.OAK_LEAVES, (blockx) -> {
         return createForOakLeaves(blockx, Blocks.OAK_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES);
      });
      this.registerWithFunction(Blocks.DARK_OAK_LEAVES, (blockx) -> {
         return createForOakLeaves(blockx, Blocks.DARK_OAK_SAPLING, SAPLING_DROP_CHANCES_FROM_LEAVES);
      });
      LootCondition.Builder builder = BlockStatePropertyLootCondition.builder(Blocks.BEETROOTS).method_22584(StatePredicate.Builder.create().exactMatch(BeetrootsBlock.AGE, 3));
      this.register(Blocks.BEETROOTS, createForCrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, builder));
      LootCondition.Builder builder2 = BlockStatePropertyLootCondition.builder(Blocks.WHEAT).method_22584(StatePredicate.Builder.create().exactMatch(CropBlock.AGE, 7));
      this.register(Blocks.WHEAT, createForCrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, builder2));
      LootCondition.Builder builder3 = BlockStatePropertyLootCondition.builder(Blocks.CARROTS).method_22584(StatePredicate.Builder.create().exactMatch(CarrotsBlock.AGE, 7));
      this.register(Blocks.CARROTS, (LootTable.Builder)addExplosionDecayLootFunction(Blocks.CARROTS, LootTable.builder().withPool(LootPool.builder().withEntry(ItemEntry.builder(Items.CARROT))).withPool(LootPool.builder().withCondition(builder3).withEntry(ItemEntry.builder(Items.CARROT).withFunction(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286F, 3))))));
      LootCondition.Builder builder4 = BlockStatePropertyLootCondition.builder(Blocks.POTATOES).method_22584(StatePredicate.Builder.create().exactMatch(PotatoesBlock.AGE, 7));
      this.register(Blocks.POTATOES, (LootTable.Builder)addExplosionDecayLootFunction(Blocks.POTATOES, LootTable.builder().withPool(LootPool.builder().withEntry(ItemEntry.builder(Items.POTATO))).withPool(LootPool.builder().withCondition(builder4).withEntry(ItemEntry.builder(Items.POTATO).withFunction(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286F, 3)))).withPool(LootPool.builder().withCondition(builder4).withEntry(ItemEntry.builder(Items.POISONOUS_POTATO).withCondition(RandomChanceLootCondition.builder(0.02F))))));
      this.registerWithFunction(Blocks.SWEET_BERRY_BUSH, (blockx) -> {
         return (LootTable.Builder)addExplosionDecayLootFunction(blockx, LootTable.builder().withPool(LootPool.builder().withCondition(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).method_22584(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 3))).withEntry(ItemEntry.builder(Items.SWEET_BERRIES)).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 3.0F))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE))).withPool(LootPool.builder().withCondition(BlockStatePropertyLootCondition.builder(Blocks.SWEET_BERRY_BUSH).method_22584(StatePredicate.Builder.create().exactMatch(SweetBerryBushBlock.AGE, 2))).withEntry(ItemEntry.builder(Items.SWEET_BERRIES)).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(1.0F, 2.0F))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE))));
      });
      this.registerWithFunction(Blocks.BROWN_MUSHROOM_BLOCK, (blockx) -> {
         return createForLargeMushroomBlock(blockx, Blocks.BROWN_MUSHROOM);
      });
      this.registerWithFunction(Blocks.RED_MUSHROOM_BLOCK, (blockx) -> {
         return createForLargeMushroomBlock(blockx, Blocks.RED_MUSHROOM);
      });
      this.registerWithFunction(Blocks.COAL_ORE, (blockx) -> {
         return createForOreWithSingleItemDrop(blockx, Items.COAL);
      });
      this.registerWithFunction(Blocks.EMERALD_ORE, (blockx) -> {
         return createForOreWithSingleItemDrop(blockx, Items.EMERALD);
      });
      this.registerWithFunction(Blocks.NETHER_QUARTZ_ORE, (blockx) -> {
         return createForOreWithSingleItemDrop(blockx, Items.QUARTZ);
      });
      this.registerWithFunction(Blocks.DIAMOND_ORE, (blockx) -> {
         return createForOreWithSingleItemDrop(blockx, Items.DIAMOND);
      });
      this.registerWithFunction(Blocks.LAPIS_ORE, (blockx) -> {
         return createForNeedingSilkTouch(blockx, (LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.LAPIS_LAZULI).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(4.0F, 9.0F))).withFunction(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE))));
      });
      this.registerWithFunction(Blocks.COBWEB, (blockx) -> {
         return createForNeedingSilkTouchShears(blockx, (LootEntry.Builder)addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.STRING)));
      });
      this.registerWithFunction(Blocks.DEAD_BUSH, (blockx) -> {
         return createForNeedingShears(blockx, (LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.STICK).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(0.0F, 2.0F)))));
      });
      ...
      this.registerWithFunction(Blocks.LARGE_FERN, (blockx) -> {
         return createForNeedingShears(Blocks.FERN, ((LeafEntry.Builder)((LeafEntry.Builder)addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.WHEAT_SEEDS))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER)))).withCondition(RandomChanceLootCondition.builder(0.125F)));
      });
      this.register(Blocks.TALL_GRASS, createForNeedingShears(Blocks.GRASS, ((LeafEntry.Builder)((LeafEntry.Builder)addSurvivesExplosionLootCondition(Blocks.TALL_GRASS, ItemEntry.builder(Items.WHEAT_SEEDS))).withCondition(BlockStatePropertyLootCondition.builder(Blocks.TALL_GRASS).method_22584(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, (Comparable)DoubleBlockHalf.LOWER)))).withCondition(RandomChanceLootCondition.builder(0.125F))));
      this.registerWithFunction(Blocks.MELON_STEM, (blockx) -> {
         return createForCropStem(blockx, Items.MELON_SEEDS);
      });
      this.registerWithFunction(Blocks.ATTACHED_MELON_STEM, (blockx) -> {
         return createForAttachedCropStem(blockx, Items.MELON_SEEDS);
      });
      this.registerWithFunction(Blocks.PUMPKIN_STEM, (blockx) -> {
         return createForCropStem(blockx, Items.PUMPKIN_SEEDS);
      });
      this.registerWithFunction(Blocks.ATTACHED_PUMPKIN_STEM, (blockx) -> {
         return createForAttachedCropStem(blockx, Items.PUMPKIN_SEEDS);
      });
      this.registerWithFunction(Blocks.CHORUS_FLOWER, (blockx) -> {
         return LootTable.builder().withPool(LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(((LeafEntry.Builder)addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(blockx))).withCondition(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS))));
      });
      ...
      this.registerWithFunction(Blocks.GLOWSTONE, (blockx) -> {
         return createForNeedingSilkTouch(blockx, (LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.GLOWSTONE_DUST).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 4.0F))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE)).withFunction(LimitCountLootFunction.builder(BoundedIntUnaryOperator.create(1, 4)))));
      });
      this.registerWithFunction(Blocks.MELON, (blockx) -> {
         return createForNeedingSilkTouch(blockx, (LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.MELON_SLICE).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(3.0F, 7.0F))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE)).withFunction(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMax(9)))));
      });
      this.registerWithFunction(Blocks.REDSTONE_ORE, (blockx) -> {
         return createForNeedingSilkTouch(blockx, (LootEntry.Builder)addExplosionDecayLootFunction(blockx, ItemEntry.builder(Items.REDSTONE).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(4.0F, 5.0F))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE))));
      });
      this.registerWithFunction(Blocks.SEA_LANTERN, (blockx) -> {
      ...
      this.registerWithFunction(Blocks.NETHER_WART, (blockx) -> {
         return LootTable.builder().withPool((LootPool.Builder)addExplosionDecayLootFunction(blockx, LootPool.builder().withRolls(ConstantLootTableRange.create(1)).withEntry(ItemEntry.builder(Items.NETHER_WART).withFunction(SetCountLootFunction.builder(UniformLootTableRange.between(2.0F, 4.0F)).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))).withFunction(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(NetherWartBlock.AGE, 3)))))));
      });
      this.registerWithFunction(Blocks.SNOW, (blockx) -> {
         return LootTable.builder().withPool(LootPool.builder().withCondition(EntityPropertiesLootCondition.create(LootContext.EntityTarget.THIS)).withEntry(AlternativeEntry.builder(AlternativeEntry.builder(ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(2))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(3))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(4))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(5))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(6))), ((LeafEntry.Builder)ItemEntry.builder(Items.SNOWBALL).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7)))).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(7))), ItemEntry.builder(Items.SNOWBALL).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(8)))).withCondition(DOESNT_NEED_SILK_TOUCH), AlternativeEntry.builder(ItemEntry.builder(Blocks.SNOW).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 1))), ItemEntry.builder(Blocks.SNOW).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(2))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 2))), ItemEntry.builder(Blocks.SNOW).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(3))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 3))), ItemEntry.builder(Blocks.SNOW).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(4))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 4))), ItemEntry.builder(Blocks.SNOW).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(5))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 5))), ItemEntry.builder(Blocks.SNOW).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(6))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 6))), ItemEntry.builder(Blocks.SNOW).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(7))).withCondition(BlockStatePropertyLootCondition.builder(blockx).method_22584(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, 7))), ItemEntry.builder(Blocks.SNOW_BLOCK)))));
      });
      this.registerWithFunction(Blocks.GRAVEL, (blockx) -> {
         return createForNeedingSilkTouch(blockx, (LootEntry.Builder)addSurvivesExplosionLootCondition(blockx, ((LeafEntry.Builder)ItemEntry.builder(Items.FLINT).withCondition(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).withChild(ItemEntry.builder(blockx))));
      });
      this.registerWithFunction(Blocks.CAMPFIRE, (blockx) -> {
         return createForNeedingSilkTouch(blockx, (LootEntry.Builder)addSurvivesExplosionLootCondition(blockx, ItemEntry.builder(Items.CHARCOAL).withFunction(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))));
      });
   ...
   public void registerForPottedPlant(Block block) {
      this.registerWithFunction(block, (blockx) -> {
         return createForPottedPlant(((FlowerPotBlock)blockx).getContent());
      });
   }
   ...
   public void registerForSelfDrop(Block block) {
      this.register(block, (ItemConvertible)block);
   }
   ...
   static {
      ...
      ALWAYS_DROPPED_FROM_EXPLOSION = (Set)Stream.of(Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX).map(ItemConvertible::asItem).collect(ImmutableSet.toImmutableSet());
