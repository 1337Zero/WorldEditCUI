...
public class ItemTagsProvider extends AbstractTagProvider<Item> {
   ...
   protected void configure() {
      ...
      this.getOrCreateTagBuilder(ItemTags.BOATS).add((Object[])(Items.OAK_BOAT, Items.SPRUCE_BOAT, Items.BIRCH_BOAT, Items.JUNGLE_BOAT, Items.ACACIA_BOAT, Items.DARK_OAK_BOAT));
      ...
      this.getOrCreateTagBuilder(ItemTags.MUSIC_DISCS).add((Object[])(Items.MUSIC_DISC_13, Items.MUSIC_DISC_CAT, Items.MUSIC_DISC_BLOCKS, Items.MUSIC_DISC_CHIRP, Items.MUSIC_DISC_FAR, Items.MUSIC_DISC_MALL, Items.MUSIC_DISC_MELLOHI, Items.MUSIC_DISC_STAL, Items.MUSIC_DISC_STRAD, Items.MUSIC_DISC_WARD, Items.MUSIC_DISC_11, Items.MUSIC_DISC_WAIT));
   ...
   protected void copy(Tag<Block> tag, Tag<Item> tag2) {
      ...
      Iterator var4 = tag.entries().iterator();

      while(var4.hasNext()) {
         Tag.Entry<Block> entry = (Tag.Entry)var4.next();
   ...
   private Tag.Entry<Item> convert(Tag.Entry<Block> entry) {
      if (entry instanceof Tag.TagEntry) {
         ...
         Iterator var3 = ((Tag.CollectionEntry)entry).getValues().iterator();
