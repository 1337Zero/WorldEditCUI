...
public class CookingRecipeJsonFactory {
   ...
   public void offerTo(Consumer<RecipeJsonProvider> exporter, Identifier recipeId) {
      ...
      this.builder.parent(new Identifier("recipes/root")).criterion("has_the_recipe", (CriterionConditions)(new RecipeUnlockedCriterion.Conditions(recipeId))).rewards(AdvancementRewards.Builder.recipe(recipeId)).criteriaMerger(CriteriaMerger.OR);
      exporter.accept(new CookingRecipeJsonFactory.CookingRecipeJsonProvider(recipeId, this.group == null ? "" : this.group, this.input, this.output, this.exp, this.time, this.builder, new Identifier(recipeId.getNamespace(), "recipes/" + this.output.getGroup().getName() + "/" + recipeId.getPath()), this.serializer));
   }
