...
public class HusbandryTabAdvancementGenerator implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> consumer) {
      Advancement advancement = Advancement.Task.create().display((ItemConvertible)Blocks.HAY_BLOCK, new TranslatableText("advancements.husbandry.root.title", new Object[0]), new TranslatableText("advancements.husbandry.root.description", new Object[0]), new Identifier("textures/gui/advancements/backgrounds/husbandry.png"), AdvancementFrame.TASK, false, false, false).criterion("consumed_item", (CriterionConditions)ConsumeItemCriterion.Conditions.any()).build(consumer, "husbandry/root");
      Advancement advancement2 = Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.WHEAT, new TranslatableText("advancements.husbandry.plant_seed.title", new Object[0]), new TranslatableText("advancements.husbandry.plant_seed.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriteriaMerger.OR).criterion("wheat", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.WHEAT)).criterion("pumpkin_stem", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.PUMPKIN_STEM)).criterion("melon_stem", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.MELON_STEM)).criterion("beetroots", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.BEETROOTS)).criterion("nether_wart", (CriterionConditions)PlacedBlockCriterion.Conditions.block(Blocks.NETHER_WART)).build(consumer, "husbandry/plant_seed");
      Advancement advancement3 = Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.WHEAT, new TranslatableText("advancements.husbandry.breed_an_animal.title", new Object[0]), new TranslatableText("advancements.husbandry.breed_an_animal.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriteriaMerger.OR).criterion("bred", (CriterionConditions)BredAnimalsCriterion.Conditions.any()).build(consumer, "husbandry/breed_an_animal");
      Advancement advancement4 = this.requireFoodItemsEaten(Advancement.Task.create()).parent(advancement2).display((ItemConvertible)Items.APPLE, new TranslatableText("advancements.husbandry.balanced_diet.title", new Object[0]), new TranslatableText("advancements.husbandry.balanced_diet.description", new Object[0]), (Identifier)null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/balanced_diet");
      Advancement advancement5 = Advancement.Task.create().parent(advancement2).display((ItemConvertible)Items.DIAMOND_HOE, new TranslatableText("advancements.husbandry.break_diamond_hoe.title", new Object[0]), new TranslatableText("advancements.husbandry.break_diamond_hoe.description", new Object[0]), (Identifier)null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).criterion("broke_hoe", (CriterionConditions)ItemDurabilityChangedCriterion.Conditions.create(ItemPredicate.Builder.create().item(Items.DIAMOND_HOE).build(), NumberRange.IntRange.exactly(0))).build(consumer, "husbandry/break_diamond_hoe");
      Advancement advancement6 = Advancement.Task.create().parent(advancement).display((ItemConvertible)Items.LEAD, new TranslatableText("advancements.husbandry.tame_an_animal.title", new Object[0]), new TranslatableText("advancements.husbandry.tame_an_animal.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).criterion("tamed_animal", (CriterionConditions)TameAnimalCriterion.Conditions.any()).build(consumer, "husbandry/tame_an_animal");
      Advancement advancement7 = this.requireListedAnimalsBred(Advancement.Task.create()).parent(advancement3).display((ItemConvertible)Items.GOLDEN_CARROT, new TranslatableText("advancements.husbandry.breed_all_animals.title", new Object[0]), new TranslatableText("advancements.husbandry.breed_all_animals.description", new Object[0]), (Identifier)null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(consumer, "husbandry/bred_all_animals");
      Advancement advancement8 = this.requireListedFishCaught(Advancement.Task.create()).parent(advancement).criteriaMerger(CriteriaMerger.OR).display((ItemConvertible)Items.FISHING_ROD, new TranslatableText("advancements.husbandry.fishy_business.title", new Object[0]), new TranslatableText("advancements.husbandry.fishy_business.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/fishy_business");
      Advancement advancement9 = this.requireListedFishBucketsFilled(Advancement.Task.create()).parent(advancement8).criteriaMerger(CriteriaMerger.OR).display((ItemConvertible)Items.PUFFERFISH_BUCKET, new TranslatableText("advancements.husbandry.tactical_fishing.title", new Object[0]), new TranslatableText("advancements.husbandry.tactical_fishing.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/tactical_fishing");
      Advancement advancement10 = this.requireAllCatsTamed(Advancement.Task.create()).parent(advancement6).display((ItemConvertible)Items.COD, new TranslatableText("advancements.husbandry.complete_catalogue.title", new Object[0]), new TranslatableText("advancements.husbandry.complete_catalogue.description", new Object[0]), (Identifier)null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(consumer, "husbandry/complete_catalogue");
      Advancement advancement11 = Advancement.Task.create().parent(advancement).criterion("safely_harvest_honey", (CriterionConditions)BlockUsedCriterion.Conditions.create(BlockPredicate.Builder.create().tag(BlockTags.BEEHIVES), ItemPredicate.Builder.create().item(Items.GLASS_BOTTLE))).display((ItemConvertible)Items.HONEY_BOTTLE, new TranslatableText("advancements.husbandry.safely_harvest_honey.title", new Object[0]), new TranslatableText("advancements.husbandry.safely_harvest_honey.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/safely_harvest_honey");
      Advancement advancement12 = Advancement.Task.create().parent(advancement).criterion("silk_touch_nest", (CriterionConditions)BeeNestDestroyedCriterion.Conditions.create(Blocks.BEE_NEST, ItemPredicate.Builder.create().enchantment(new EnchantmentPredicate(Enchantments.SILK_TOUCH, NumberRange.IntRange.atLeast(1))), NumberRange.IntRange.exactly(3))).display((ItemConvertible)Blocks.BEE_NEST, new TranslatableText("advancements.husbandry.silk_touch_nest.title", new Object[0]), new TranslatableText("advancements.husbandry.silk_touch_nest.description", new Object[0]), (Identifier)null, AdvancementFrame.TASK, true, true, false).build(consumer, "husbandry/silk_touch_nest");
   }
