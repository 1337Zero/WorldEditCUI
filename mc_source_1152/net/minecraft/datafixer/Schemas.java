...
public class Schemas {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      builder.addFixer(ItemNameFix.create(schema18, "cooked_fished item renamer", (string) -> {
         return Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : string;
      }));
      ...
      builder.addFixer(ItemNameFix.create(schema32, "totem item renamer", (string) -> {
      ...
      builder.addFixer(BlockNameFix.create(schema52, "Colorless shulker block fixer", (string) -> {
         return Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string;
      }));
      builder.addFixer(ItemNameFix.create(schema52, "Colorless shulker item fixer", (string) -> {
         return Objects.equals(SchemaIdentifierNormalize.normalize(string), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : string;
      }));
      Schema schema53 = builder.addSchema(1475, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(BlockNameFix.create(schema53, "Flowing fixer", (string) -> {
      ...
      builder.addFixer(BlockNameFix.create(schema54, "Rename coral blocks", (string) -> {
         return (String)LegacyCoralBlockMapping.MAP.getOrDefault(string, string);
      }));
      builder.addFixer(ItemNameFix.create(schema54, "Rename coral items", (string) -> {
         return (String)LegacyCoralBlockMapping.MAP.getOrDefault(string, string);
      }));
      ...
      builder.addFixer(ItemNameFix.create(schema56, "Rename pufferfish egg item", (string) -> {
         return (String)EntityPufferfishRenameFix.RENAMED_FISHES.getOrDefault(string, string);
      }));
      Schema schema57 = builder.addSchema(1484, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(ItemNameFix.create(schema57, "Rename seagrass items", (string) -> {
      ...
      builder.addFixer(BlockNameFix.create(schema57, "Rename seagrass blocks", (string) -> {
         return (String)ImmutableMap.of("minecraft:sea_grass", "minecraft:seagrass", "minecraft:tall_sea_grass", "minecraft:tall_seagrass").getOrDefault(string, string);
      }));
      ...
      builder.addFixer(ItemNameFix.create(schema58, "Rename cod/salmon egg items", (string) -> {
         return (String)EntityCodSalmonFix.SPAWN_EGGS.getOrDefault(string, string);
      }));
      Schema schema59 = builder.addSchema(1487, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(ItemNameFix.create(schema59, "Rename prismarine_brick(s)_* blocks", (string) -> {
      ...
      builder.addFixer(BlockNameFix.create(schema59, "Rename prismarine_brick(s)_* items", (string) -> {
         return (String)ImmutableMap.of("minecraft:prismarine_bricks_slab", "minecraft:prismarine_brick_slab", "minecraft:prismarine_bricks_stairs", "minecraft:prismarine_brick_stairs").getOrDefault(string, string);
      }));
      Schema schema60 = builder.addSchema(1488, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(BlockNameFix.create(schema60, "Rename kelp/kelptop", (string) -> {
      ...
      builder.addFixer(ItemNameFix.create(schema60, "Rename kelptop", (string) -> {
      ...
      builder.addFixer(BlockNameFix.create(schema61, "Rename melon_block", (string) -> {
         return Objects.equals(string, "minecraft:melon_block") ? "minecraft:melon" : string;
      }));
      builder.addFixer(ItemNameFix.create(schema61, "Rename melon_block/melon/speckled_melon", (string) -> {
      ...
      builder.addFixer(BlockNameFix.create(schema70, "Block renamening fix", (string) -> {
         return (String)EntityTheRenameningBlock.BLOCKS.getOrDefault(string, string);
      }));
      builder.addFixer(ItemNameFix.create(schema70, "Item renamening fix", (string) -> {
         return (String)EntityTheRenameningBlock.ITEMS.getOrDefault(string, string);
      }));
      ...
      builder.addFixer(BlockNameFix.create(schema72, "Rename coral fan blocks", (string) -> {
         return (String)LegacyCoralFanBlockMapping.MAP.getOrDefault(string, string);
      }));
      ...
      builder.addFixer(ItemNameFix.create(schema74, "Rename dye items", (string) -> {
         return (String)LegacyDyeItemMapping.MAP.getOrDefault(string, string);
      }));
      ...
      builder.addFixer(BlockNameFix.create(schema76, "Rename sign blocks & stone slabs", (string) -> {
      ...
      builder.addFixer(ItemNameFix.create(schema76, "Rename sign item & stone slabs", (string) -> {
      ...
      builder.addFixer(ItemNameFix.create(schema87, "Rename ravager egg item", (string) -> {
         return (String)EntityRavagerRenameFix.ITEMS.getOrDefault(string, string);
      }));
      ...
      builder.addFixer(new RecipeRenameFix(schema96, false, "Rename sugar recipe", (string) -> {
         return "minecraft:sugar".equals(string) ? "sugar_from_sugar_cane" : string;
      }));
      builder.addFixer(new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", (string) -> {
         return "minecraft:recipes/misc/sugar".equals(string) ? "minecraft:recipes/misc/sugar_from_sugar_cane" : string;
      }));
      ...
      builder.addFixer(ItemNameFix.create(schema98, "Rename bee_hive item to beehive", (string) -> {
         return Objects.equals(string, "minecraft:bee_hive") ? "minecraft:beehive" : string;
      }));
      builder.addFixer(new BeehiveRenameFix(schema98));
      builder.addFixer(BlockNameFix.create(schema98, "Rename bee_hive block to beehive", (string) -> {
         return (String)ImmutableMap.of("minecraft:bee_hive", "minecraft:beehive").getOrDefault(string, string);
      }));
