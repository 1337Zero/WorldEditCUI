...
public class ItemInstanceTheFlatteningFix extends DataFix {
   private static final Map<String, String> FLATTENING_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   private static final Set<String> DAMAGABLE_ITEMS;
