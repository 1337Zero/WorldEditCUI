         ...
         return this.fixTypeEverywhere("Biomes fix", type, (dynamicOps) -> {
            return (pair) -> {
               return pair.mapSecond((string) -> {
                  return (String)RENAMED_BIOMES.getOrDefault(string, string);
               });
            };
         });
      }
