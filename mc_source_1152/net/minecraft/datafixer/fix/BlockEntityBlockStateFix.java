...
public class BlockEntityBlockStateFix extends ChoiceFix {
   ...
   protected Typed<?> transform(Typed<?> typed) {
      ...
      Typed<?> typed2 = (Typed)type.pointTyped(typed.getOps()).orElseThrow(() -> {
         return new IllegalStateException("Could not create new piston block entity.");
      });
      return typed2.set(DSL.remainderFinder(), dynamic).set(opticFinder, (Typed)((Optional)type2.readTyped(dynamic2).getSecond()).orElseThrow(() -> {
