...
public class OptionsKeyLwjgl3Fix extends DataFix {
   private static final Int2ObjectMap<String> NUMERICAL_KEY_IDS_TO_KEY_NAMES = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (int2ObjectOpenHashMap) -> {
