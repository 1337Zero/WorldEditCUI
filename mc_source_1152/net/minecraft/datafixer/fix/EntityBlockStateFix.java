...
public class EntityBlockStateFix extends DataFix {
   private static final Map<String, Integer> BLOCK_NAME_TO_ID = (Map)DataFixUtils.make(Maps.newHashMap(), (hashMap) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function<Typed<?>, Typed<?>> function = (typed) -> {
         return this.mergeIdAndData(typed, "DisplayTile", "DisplayData", "DisplayState");
      };
      Function<Typed<?>, Typed<?>> function2 = (typed) -> {
         return this.mergeIdAndData(typed, "inTile", "inData", "inBlockState");
      };
      ...
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", schema.getType(TypeReferences.ENTITY), schema2.getType(TypeReferences.ENTITY), (typed) -> {
         ...
         typed = this.useFunction(typed, "minecraft:enderman", (typedx) -> {
            return this.mergeIdAndData(typedx, "carried", "carriedData", "carriedBlockState");
         });
         ...
         typed = this.useFunction(typed, "minecraft:spawner_minecart", function);
         return typed;
      });
   }
   ...
   private Typed<?> mergeIdAndData(Typed<?> typed, String oldIdKey, String oldDataKey, String newStateKey) {
      Type<Pair<String, Either<Integer, String>>> type = DSL.field(oldIdKey, DSL.named(TypeReferences.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())));
