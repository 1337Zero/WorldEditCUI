...
public final class GiantTreeTaigaHillsBiome extends Biome {
   public GiantTreeTaigaHillsBiome() {
      super((new Biome.Settings()).configureSurfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.GRASS_CONFIG).precipitation(Biome.Precipitation.RAIN).category(Biome.Category.TAIGA).depth(0.45F).scale(0.3F).temperature(0.3F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent((String)null));
