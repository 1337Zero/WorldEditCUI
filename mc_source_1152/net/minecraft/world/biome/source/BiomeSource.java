...
public abstract class BiomeSource implements BiomeAccess.Storage {
   ...
   static {
      SPAWN_BIOMES = Lists.newArrayList(new Biome[]{Biomes.FOREST, Biomes.PLAINS, Biomes.TAIGA, Biomes.TAIGA_HILLS, Biomes.WOODED_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_HILLS});
   }
}
