...
public class BiomeSourceType<C extends BiomeSourceConfig, T extends BiomeSource> {
   ...
   public static final BiomeSourceType<TheEndBiomeSourceConfig, TheEndBiomeSource> THE_END = register("the_end", TheEndBiomeSource::new, TheEndBiomeSourceConfig::new);
   ...
   private static <C extends BiomeSourceConfig, T extends BiomeSource> BiomeSourceType<C, T> register(String id, Function<C, T> biomeSource, Function<LevelProperties, C> function) {
      return (BiomeSourceType)Registry.register(Registry.BIOME_SOURCE_TYPE, (String)id, new BiomeSourceType(biomeSource, function));
   }
   ...
   public T applyConfig(C config) {
      return (BiomeSource)this.biomeSource.apply(config);
   }

   public C getConfig(LevelProperties levelProperties) {
      return (BiomeSourceConfig)this.config.apply(levelProperties);
   }
}
