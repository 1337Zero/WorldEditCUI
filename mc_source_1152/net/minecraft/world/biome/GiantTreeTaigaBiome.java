...
public final class GiantTreeTaigaBiome extends Biome {
   public GiantTreeTaigaBiome() {
      super((new Biome.Settings()).configureSurfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.GRASS_CONFIG).precipitation(Biome.Precipitation.RAIN).category(Biome.Category.TAIGA).depth(0.2F).scale(0.2F).temperature(0.3F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent((String)null));
