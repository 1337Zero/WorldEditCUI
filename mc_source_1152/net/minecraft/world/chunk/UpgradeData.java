...
public class UpgradeData {
      ...
      if (chunk.getUpgradeData().sidesToUpgrade.remove(side)) {
         ...
         while(var18.hasNext()) {
            ...
            for(int var24 = 0; var24 < var23; ++var24) {
               ...
               mutable.set((Vec3i)blockPos).setOffset(direction);
   ...
   private static BlockState applyAdjacentBlock(BlockState oldState, Direction dir, IWorld world, BlockPos currentPos, BlockPos otherPos) {
      return ((UpgradeData.Logic)BLOCK_TO_LOGIC.getOrDefault(oldState.getBlock(), UpgradeData.BulitinLogic.DEFAULT)).getUpdatedState(oldState, dir, world.getBlockState(otherPos), world, currentPos, otherPos);
   }
            ...
            for(i = 0; i < 16; ++i) {
               ...
               if (chunkSection != null && is != null && is.length > 0) {
                  ...
                  for(int var15 = 0; var15 < var14; ++var15) {
                     ...
                     for(int var24 = 0; var24 < var23; ++var24) {
                        Direction direction = var22[var24];
                        pooledMutable2.set((Vec3i)pooledMutable).setOffset(direction);
