...
public class WanderingTraderManager {
   ...
   private boolean method_18018() {
      ...
      if (playerEntity == null) {
         ...
         if (blockPos3 != null && this.method_23279(blockPos3)) {
            ...
            WanderingTraderEntity wanderingTraderEntity = (WanderingTraderEntity)EntityType.WANDERING_TRADER.spawn(this.world, (CompoundTag)null, (Text)null, (PlayerEntity)null, blockPos3, SpawnType.EVENT, false, false);
   ...
   private void method_18016(WanderingTraderEntity wanderingTraderEntity, int i) {
      ...
      if (blockPos != null) {
         TraderLlamaEntity traderLlamaEntity = (TraderLlamaEntity)EntityType.TRADER_LLAMA.spawn(this.world, (CompoundTag)null, (Text)null, (PlayerEntity)null, blockPos, SpawnType.EVENT, false, false);
