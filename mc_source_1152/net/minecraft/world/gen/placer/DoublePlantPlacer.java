...
public class DoublePlantPlacer extends BlockPlacer {
   ...
   public <T> T serialize(DynamicOps<T> ops) {
      return (new Dynamic(ops, ops.createMap(ImmutableMap.of(ops.createString("type"), ops.createString(Registry.BLOCK_PLACER_TYPE.getId(this.type).toString()))))).getValue();
   }
}
