...
public class WeightedStateProvider extends StateProvider {
   ...
   public <T> T serialize(DynamicOps<T> ops) {
      ...
      builder.put(ops.createString("type"), ops.createString(Registry.BLOCK_STATE_PROVIDER_TYPE.getId(this.stateProvider).toString())).put(ops.createString("entries"), this.states.serialize(ops, (blockState) -> {
         return BlockState.serialize(ops, blockState);
      }));
