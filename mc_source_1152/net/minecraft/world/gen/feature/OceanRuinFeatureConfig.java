...
public class OceanRuinFeatureConfig implements FeatureConfig {
   ...
   public <T> Dynamic<T> serialize(DynamicOps<T> ops) {
      return new Dynamic(ops, ops.createMap(ImmutableMap.of(ops.createString("biome_temp"), ops.createString(this.biomeType.getName()), ops.createString("large_probability"), ops.createFloat(this.largeProbability), ops.createString("cluster_probability"), ops.createFloat(this.clusterProbability))));
   }
