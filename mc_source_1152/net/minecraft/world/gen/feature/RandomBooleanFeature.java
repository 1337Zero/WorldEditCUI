...
public class RandomBooleanFeature extends Feature<RandomBooleanFeatureConfig> {
   ...
   public boolean generate(IWorld iWorld, ChunkGenerator<? extends ChunkGeneratorConfig> chunkGenerator, Random random, BlockPos blockPos, RandomBooleanFeatureConfig randomBooleanFeatureConfig) {
      ...
      return bl ? randomBooleanFeatureConfig.featureTrue.generate(iWorld, chunkGenerator, random, blockPos) : randomBooleanFeatureConfig.featureFalse.generate(iWorld, chunkGenerator, random, blockPos);
   }
}
