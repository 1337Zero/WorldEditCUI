...
public class OreFeatureConfig implements FeatureConfig {
   ...
   public static enum Target {
      ...
      private static final Map<String, OreFeatureConfig.Target> nameMap = (Map)Arrays.stream(values()).collect(Collectors.toMap(OreFeatureConfig.Target::getName, (target) -> {
         return target;
      }));
