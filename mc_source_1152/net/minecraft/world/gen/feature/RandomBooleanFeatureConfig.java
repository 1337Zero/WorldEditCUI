...
public class RandomBooleanFeatureConfig implements FeatureConfig {
   ...
   public <T> Dynamic<T> serialize(DynamicOps<T> ops) {
      return new Dynamic(ops, ops.createMap(ImmutableMap.of(ops.createString("feature_true"), this.featureTrue.serialize(ops).getValue(), ops.createString("feature_false"), this.featureFalse.serialize(ops).getValue())));
   }
