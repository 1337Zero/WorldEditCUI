...
public class BranchedTreeFeatureConfig extends TreeFeatureConfig {
   ...
   public static <T> BranchedTreeFeatureConfig deserialize(Dynamic<T> dynamic) {
      ...
      FoliagePlacerType<?> foliagePlacerType = (FoliagePlacerType)Registry.FOLIAGE_PLACER_TYPE.get(new Identifier((String)dynamic.get("foliage_placer").get("type").asString().orElseThrow(RuntimeException::new)));
