...
public class TreeDecoratorType<P extends TreeDecorator> {
   ...
   private static <P extends TreeDecorator> TreeDecoratorType<P> register(String string, Function<Dynamic<?>, P> function) {
      return (TreeDecoratorType)Registry.register(Registry.TREE_DECORATOR_TYPE, (String)string, new TreeDecoratorType(function));
   }
   ...
   public P method_23472(Dynamic<?> dynamic) {
      return (TreeDecorator)this.field_21325.apply(dynamic);
   }
}
