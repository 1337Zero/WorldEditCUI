...
public class CocoaBeansTreeDecorator extends TreeDecorator {
   ...
   public <T> T serialize(DynamicOps<T> ops) {
      return (new Dynamic(ops, ops.createMap(ImmutableMap.of(ops.createString("type"), ops.createString(Registry.TREE_DECORATOR_TYPE.getId(this.field_21319).toString()), ops.createString("probability"), ops.createFloat(this.field_21318))))).getValue();
   }
}
