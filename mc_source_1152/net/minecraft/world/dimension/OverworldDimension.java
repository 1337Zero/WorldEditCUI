...
public class OverworldDimension extends Dimension {
   ...
   public ChunkGenerator<? extends ChunkGeneratorConfig> createChunkGenerator() {
      ...
      if (levelGeneratorType == LevelGeneratorType.FLAT) {
         ...
         FixedBiomeSourceConfig fixedBiomeSourceConfig = ((FixedBiomeSourceConfig)biomeSourceType.getConfig(this.world.getLevelProperties())).setBiome(flatChunkGeneratorConfig.getBiome());
         ...
         FixedBiomeSourceConfig fixedBiomeSourceConfig2 = ((FixedBiomeSourceConfig)biomeSourceType.getConfig(this.world.getLevelProperties())).setBiome(Biomes.PLAINS);
         ...
         VanillaLayeredBiomeSourceConfig vanillaLayeredBiomeSourceConfig2 = ((VanillaLayeredBiomeSourceConfig)biomeSourceType2.getConfig(this.world.getLevelProperties())).setGeneratorSettings(overworldChunkGeneratorConfig2);
         ...
         if (jsonObject2 != null && jsonObject2.has("type") && jsonObject2.has("options")) {
            ...
            if (BiomeSourceType.FIXED == biomeSourceType4) {
               FixedBiomeSourceConfig fixedBiomeSourceConfig3 = ((FixedBiomeSourceConfig)biomeSourceType.getConfig(this.world.getLevelProperties())).setBiome(biomes[0]);
            ...
            if (BiomeSourceType.CHECKERBOARD == biomeSourceType4) {
               ...
               CheckerboardBiomeSourceConfig checkerboardBiomeSourceConfig = ((CheckerboardBiomeSourceConfig)biomeSourceType3.getConfig(this.world.getLevelProperties())).setBiomes(biomes).setSize(j);
            ...
            if (BiomeSourceType.VANILLA_LAYERED == biomeSourceType4) {
               VanillaLayeredBiomeSourceConfig vanillaLayeredBiomeSourceConfig = (VanillaLayeredBiomeSourceConfig)biomeSourceType2.getConfig(this.world.getLevelProperties());
               biomeSource = biomeSourceType2.applyConfig(vanillaLayeredBiomeSourceConfig);
            }
         }

         if (biomeSource == null) {
            biomeSource = biomeSourceType.applyConfig(((FixedBiomeSourceConfig)biomeSourceType.getConfig(this.world.getLevelProperties())).setBiome(Biomes.OCEAN));
         }
