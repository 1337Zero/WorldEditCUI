...
public class DimensionType implements DynamicSerializable {
   ...
   private static DimensionType register(String id, DimensionType dimension) {
      return (DimensionType)Registry.register(Registry.DIMENSION_TYPE, dimension.id, id, dimension);
   }
   ...
   public static DimensionType deserialize(Dynamic<?> dynamic) {
      return (DimensionType)Registry.DIMENSION_TYPE.get(new Identifier(dynamic.asString("")));
   }
   ...
   public static DimensionType byId(Identifier identifier) {
      return (DimensionType)Registry.DIMENSION_TYPE.get(identifier);
   }
   ...
   static {
      OVERWORLD = register("overworld", new DimensionType(1, "", "", OverworldDimension::new, true, HorizontalVoronoiBiomeAccessType.INSTANCE));
      THE_NETHER = register("the_nether", new DimensionType(0, "_nether", "DIM-1", TheNetherDimension::new, false, VoronoiBiomeAccessType.INSTANCE));
      THE_END = register("the_end", new DimensionType(2, "_end", "DIM1", TheEndDimension::new, false, VoronoiBiomeAccessType.INSTANCE));
   }
}
