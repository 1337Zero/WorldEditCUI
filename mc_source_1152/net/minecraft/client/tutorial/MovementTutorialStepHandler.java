...
public class MovementTutorialStepHandler implements TutorialStepHandler {
   private static final Text MOVE_TITLE = new TranslatableText("tutorial.move.title", new Object[]{TutorialManager.getKeybindName("forward"), TutorialManager.getKeybindName("left"), TutorialManager.getKeybindName("back"), TutorialManager.getKeybindName("right")});
   private static final Text MOVE_DESCRIPTION = new TranslatableText("tutorial.move.description", new Object[]{TutorialManager.getKeybindName("jump")});
