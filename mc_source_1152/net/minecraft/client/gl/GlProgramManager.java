...
public class GlProgramManager {
   ...
   public static void linkProgram(GlProgram glProgram) throws IOException {
      ...
      if (i == 0) {
         LOGGER.warn("Error encountered when linking program containing VS {} and FS {}. Log output:", glProgram.getVertexShader().getName(), glProgram.getFragmentShader().getName());
