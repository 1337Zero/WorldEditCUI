...
public class PostProcessShader implements AutoCloseable {
   ...
   public void render(float time) {
      ...
      bufferBuilder.vertex(0.0D, 0.0D, 500.0D).color(255, 255, 255, 255).next();
      bufferBuilder.vertex((double)f, 0.0D, 500.0D).color(255, 255, 255, 255).next();
      bufferBuilder.vertex((double)f, (double)g, 500.0D).color(255, 255, 255, 255).next();
      bufferBuilder.vertex(0.0D, (double)g, 500.0D).color(255, 255, 255, 255).next();
      bufferBuilder.end();
