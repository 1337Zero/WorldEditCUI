...
public class GlDebug {
   ...
   protected static final FloatBuffer field_4916;
   protected static final IntBuffer field_4917;
   ...
   private static void info(int source, int type, int id, int severity, int i, long l, long m) {
      LOGGER.info("OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", id, getSource(source), getType(type), getSeverity(severity), GLDebugMessageCallback.getMessage(i, l));
   }

   private static void registerConstant(int constant, String description) {
      CONSTANTS.merge(constant, description, (string, string2) -> {
   ...
   static {
      field_4916 = field_4924.asFloatBuffer();
      field_4917 = field_4924.asIntBuffer();
      NEWLINE_JOINER = Joiner.on('\n');
      SEMICOLON_JOINER = Joiner.on("; ");
      CONSTANTS = Maps.newHashMap();
      KHR_VERBOSITY_LEVELS = ImmutableList.of(37190, 37191, 37192, 33387);
      ARB_VERBOSITY_LEVELS = ImmutableList.of(37190, 37191, 37192);
