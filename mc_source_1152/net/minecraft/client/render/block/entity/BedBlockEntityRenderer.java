...
public class BedBlockEntityRenderer extends BlockEntityRenderer<BedBlockEntity> {
   ...
   public void render(BedBlockEntity bedBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
      ...
      if (world != null) {
         ...
         DoubleBlockProperties.PropertySource<? extends BedBlockEntity> propertySource = DoubleBlockProperties.toPropertySource(BlockEntityType.BED, BedBlock::method_24164, BedBlock::method_24163, ChestBlock.FACING, blockState, world, bedBlockEntity.getPos(), (iWorld, blockPos) -> {
            return false;
         });
