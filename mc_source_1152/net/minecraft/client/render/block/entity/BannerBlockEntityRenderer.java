...
public class BannerBlockEntityRenderer extends BlockEntityRenderer<BannerBlockEntity> {
   ...
   public void render(BannerBlockEntity bannerBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
      ...
      if (list != null) {
         ...
         this.field.pitch = (-0.0125F + 0.01F * MathHelper.cos(6.2831855F * n)) * 3.1415927F;
   ...
   public static void method_23802(MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j, ModelPart modelPart, SpriteIdentifier spriteIdentifier, boolean bl, List<Pair<BannerPattern, DyeColor>> list) {
      ...
      for(int k = 0; k < 17 && k < list.size(); ++k) {
         ...
         SpriteIdentifier spriteIdentifier2 = new SpriteIdentifier(bl ? TexturedRenderLayers.BANNER_PATTERNS_ATLAS_TEXTURE : TexturedRenderLayers.SHIELD_PATTERNS_ATLAS_TEXTURE, ((BannerPattern)pair.getFirst()).getSpriteId(bl));
