...
public class SkyLightDebugRenderer implements DebugRenderer.Renderer {
   ...
   public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
      ...
      while(var12.hasNext()) {
         ...
         if (longSet.add(l)) {
            DebugRenderer.drawString(world.getChunkManager().getLightingProvider().method_22876(LightType.SKY, ChunkSectionPos.from(l)), (double)(ChunkSectionPos.getX(l) * 16 + 8), (double)(ChunkSectionPos.getY(l) * 16 + 8), (double)(ChunkSectionPos.getZ(l) * 16 + 8), 16711680, 0.3F);
         }
