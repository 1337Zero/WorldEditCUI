...
public class RenderLayers {
   private static final Map<Block, RenderLayer> BLOCKS = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
   ...
   private static final Map<Fluid, RenderLayer> FLUIDS = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
