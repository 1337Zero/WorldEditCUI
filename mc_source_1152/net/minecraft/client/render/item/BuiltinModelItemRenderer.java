   ...
   public void render(ItemStack stack, MatrixStack matrix, VertexConsumerProvider vertexConsumerProvider, int light, int overlay) {
      ...
      if (item instanceof BlockItem) {
         ...
         if (block instanceof AbstractSkullBlock) {
            ...
            SkullBlockEntityRenderer.render((Direction)null, 180.0F, ((AbstractSkullBlock)block).getSkullType(), gameProfile, 0.0F, matrix, vertexConsumerProvider, light);
         } else {
            Object blockEntity9;
            ...
            BlockEntityRenderDispatcher.INSTANCE.renderEntity((BlockEntity)blockEntity9, matrix, vertexConsumerProvider, light, overlay);
         }
      } else {
