...
public class VertexFormats {
   ...
   static {
      ...
      POSITION_COLOR_TEXTURE_LIGHT_NORMAL = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(TEXTURE_ELEMENT).add(LIGHT_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT).build());
      POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(TEXTURE_ELEMENT).add(OVERLAY_ELEMENT).add(LIGHT_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT).build());
      POSITION_TEXTURE_COLOR_LIGHT = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(COLOR_ELEMENT).add(LIGHT_ELEMENT).build());
      POSITION = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).build());
      POSITION_COLOR = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(COLOR_ELEMENT).build());
      POSITION_COLOR_LIGHT = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(LIGHT_ELEMENT).build());
      POSITION_TEXTURE = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).build());
      POSITION_COLOR_TEXTURE = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(TEXTURE_ELEMENT).build());
      POSITION_TEXTURE_COLOR = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(COLOR_ELEMENT).build());
      POSITION_COLOR_TEXTURE_LIGHT = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(COLOR_ELEMENT).add(TEXTURE_ELEMENT).add(LIGHT_ELEMENT).build());
      POSITION_TEXTURE_LIGHT_COLOR = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(LIGHT_ELEMENT).add(COLOR_ELEMENT).build());
      POSITION_TEXTURE_COLOR_NORMAL = new VertexFormat(ImmutableList.builder().add(POSITION_ELEMENT).add(TEXTURE_ELEMENT).add(COLOR_ELEMENT).add(NORMAL_ELEMENT).add(PADDING_ELEMENT).build());
   }
}
