...
public class Camera {
   ...
   private double clipToSpace(double desiredCameraDistance) {
      for(int i = 0; i < 8; ++i) {
         ...
         HitResult hitResult = this.area.rayTrace(new RayTraceContext(vec3d, vec3d2, RayTraceContext.ShapeType.COLLIDER, RayTraceContext.FluidHandling.NONE, this.focusedEntity));
