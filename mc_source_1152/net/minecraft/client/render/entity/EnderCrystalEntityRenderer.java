...
public class EnderCrystalEntityRenderer extends EntityRenderer<EnderCrystalEntity> {
   ...
   private static final RenderLayer field_21736;
   private static final float field_21002;
   ...
   static {
      field_21736 = RenderLayer.getEntityCutoutNoCull(SKIN);
      field_21002 = (float)Math.sin(0.7853981633974483D);
   }
}
