...
public class ArmorStandEntityModel extends ArmorStandArmorEntityModel {
   ...
   public void animateModel(ArmorStandEntity armorStandEntity, float f, float g, float h) {
      ...
      this.plate.yaw = 0.017453292F * -MathHelper.lerpAngleDegrees(h, armorStandEntity.prevYaw, armorStandEntity.yaw);
   ...
   public void setAngles(ArmorStandEntity armorStandEntity, float f, float g, float h, float i, float j) {
      ...
      this.hip.pitch = 0.017453292F * armorStandEntity.getBodyRotation().getPitch();
      this.hip.yaw = 0.017453292F * armorStandEntity.getBodyRotation().getYaw();
      this.hip.roll = 0.017453292F * armorStandEntity.getBodyRotation().getRoll();
   }
