...
public class RavagerEntityModel extends CompositeEntityModel<RavagerEntity> {
   ...
   public void setAngles(RavagerEntity ravagerEntity, float f, float g, float h, float i, float j) {
      this.field_3386.pitch = j * 0.017453292F;
      this.field_3386.yaw = i * 0.017453292F;
   ...
   public void animateModel(RavagerEntity ravagerEntity, float f, float g, float h) {
      ...
      float u;
      if (l > 0) {
         n = this.method_2801((float)l - h, 10.0F);
         o = (1.0F + n) * 0.5F;
         float p = o * o * o * 12.0F;
         u = p * MathHelper.sin(this.field_3384.pitch);
         this.field_3384.pivotZ = -6.5F + p;
         this.field_3384.pivotY = -7.0F - u;
         ...
         n = -1.0F;
         o = -1.0F * MathHelper.sin(this.field_3384.pitch);
         ...
         if (bl) {
            ...
            this.field_3384.pivotX = (float)Math.sin(d * 10.0D) * 3.0F;
         } else if (j > 0) {
