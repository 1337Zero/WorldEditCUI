      ...
      if (itemStack.getItem() instanceof ArmorItem) {
         ...
         if (armorItem.getSlotType() == equipmentSlot) {
            ...
            if (armorItem instanceof DyeableArmorItem) {
               ...
               float o = (float)(m >> 8 & 255) / 255.0F;
               float p = (float)(m & 255) / 255.0F;
               this.renderArmorParts(matrixStack, vertexConsumerProvider, l, armorItem, bl2, bipedEntityModel, bl, n, o, p, (String)null);
               this.renderArmorParts(matrixStack, vertexConsumerProvider, l, armorItem, bl2, bipedEntityModel, bl, 1.0F, 1.0F, 1.0F, "overlay");
            } else {
               this.renderArmorParts(matrixStack, vertexConsumerProvider, l, armorItem, bl2, bipedEntityModel, bl, 1.0F, 1.0F, 1.0F, (String)null);
            }
