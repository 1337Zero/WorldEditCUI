...
public class VillagerResourceMetadata {
   ...
   public static enum HatType {
      ...
      private static final Map<String, VillagerResourceMetadata.HatType> byName = (Map)Arrays.stream(values()).collect(Collectors.toMap(VillagerResourceMetadata.HatType::getName, (hatType) -> {
         return hatType;
      }));
