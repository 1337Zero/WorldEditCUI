...
public class TexturedRenderLayers {
   ...
   private static final RenderLayer ENTITY_TRANSLUCENT;
   ...
   static {
      ...
      ENTITY_SOLID = RenderLayer.getEntitySolid(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
      ENTITY_CUTOUT = RenderLayer.getEntityCutout(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
      ENTITY_TRANSLUCENT = RenderLayer.getEntityTranslucent(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
      ENTITY_TRANSLUCENT_CULL = RenderLayer.getEntityTranslucentCull(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
      ...
      WOOD_TYPE_TEXTURES = (Map)SignType.stream().collect(Collectors.toMap(Function.identity(), TexturedRenderLayers::getSignTextureId));
