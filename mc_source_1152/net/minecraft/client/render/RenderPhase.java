...
public abstract class RenderPhase {
   ...
   protected static final RenderPhase.Layering PROJECTION_LAYERING;
   ...
   protected static final RenderPhase.LineWidth FULL_LINEWIDTH;
   ...
   static {
      ...
      ALWAYS_DEPTH_TEST = new RenderPhase.DepthTest(519);
      ...
      PROJECTION_LAYERING = new RenderPhase.Layering("projection_layering", () -> {
      ...
      FULL_LINEWIDTH = new RenderPhase.LineWidth(OptionalDouble.of(1.0D));
   }
