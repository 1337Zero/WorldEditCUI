...
public class BubbleColumnSoundPlayer implements ClientPlayerTickable {
   ...
   public void tick() {
      ...
      BlockState blockState = world.getBlockState(this.player.getBoundingBox().expand(0.0D, -0.4000000059604645D, 0.0D).contract(0.001D), Blocks.BUBBLE_COLUMN);
      if (blockState != null) {
         if (!this.hasPlayedForCurrentColumn && !this.firstTick && blockState.getBlock() == Blocks.BUBBLE_COLUMN && !this.player.isSpectator()) {
