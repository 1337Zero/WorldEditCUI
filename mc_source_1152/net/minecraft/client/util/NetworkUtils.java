   ...
   public static CompletableFuture<?> download(File file, String string, Map<String, String> map, int i, @Nullable ProgressListener progressListener, Proxy proxy) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         if (progressListener != null) {
            progressListener.method_15413(new TranslatableText("resourcepack.downloading", new Object[0]));
            progressListener.method_15414(new TranslatableText("resourcepack.requesting", new Object[0]));
         }
