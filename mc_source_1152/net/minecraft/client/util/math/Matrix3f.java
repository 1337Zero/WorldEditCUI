...
public final class Matrix3f {
   ...
   private static final float SQRT_HALF = 1.0F / (float)Math.sqrt(2.0D);
   protected float a00;
   protected float a01;
   protected float a02;
   protected float a10;
   ...
   private static Quaternion method_22857(Matrix3f matrix3f) {
      ...
      if (matrix3f.a01 * matrix3f.a01 + matrix3f.a10 * matrix3f.a10 > 1.0E-6F) {
         ...
         float4 = (Float)pair3.getFirst();
         float5 = (Float)pair3.getSecond();
   ...
   public Triple<Quaternion, Vector3f, Quaternion> decomposeLinearTransformation() {
      ...
      Float var7 = (Float)pair.getFirst();
      Float float2 = (Float)pair.getSecond();
      float g = float2 * float2 - var7 * var7;
      float h = -2.0F * var7 * float2;
      float j = float2 * float2 + var7 * var7;
      Quaternion quaternion3 = new Quaternion(0.0F, 0.0F, var7, float2);
