...
public class BlockColors {
   ...
   public static BlockColors create() {
      ...
      blockColors.registerColorProvider((state, view, pos, tintIndex) -> {
         return view != null && pos != null ? BiomeColors.getGrassColor(view, state.get(ReplaceableTallPlantBlock.HALF) == DoubleBlockHalf.UPPER ? pos.down() : pos) : -1;
      ...
      blockColors.registerColorProvider((state, view, pos, tintIndex) -> {
         return view != null && pos != null ? 2129968 : 7455580;
      }, Blocks.LILY_PAD);
      return blockColors;
   }
