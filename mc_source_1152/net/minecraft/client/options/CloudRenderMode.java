...
public enum CloudRenderMode {
   ...
   private static final CloudRenderMode[] RENDER_MODES = (CloudRenderMode[])Arrays.stream(values()).sorted(Comparator.comparingInt(CloudRenderMode::getValue)).toArray((i) -> {
      return new CloudRenderMode[i];
   });
