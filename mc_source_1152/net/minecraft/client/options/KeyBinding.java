...
public class KeyBinding implements Comparable<KeyBinding> {
   ...
   private static final Map<String, Integer> categoryOrderMap = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
   ...
   public static void updatePressedStates() {
      Iterator var0 = keysById.values().iterator();
   ...
   public int compareTo(KeyBinding keyBinding) {
      return this.category.equals(keyBinding.category) ? I18n.translate(this.id).compareTo(I18n.translate(keyBinding.id)) : ((Integer)categoryOrderMap.get(this.category)).compareTo((Integer)categoryOrderMap.get(keyBinding.category));
   }
