   ...
   public void addResourcePackProfilesToManager(ResourcePackManager<ClientResourcePackProfile> manager) {
      ...
      while(true) {
         while(iterator.hasNext()) {
            ...
            ClientResourcePackProfile clientResourcePackProfile = (ClientResourcePackProfile)manager.getProfile(string);
            if (clientResourcePackProfile == null && !string.startsWith("file/")) {
               clientResourcePackProfile = (ClientResourcePackProfile)manager.getProfile("file/" + string);
            }
