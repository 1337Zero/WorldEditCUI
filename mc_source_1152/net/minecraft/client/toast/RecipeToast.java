...
public class RecipeToast implements Toast {
   ...
   public Toast.Visibility draw(ToastManager manager, long currentTime) {
      ...
      if (this.recipes.isEmpty()) {
         ...
         manager.getGame().getItemRenderer().renderGuiItem((LivingEntity)null, itemStack, 3, 3);
         RenderSystem.popMatrix();
         manager.getGame().getItemRenderer().renderGuiItem((LivingEntity)null, recipe.getOutput(), 8, 8);
   ...
   public static void show(ToastManager toastManager, Recipe<?> recipe) {
      RecipeToast recipeToast = (RecipeToast)toastManager.getToast(RecipeToast.class, field_2208);
      if (recipeToast == null) {
