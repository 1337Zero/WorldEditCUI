...
public class TrueTypeFont implements Font {
   ...
   public TrueTypeFont(ByteBuffer byteBuffer, STBTTFontinfo sTBTTFontinfo, float f, float g, float h, float i, String string) {
      ...
      this.oversample = g;
      string.chars().forEach((ix) -> {
         this.excludedCharacters.add((char)(ix & '\uffff'));
      });
      this.shiftX = h * g;
      this.shiftY = i * g;
         ...
         try {
            ...
            if (i != 0) {
               ...
               if (j != 0 && k != 0) {
                  ...
                  TrueTypeFont.TtfGlyph var13 = new TrueTypeFont.TtfGlyph(intBuffer.get(0), intBuffer3.get(0), -intBuffer2.get(0), -intBuffer4.get(0), (float)intBuffer5.get(0) * this.scaleFactor, (float)intBuffer6.get(0) * this.scaleFactor, i);
                  return var13;
               }
