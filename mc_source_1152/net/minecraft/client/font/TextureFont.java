      ...
      public Font load(ResourceManager manager) {
         try {
            ...
            try {
               ...
               for(int m = 0; m < this.chars.size(); ++m) {
                  ...
                  for(int n = 0; n < string.length(); ++n) {
                     ...
                     if (c != 0 && c != ' ') {
                        ...
                        TextureFont.TextureFontGlyph textureFontGlyph = (TextureFont.TextureFontGlyph)char2ObjectMap.put(c, new TextureFont.TextureFontGlyph(f, nativeImage, n * k, m * l, k, l, (int)(0.5D + (double)((float)o * f)) + 1, this.ascent));
               ...
               TextureFont var28 = new TextureFont(nativeImage, char2ObjectMap);
               return var28;
