...
public class LockButtonWidget extends ButtonWidget {
   ...
   public void renderButton(int mouseX, int mouseY, float delta) {
      ...
      LockButtonWidget.IconLocation iconLocation3;
      if (!this.active) {
         iconLocation3 = this.locked ? LockButtonWidget.IconLocation.LOCKED_DISABLED : LockButtonWidget.IconLocation.UNLOCKED_DISABLED;
      } else if (this.isHovered()) {
         iconLocation3 = this.locked ? LockButtonWidget.IconLocation.LOCKED_HOVER : LockButtonWidget.IconLocation.UNLOCKED_HOVER;
      } else {
         iconLocation3 = this.locked ? LockButtonWidget.IconLocation.LOCKED : LockButtonWidget.IconLocation.UNLOCKED;
      }

      this.blit(this.x, this.y, iconLocation3.getU(), iconLocation3.getV(), this.width, this.height);
   }
