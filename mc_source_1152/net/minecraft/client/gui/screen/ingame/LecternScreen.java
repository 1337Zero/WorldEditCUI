...
public class LecternScreen extends BookScreen implements ContainerProvider<LecternContainer> {
   ...
   protected void addCloseButton() {
      if (this.minecraft.player.canModifyWorld()) {
         this.addButton(new ButtonWidget(this.width / 2 - 100, 196, 98, 20, I18n.translate("gui.done"), (buttonWidget) -> {
            this.minecraft.openScreen((Screen)null);
         }));
         this.addButton(new ButtonWidget(this.width / 2 + 2, 196, 98, 20, I18n.translate("lectern.take_book"), (buttonWidget) -> {
