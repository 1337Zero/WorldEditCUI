...
public class JigsawBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 4 - 150, 210, 150, 20, I18n.translate("gui.done"), (buttonWidget) -> {
         this.onDone();
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 4, 210, 150, 20, I18n.translate("gui.cancel"), (buttonWidget) -> {
         this.onCancel();
      }));
      ...
      this.targetPoolField.setChangedListener((string) -> {
      ...
      this.attachmentTypeField.setChangedListener((string) -> {
         this.updateDoneButtonState();
      });
