...
public class StructureBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.buttonDone = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 4 - 150, 210, 150, 20, I18n.translate("gui.done"), (buttonWidget) -> {
         this.done();
      }));
      this.buttonCancel = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4, 210, 150, 20, I18n.translate("gui.cancel"), (buttonWidget) -> {
         this.cancel();
      }));
      this.buttonSave = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, I18n.translate("structure_block.button.save"), (buttonWidget) -> {
      ...
      this.buttonLoad = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 185, 50, 20, I18n.translate("structure_block.button.load"), (buttonWidget) -> {
      ...
      this.buttonMode = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 4 - 150, 185, 50, 20, "MODE", (buttonWidget) -> {
         this.structureBlock.cycleMode();
         this.updateMode();
      }));
      this.buttonDetect = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 120, 50, 20, I18n.translate("structure_block.button.detect_size"), (buttonWidget) -> {
         if (this.structureBlock.getMode() == StructureBlockMode.SAVE) {
      ...
      this.buttonEntities = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 160, 50, 20, "ENTITIES", (buttonWidget) -> {
         this.structureBlock.setIgnoreEntities(!this.structureBlock.shouldIgnoreEntities());
         this.updateIgnoreEntitiesButton();
      }));
      this.buttonMirror = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 20, 185, 40, 20, "MIRROR", (buttonWidget) -> {
      ...
      this.buttonShowAir = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 80, 50, 20, "SHOWAIR", (buttonWidget) -> {
         this.structureBlock.setShowAir(!this.structureBlock.shouldShowAir());
         this.updateShowAirButton();
      }));
      this.buttonShowBoundingBox = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4 + 100, 80, 50, 20, "SHOWBB", (buttonWidget) -> {
         this.structureBlock.setShowBoundingBox(!this.structureBlock.shouldShowBoundingBox());
         this.updateShowBoundingBoxButton();
      }));
      this.buttonRotate0 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20, "0", (buttonWidget) -> {
         this.structureBlock.setRotation(BlockRotation.NONE);
         this.updateRotationButton();
      }));
      this.buttonRotate90 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 1 - 40 - 20, 185, 40, 20, "90", (buttonWidget) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_90);
         this.updateRotationButton();
      }));
      this.buttonRotate180 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 1 + 20, 185, 40, 20, "180", (buttonWidget) -> {
         this.structureBlock.setRotation(BlockRotation.CLOCKWISE_180);
         this.updateRotationButton();
      }));
      this.buttonRotate270 = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 1 + 40 + 1 + 20, 185, 40, 20, "270", (buttonWidget) -> {
   ...
   public void render(int mouseX, int mouseY, float delta) {
      ...
      if (structureBlockMode == StructureBlockMode.LOAD || structureBlockMode == StructureBlockMode.SAVE) {
         ...
         string5 = I18n.translate("structure_block.include_entities");
         l = this.font.getStringWidth(string5);
         this.drawString(this.font, string5, this.width / 2 + 154 - l, 150, 10526880);
      }
      ...
      if (structureBlockMode == StructureBlockMode.SAVE) {
         ...
         string5 = I18n.translate("structure_block.detect_size");
         l = this.font.getStringWidth(string5);
         this.drawString(this.font, string5, this.width / 2 + 154 - l, 110, 10526880);
         String string3 = I18n.translate("structure_block.show_air");
         int k = this.font.getStringWidth(string3);
         this.drawString(this.font, string3, this.width / 2 + 154 - k, 70, 10526880);
      }
      ...
      if (structureBlockMode == StructureBlockMode.LOAD) {
         ...
         string5 = I18n.translate("structure_block.show_boundingbox");
         l = this.font.getStringWidth(string5);
         this.drawString(this.font, string5, this.width / 2 + 154 - l, 70, 10526880);
      }
      ...
      string5 = "structure_block.mode_info." + structureBlockMode.asString();
