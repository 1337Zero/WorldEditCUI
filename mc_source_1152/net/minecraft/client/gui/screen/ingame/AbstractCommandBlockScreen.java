...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.translate("gui.done"), (buttonWidget) -> {
         this.commitAndClose();
      }));
      this.cancelButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.translate("gui.cancel"), (buttonWidget) -> {
         this.onClose();
      }));
      this.toggleTrackingOutputButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 150 - 20, this.getTrackOutputButtonHeight(), 20, 20, "O", (buttonWidget) -> {
      ...
      this.previousOutputTextField = new TextFieldWidget(this.font, this.width / 2 - 150, this.getTrackOutputButtonHeight(), 276, 20, I18n.translate("advMode.previousOutput"));
