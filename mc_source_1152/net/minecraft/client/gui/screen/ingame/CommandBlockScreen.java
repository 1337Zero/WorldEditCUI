...
public class CommandBlockScreen extends AbstractCommandBlockScreen {
   ...
   protected void init() {
      super.init();
      this.modeButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 50 - 100 - 4, 165, 100, 20, I18n.translate("advMode.mode.sequence"), (buttonWidget) -> {
         this.cycleType();
         this.updateMode();
      }));
      this.conditionalModeButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 50, 165, 100, 20, I18n.translate("advMode.mode.unconditional"), (buttonWidget) -> {
         this.conditional = !this.conditional;
         this.updateConditionalMode();
      }));
      this.redstoneTriggerButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 50 + 4, 165, 100, 20, I18n.translate("advMode.mode.redstoneTriggered"), (buttonWidget) -> {
