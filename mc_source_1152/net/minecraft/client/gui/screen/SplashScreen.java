...
public class SplashScreen extends Overlay {
   ...
   private void renderProgressBar(int minX, int minY, int maxX, int maxY, float progress) {
      ...
      fill(minX + 1, minY + 1, minX + i, maxY - 1, -16777216 | (int)MathHelper.lerp(1.0F - progress, 226.0F, 255.0F) << 16 | (int)MathHelper.lerp(1.0F - progress, 40.0F, 255.0F) << 8 | (int)MathHelper.lerp(1.0F - progress, 55.0F, 255.0F));
   }
   ...
   static class LogoTexture extends ResourceTexture {
      ...
      protected ResourceTexture.TextureData loadTextureData(ResourceManager resourceManager) {
         ...
         try {
            ...
            try {
               var6 = new ResourceTexture.TextureData((TextureResourceMetadata)null, NativeImage.read(inputStream));
