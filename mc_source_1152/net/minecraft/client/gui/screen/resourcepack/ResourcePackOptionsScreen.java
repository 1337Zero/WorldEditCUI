   ...
   protected void init() {
      ...
      this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 48, 150, 20, I18n.translate("gui.done"), (buttonWidget) -> {
         if (this.dirty) {
            ...
            Iterator var3 = this.enabledPacks.children().iterator();
      ...
      if (!this.dirty) {
         ...
         while(var5.hasNext()) {
            ...
            this.availablePacks.add(new ResourcePackListWidget.ResourcePackEntry(this.availablePacks, this, clientResourcePackProfile2));
         }
