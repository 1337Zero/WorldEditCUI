...
public class RecipeAlternativesWidget extends DrawableHelper implements Drawable, Element {
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      if (button != 0) {
         ...
         do {
            ...
            alternativeButtonWidget = (RecipeAlternativesWidget.AlternativeButtonWidget)var6.next();
   ...
   public void render(int mouseX, int mouseY, float delta) {
      if (this.visible) {
         ...
         Iterator var11 = this.alternativeButtons.iterator();

         while(var11.hasNext()) {
            RecipeAlternativesWidget.AlternativeButtonWidget alternativeButtonWidget = (RecipeAlternativesWidget.AlternativeButtonWidget)var11.next();
   ...
   class AlternativeButtonWidget extends AbstractButtonWidget implements RecipeGridAligner<Ingredient> {
      ...
      public void renderButton(int mouseX, int mouseY, float delta) {
         ...
         Iterator var6 = this.slots.iterator();

         while(var6.hasNext()) {
            RecipeAlternativesWidget.AlternativeButtonWidget.InputSlot inputSlot = (RecipeAlternativesWidget.AlternativeButtonWidget.InputSlot)var6.next();
            RenderSystem.pushMatrix();
            float f = 0.42F;
   ...
   class FurnaceAlternativeButtonWidget extends RecipeAlternativesWidget.AlternativeButtonWidget {
      ...
      protected void alignRecipe(Recipe<?> recipe) {
         ItemStack[] itemStacks = ((Ingredient)recipe.getPreviewInputs().get(0)).getMatchingStacksClient();
