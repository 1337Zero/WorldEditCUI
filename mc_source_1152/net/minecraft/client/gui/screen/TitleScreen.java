...
public class TitleScreen extends Screen {
   ...
   private void initWidgetsNormal(int y, int spacingY) {
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 100, y + spacingY * 2, 200, 20, I18n.translate("menu.online"), (buttonWidget) -> {
         this.switchToRealms();
      }));
   }

   private void initWidgetsDemo(int y, int spacingY) {
      this.addButton(new ButtonWidget(this.width / 2 - 100, y, 200, 20, I18n.translate("menu.playdemo"), (buttonWidget) -> {
         this.minecraft.startIntegratedServer("Demo_World", "Demo_World", MinecraftServer.DEMO_LEVEL_INFO);
      }));
      this.buttonResetDemo = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, y + spacingY * 1, 200, 20, I18n.translate("menu.resetdemo"), (buttonWidget) -> {
         ...
         if (levelProperties != null) {
            this.minecraft.openScreen(new ConfirmScreen(this::onDemoDeletionConfirmed, new TranslatableText("selectWorld.deleteQuestion", new Object[0]), new TranslatableText("selectWorld.deleteWarning", new Object[]{levelProperties.getLevelName()}), I18n.translate("selectWorld.deleteButton"), I18n.translate("gui.cancel")));
         }
   ...
   public void render(int mouseX, int mouseY, float delta) {
      ...
      if ((l & -67108864) != 0) {
         ...
         while(var11.hasNext()) {
            AbstractButtonWidget abstractButtonWidget = (AbstractButtonWidget)var11.next();
