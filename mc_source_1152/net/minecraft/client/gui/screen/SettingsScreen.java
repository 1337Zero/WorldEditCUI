...
public class SettingsScreen extends Screen {
   ...
   protected void init() {
      ...
      if (this.minecraft.world != null) {
         ...
         this.difficultyButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, this.getDifficultyButtonText(this.difficulty), (buttonWidget) -> {
         ...
         if (this.minecraft.isIntegratedServerRunning() && !this.minecraft.world.getLevelProperties().isHardcore()) {
            ...
            this.lockDifficultyButton = (LockButtonWidget)this.addButton(new LockButtonWidget(this.difficultyButton.x + this.difficultyButton.getWidth(), this.difficultyButton.y, (buttonWidget) -> {
               this.minecraft.openScreen(new ConfirmScreen(this::lockDifficulty, new TranslatableText("difficulty.lock.title", new Object[0]), new TranslatableText("difficulty.lock.question", new Object[]{new TranslatableText("options.difficulty." + this.minecraft.world.getLevelProperties().getDifficulty().getName(), new Object[0])})));
            }));
      ...
      this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 6 + 48 - 6, 150, 20, I18n.translate("options.skinCustomisation"), (buttonWidget) -> {
         this.minecraft.openScreen(new SkinOptionsScreen(this, this.settings));
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, I18n.translate("options.sounds"), (buttonWidget) -> {
         this.minecraft.openScreen(new SoundOptionsScreen(this, this.settings));
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 6 + 72 - 6, 150, 20, I18n.translate("options.video"), (buttonWidget) -> {
         this.minecraft.openScreen(new VideoOptionsScreen(this, this.settings));
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.translate("options.controls"), (buttonWidget) -> {
         this.minecraft.openScreen(new ControlsOptionsScreen(this, this.settings));
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 6 + 96 - 6, 150, 20, I18n.translate("options.language"), (buttonWidget) -> {
         this.minecraft.openScreen(new LanguageOptionsScreen(this, this.settings, this.minecraft.getLanguageManager()));
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 5, this.height / 6 + 96 - 6, 150, 20, I18n.translate("options.chat.title"), (buttonWidget) -> {
         this.minecraft.openScreen(new ChatOptionsScreen(this, this.settings));
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 6 + 120 - 6, 150, 20, I18n.translate("options.resourcepack"), (buttonWidget) -> {
         this.minecraft.openScreen(new ResourcePackOptionsScreen(this, this.settings));
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 5, this.height / 6 + 120 - 6, 150, 20, I18n.translate("options.accessibility.title"), (buttonWidget) -> {
         this.minecraft.openScreen(new AccessibilityScreen(this, this.settings));
      }));
