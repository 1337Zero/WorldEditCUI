...
public class DirectConnectScreen extends Screen {
   ...
   protected void init() {
      ...
      this.selectServerButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20, I18n.translate("selectServer.select"), (buttonWidget) -> {
         this.saveAndClose();
      }));
