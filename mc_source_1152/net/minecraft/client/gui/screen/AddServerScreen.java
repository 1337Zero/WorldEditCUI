...
public class AddServerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.resourcePackOptionButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 72, 200, 20, I18n.translate("addServer.resourcePack") + ": " + this.server.getResourcePack().getName().asFormattedString(), (buttonWidget) -> {
      ...
      this.buttonAdd = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 96 + 18, 200, 20, I18n.translate("addServer.add"), (buttonWidget) -> {
         this.addAndClose();
      }));
      this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 120 + 18, 200, 20, I18n.translate("gui.cancel"), (buttonWidget) -> {
