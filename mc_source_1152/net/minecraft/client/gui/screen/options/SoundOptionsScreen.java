...
public class SoundOptionsScreen extends GameOptionsScreen {
   public SoundOptionsScreen(Screen parent, GameOptions options) {
      super(parent, options, new TranslatableText("options.sounds.title", new Object[0]));
   }
   ...
   protected void init() {
      ...
      ++i;
      this.addButton(new OptionButtonWidget(var10003, var10004 + 24 * (i >> 1), 150, 20, Option.SUBTITLES, Option.SUBTITLES.getDisplayString(this.gameOptions), (buttonWidget) -> {
