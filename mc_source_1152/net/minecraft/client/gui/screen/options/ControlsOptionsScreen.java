...
public class ControlsOptionsScreen extends GameOptionsScreen {
   ...
   protected void init() {
      ...
      this.resetButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 155, this.height - 29, 150, 20, I18n.translate("controls.resetAll"), (buttonWidget) -> {
   ...
   public void render(int mouseX, int mouseY, float delta) {
      ...
      boolean bl = false;
      KeyBinding[] var5 = this.gameOptions.keysAll;
