...
public class LanguageOptionsScreen extends GameOptionsScreen {
   ...
   protected void init() {
      ...
      this.forceUnicodeButton = (OptionButtonWidget)this.addButton(new OptionButtonWidget(this.width / 2 - 155, this.height - 38, 150, 20, Option.FORCE_UNICODE_FONT, Option.FORCE_UNICODE_FONT.getDisplayString(this.gameOptions), (buttonWidget) -> {
      ...
      this.doneButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 155 + 160, this.height - 38, 150, 20, I18n.translate("gui.done"), (buttonWidget) -> {
   ...
   class LanguageSelectionListWidget extends AlwaysSelectedEntryListWidget<LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry> {
      ...
      public class LanguageEntry extends AlwaysSelectedEntryListWidget.Entry<LanguageOptionsScreen.LanguageSelectionListWidget.LanguageEntry> {
         ...
         public void render(int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
            ...
            LanguageSelectionListWidget.this.drawCenteredString(LanguageOptionsScreen.this.font, this.languageDefinition.toString(), LanguageSelectionListWidget.this.width / 2, j + 1, 16777215);
