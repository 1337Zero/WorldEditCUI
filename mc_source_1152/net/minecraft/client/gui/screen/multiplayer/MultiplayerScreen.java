...
public class MultiplayerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.buttonJoin = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 52, 100, 20, I18n.translate("selectServer.select"), (buttonWidget) -> {
         this.connect();
      }));
      ...
      this.buttonEdit = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 28, 70, 20, I18n.translate("selectServer.edit"), (buttonWidget) -> {
      ...
      this.buttonDelete = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 74, this.height - 28, 70, 20, I18n.translate("selectServer.delete"), (buttonWidget) -> {
         MultiplayerServerListWidget.Entry entry = (MultiplayerServerListWidget.Entry)this.serverListWidget.getSelected();
         if (entry instanceof MultiplayerServerListWidget.ServerEntry) {
            String string = ((MultiplayerServerListWidget.ServerEntry)entry).getServer().name;
            if (string != null) {
               Text text = new TranslatableText("selectServer.deleteQuestion", new Object[0]);
      ...
      this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 28, 70, 20, I18n.translate("selectServer.refresh"), (buttonWidget) -> {
         this.refresh();
      }));
      this.addButton(new ButtonWidget(this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.translate("gui.cancel"), (buttonWidget) -> {
