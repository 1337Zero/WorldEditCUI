...
public class SelectWorldScreen extends Screen {
   ...
   protected void init() {
      ...
      this.levelList = new WorldListWidget(this, this.minecraft, this.width, this.height, 48, this.height - 64, 36, () -> {
         return this.searchBox.getText();
      }, this.levelList);
      this.children.add(this.searchBox);
      this.children.add(this.levelList);
      this.selectButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 52, 150, 20, I18n.translate("selectWorld.select"), (buttonWidget) -> {
      ...
      this.editButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 154, this.height - 28, 72, 20, I18n.translate("selectWorld.edit"), (buttonWidget) -> {
         this.levelList.method_20159().ifPresent(WorldListWidget.Entry::edit);
      }));
      this.deleteButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 76, this.height - 28, 72, 20, I18n.translate("selectWorld.delete"), (buttonWidget) -> {
         this.levelList.method_20159().ifPresent(WorldListWidget.Entry::delete);
      }));
      this.recreateButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 4, this.height - 28, 72, 20, I18n.translate("selectWorld.recreate"), (buttonWidget) -> {
