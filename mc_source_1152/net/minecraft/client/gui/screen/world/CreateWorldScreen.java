...
public class CreateWorldScreen extends Screen {
   ...
   protected void init() {
      ...
      this.gameModeSwitchButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 75, 115, 150, 20, I18n.translate("selectWorld.gameMode"), (buttonWidget) -> {
      ...
      this.generateStructuresButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 155, 100, 150, 20, I18n.translate("selectWorld.mapFeatures"), (buttonWidget) -> {
      ...
      this.mapTypeSwitchButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 5, 100, 150, 20, I18n.translate("selectWorld.mapType"), (buttonWidget) -> {
         ++this.generatorType;
         ...
         protected String getNarrationMessage() {
            ...
            return levelGeneratorType.hasInfo() ? super.getNarrationMessage() + ". " + I18n.translate(levelGeneratorType.getInfoTranslationKey()) : super.getNarrationMessage();
         }
      });
      this.mapTypeSwitchButton.visible = false;
      this.customizeTypeButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 5, 120, 150, 20, I18n.translate("selectWorld.customizeType"), (buttonWidget) -> {
      ...
      this.enableCheatsButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 155, 151, 150, 20, I18n.translate("selectWorld.allowCommands"), (buttonWidget) -> {
         this.tweakedCheats = true;
         this.cheatsEnabled = !this.cheatsEnabled;
         buttonWidget.queueNarration(250);
      }) {
         public String getMessage() {
            return I18n.translate("selectWorld.allowCommands") + ' ' + I18n.translate(CreateWorldScreen.this.cheatsEnabled && !CreateWorldScreen.this.hardcore ? "options.on" : "options.off");
         }
      ...
      this.generateBonusChestButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 + 5, 151, 150, 20, I18n.translate("selectWorld.bonusItems"), (buttonWidget) -> {
         this.bonusChest = !this.bonusChest;
         buttonWidget.queueNarration(250);
      }) {
         public String getMessage() {
            return I18n.translate("selectWorld.bonusItems") + ' ' + I18n.translate(CreateWorldScreen.this.bonusChest && !CreateWorldScreen.this.hardcore ? "options.on" : "options.off");
         }
      });
      this.generateBonusChestButton.visible = false;
      this.moreOptionsButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 75, 187, 150, 20, I18n.translate("selectWorld.moreWorldOptions"), (buttonWidget) -> {
         this.toggleMoreOptions();
      }));
      this.createLevelButton = (ButtonWidget)this.addButton(new ButtonWidget(this.width / 2 - 155, this.height - 28, 150, 20, I18n.translate("selectWorld.create"), (buttonWidget) -> {
         this.createLevel();
      }));
   ...
   public void render(int mouseX, int mouseY, float delta) {
      ...
      if (this.moreOptionsOpen) {
         ...
         if (LevelGeneratorType.TYPES[this.generatorType].hasInfo()) {
            this.font.drawTrimmed(I18n.translate(LevelGeneratorType.TYPES[this.generatorType].getInfoTranslationKey()), this.mapTypeSwitchButton.x + 2, this.mapTypeSwitchButton.y + 22, this.mapTypeSwitchButton.getWidth(), 10526880);
         }
      } else {
