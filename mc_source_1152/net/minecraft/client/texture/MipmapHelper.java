      ...
      if (mipmap > 0) {
         ...
         for(k = 0; k < image.getWidth(); ++k) {
            for(int j = 0; j < image.getHeight(); ++j) {
               if (image.getPixelRgba(k, j) >> 24 == 0) {
                  bl = true;
                  break label51;
               }
            }
         ...
         for(k = 1; k <= mipmap; ++k) {
            ...
            for(int n = 0; n < l; ++n) {
               for(int o = 0; o < m; ++o) {
                  nativeImage2.setPixelRgba(n, o, blend(nativeImage.getPixelRgba(n * 2 + 0, o * 2 + 0), nativeImage.getPixelRgba(n * 2 + 1, o * 2 + 0), nativeImage.getPixelRgba(n * 2 + 0, o * 2 + 1), nativeImage.getPixelRgba(n * 2 + 1, o * 2 + 1), bl));
               }
            }
