...
public final class NativeImage implements AutoCloseable {
   ...
   public static NativeImage read(@Nullable NativeImage.Format format, ByteBuffer byteBuffer) throws IOException {
      if (format != null && !format.isWriteable()) {
         ...
         try {
            ...
            var8 = new NativeImage(format == null ? NativeImage.Format.getFormat(intBuffer3.get(0)) : format, intBuffer.get(0), intBuffer2.get(0), true, MemoryUtil.memAddress(byteBuffer2));
   ...
   public static int method_24031(int i, int j, int k, int l) {
      return (i & 255) << 24 | (j & 255) << 16 | (k & 255) << 8 | (l & 255) << 0;
   }
