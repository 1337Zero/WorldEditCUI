...
public class ElderGuardianAppearanceParticle extends Particle {
   private final Model field_21793;
   private final RenderLayer field_21792;

   private ElderGuardianAppearanceParticle(World world, double x, double y, double z) {
      super(world, x, y, z);
      this.field_21793 = new GuardianEntityModel();
      this.field_21792 = RenderLayer.getEntityTranslucent(ElderGuardianEntityRenderer.SKIN);
