...
public class ClientPlayNetworkHandler implements ClientPlayPacketListener {
   ...
   public void onGameJoin(GameJoinS2CPacket packet) {
      ...
      this.world = new ClientWorld(this, new LevelInfo(packet.getSeed(), packet.getGameMode(), false, packet.isHardcore(), packet.getGeneratorType()), packet.getDimension(), this.chunkLoadDistance, this.client.getProfiler(), this.client.worldRenderer);
   ...
   public void onEntitySpawn(EntitySpawnS2CPacket packet) {
      ...
      if (entityType == EntityType.CHEST_MINECART) {
         ...
         if (entityType == EntityType.FISHING_BOBBER) {
            ...
            entity16 = this.world.getEntityById(packet.getEntityData());
            if (entity16 != null) {
               ((ProjectileEntity)entity15).setOwner(entity16);
            }
            ...
            entity15 = new LeadKnotEntity(this.world, new BlockPos(d, e, f));
         } else if (entityType == EntityType.ENDER_PEARL) {
            entity15 = new ThrownEnderpearlEntity(this.world, d, e, f);
         } else if (entityType == EntityType.EYE_OF_ENDER) {
            entity15 = new EnderEyeEntity(this.world, d, e, f);
         } else if (entityType == EntityType.FIREWORK_ROCKET) {
            entity15 = new FireworkEntity(this.world, d, e, f, ItemStack.EMPTY);
            ...
            entity15 = new ThrownEggEntity(this.world, d, e, f);
            ...
            entity15 = new ThrownPotionEntity(this.world, d, e, f);
         } else if (entityType == EntityType.EXPERIENCE_BOTTLE) {
            entity15 = new ThrownExperienceBottleEntity(this.world, d, e, f);
            ...
            entity15 = new EnderCrystalEntity(this.world, d, e, f);
      ...
      if (entity != null) {
         if (!entity.isLogicalSideForUpdatingMovement()) {
            ...
            if (packet.method_22826()) {
               ...
               entity.updateTrackedPositionAndAngles(vec3d.x, vec3d.y, vec3d.z, i, g, 3, false);
   ...
   public void onChunkDeltaUpdate(ChunkDeltaUpdateS2CPacket packet) {
      NetworkThreadUtils.forceMainThread(packet, this, (ThreadExecutor)this.client);
      ChunkDeltaUpdateS2CPacket.ChunkDeltaRecord[] var2 = packet.getRecords();
      int var3 = var2.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         ChunkDeltaUpdateS2CPacket.ChunkDeltaRecord chunkDeltaRecord = var2[var4];
   ...
   public void onChunkData(ChunkDataS2CPacket packet) {
      ...
      Iterator var9 = packet.getBlockEntityTagList().iterator();

      while(var9.hasNext()) {
         CompoundTag compoundTag = (CompoundTag)var9.next();
   ...
   public void onItemPickupAnimation(ItemPickupAnimationS2CPacket packet) {
      ...
      if (entity != null) {
         ...
         this.client.particleManager.addParticle(new ItemPickupParticle(this.client.getEntityRenderManager(), this.client.getBufferBuilders(), this.world, entity, (Entity)livingEntity));
   ...
   public void onMobSpawn(MobSpawnS2CPacket packet) {
      ...
      if (livingEntity != null) {
         ...
         if (livingEntity instanceof BeeEntity) {
            ...
            this.client.getSoundManager().play((SoundInstance)abstractBeeSoundInstance2);
         }
      } else {
   ...
   public void onPlayerRespawn(PlayerRespawnS2CPacket packet) {
      ...
      if (dimensionType != clientPlayerEntity.dimension) {
         ...
         this.world = new ClientWorld(this, new LevelInfo(packet.method_22425(), packet.getGameMode(), false, this.client.world.getLevelProperties().isHardcore(), packet.getGeneratorType()), packet.getDimension(), this.chunkLoadDistance, this.client.getProfiler(), this.client.worldRenderer);
   ...
   public void onGameStateChange(GameStateChangeS2CPacket packet) {
      ...
      if (i >= 0 && i < GameStateChangeS2CPacket.REASON_MESSAGES.length && GameStateChangeS2CPacket.REASON_MESSAGES[i] != null) {
         playerEntity.addChatMessage(new TranslatableText(GameStateChangeS2CPacket.REASON_MESSAGES[i], new Object[0]), false);
      }
      ...
      if (i == 1) {
         ...
         if (f == 0.0F) {
            ...
            this.client.inGameHud.getChatHud().addMessage(new TranslatableText("demo.help.movement", new Object[]{gameOptions.keyForward.getLocalizedName(), gameOptions.keyLeft.getLocalizedName(), gameOptions.keyBack.getLocalizedName(), gameOptions.keyRight.getLocalizedName()}));
         } else if (f == 102.0F) {
            this.client.inGameHud.getChatHud().addMessage(new TranslatableText("demo.help.jump", new Object[]{gameOptions.keyJump.getLocalizedName()}));
         } else if (f == 103.0F) {
            this.client.inGameHud.getChatHud().addMessage(new TranslatableText("demo.help.inventory", new Object[]{gameOptions.keyInventory.getLocalizedName()}));
         } else if (f == 104.0F) {
            this.client.inGameHud.getChatHud().addMessage(new TranslatableText("demo.day.6", new Object[]{gameOptions.keyScreenshot.getLocalizedName()}));
         }
      } else if (i == 6) {
         ...
         if (CustomPayloadS2CPacket.BRAND.equals(identifier)) {
            ...
            if (CustomPayloadS2CPacket.DEBUG_PATH.equals(identifier)) {
               ...
               if (CustomPayloadS2CPacket.DEBUG_CAVES.equals(identifier)) {
                  ...
                  this.client.debugRenderer.caveDebugRenderer.method_3704(blockPos12, list, list5);
               } else {
                  int x;
                  int au;
                  if (CustomPayloadS2CPacket.DEBUG_STRUCTURES.equals(identifier)) {
                     ...
                     if (CustomPayloadS2CPacket.DEBUG_POI_ADDED.equals(identifier)) {
                        ...
                        au = packetByteBuf.readInt();
                        VillageDebugRenderer.PointOfInterest pointOfInterest = new VillageDebugRenderer.PointOfInterest(blockPos12, string11, au);
                        ...
                        blockPos12 = packetByteBuf.readBlockPos();
                        aw = packetByteBuf.readInt();
                        this.client.debugRenderer.villageDebugRenderer.setFreeTicketCount(blockPos12, aw);
                        ...
                        for(w = 0; w < au; ++w) {
                           ...
                           list5.add(new GoalSelectorDebugRenderer.GoalSelector(blockPos12, x, string2, bl));
                        }

                        this.client.debugRenderer.goalSelectorDebugRenderer.setGoalSelectorList(aw, list5);
                        ...
                        if (CustomPayloadS2CPacket.DEBUG_BRAIN.equals(identifier)) {
                           h = packetByteBuf.readDouble();
                           am = packetByteBuf.readDouble();
                           an = packetByteBuf.readDouble();
                           position2 = new PositionImpl(h, am, an);
                           uUID2 = packetByteBuf.readUuid();
                           ao = packetByteBuf.readInt();
                           ...
                           VillageDebugRenderer.Brain brain = new VillageDebugRenderer.Brain(uUID2, ao, string3, string4, ab, position2, string5, path3, bl3);
                           aq = packetByteBuf.readInt();

                           for(as = 0; as < aq; ++as) {
                              string10 = packetByteBuf.readString();
                              brain.field_18927.add(string10);
                           }
                           ...
                           if (CustomPayloadS2CPacket.DEBUG_HIVE.equals(identifier)) {
                              ...
                              BeeDebugRenderer.Hive hive = new BeeDebugRenderer.Hive(blockPos12, string11, au, ax, bl7, this.world.getTime());
         ...
         if (!(entity instanceof LivingEntity)) {
            ...
            while(var4.hasNext()) {
               ...
               if (entityAttributeInstance == null) {
                  entityAttributeInstance = abstractEntityAttributeContainer.register(new ClampedEntityAttribute((EntityAttribute)null, entry.getId(), 0.0D, 2.2250738585072014E-308D, Double.MAX_VALUE));
               }
   ...
   private void method_2870(int i, int j, LightingProvider lightingProvider, LightType lightType, int k, int l, Iterator<byte[]> iterator) {
      for(int m = 0; m < 18; ++m) {
         ...
         boolean bl2 = (l & 1 << m) != 0;
         if (bl || bl2) {
            lightingProvider.queueData(lightType, ChunkSectionPos.from(i, n, j), bl ? new ChunkNibbleArray((byte[])((byte[])iterator.next()).clone()) : new ChunkNibbleArray());
