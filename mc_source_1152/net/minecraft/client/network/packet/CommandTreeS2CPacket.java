...
public class CommandTreeS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public void write(PacketByteBuf buf) throws IOException {
      ...
      CommandNode<CommandSource>[] commandNodes = (CommandNode[])(new CommandNode[map.size()]);

      Entry entry;
      for(Iterator var10 = map.entrySet().iterator(); var10.hasNext(); commandNodes[(Integer)entry.getValue()] = (CommandNode)entry.getKey()) {
         entry = (Entry)var10.next();
      }

      buf.writeVarInt(commandNodes.length);
      CommandNode[] var11 = commandNodes;
      int var12 = commandNodes.length;

      for(int var7 = 0; var7 < var12; ++var7) {
         CommandNode<CommandSource> commandNode2 = var11[var7];
