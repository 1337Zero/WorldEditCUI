...
public class ChunkDeltaUpdateS2CPacket implements Packet<ClientPlayPacketListener> {
   ...
   public void read(PacketByteBuf buf) throws IOException {
      ...
      for(int i = 0; i < this.records.length; ++i) {
         this.records[i] = new ChunkDeltaUpdateS2CPacket.ChunkDeltaRecord(buf.readShort(), (BlockState)Block.STATE_IDS.get(buf.readVarInt()));
      }
   ...
   public void write(PacketByteBuf buf) throws IOException {
      ...
      ChunkDeltaUpdateS2CPacket.ChunkDeltaRecord[] var2 = this.records;
