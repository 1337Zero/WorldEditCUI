...
public class ClientAdvancementManager {
   ...
   public void onAdvancements(AdvancementUpdateS2CPacket advancementUpdateS2CPacket) {
      ...
      Iterator var2 = advancementUpdateS2CPacket.getAdvancementsToProgress().entrySet().iterator();
      ...
      while(var2.hasNext()) {
         ...
         if (advancement != null) {
            ...
            if (!advancementUpdateS2CPacket.shouldClearCurrent() && advancementProgress.isDone() && advancement.getDisplay() != null && advancement.getDisplay().shouldShowToast()) {
