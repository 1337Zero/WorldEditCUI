...
public class BlockPredicate {
      ...
      if (this == ANY) {
         ...
         if (this.tag != null && !this.tag.contains(block)) {
            ...
            if (this.nbt != NbtPredicate.ANY) {
               ...
               if (blockEntity == null || !this.nbt.test((net.minecraft.nbt.Tag)blockEntity.toTag(new CompoundTag()))) {
                  return false;
               }
            }
   ...
   static {
      ANY = new BlockPredicate((Tag)null, (Block)null, StatePredicate.ANY, NbtPredicate.ANY);
   }
