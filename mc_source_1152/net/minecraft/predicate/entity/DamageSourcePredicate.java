...
public class DamageSourcePredicate {
   ...
   public DamageSourcePredicate(@Nullable Boolean var1, @Nullable Boolean boolean2, @Nullable Boolean boolean3, @Nullable Boolean boolean4, @Nullable Boolean boolean5, @Nullable Boolean boolean6, @Nullable Boolean boolean7, @Nullable Boolean boolean8, EntityPredicate entityPredicate, EntityPredicate entityPredicate2) {
   ...
   public static DamageSourcePredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         Boolean var2 = getBoolean(jsonObject, "is_projectile");
         ...
         return new DamageSourcePredicate(var2, boolean2, boolean3, boolean4, boolean5, boolean6, boolean7, boolean8, entityPredicate, entityPredicate2);
      } else {
         return EMPTY;
      }
   }
   ...
   private void addProperty(JsonObject json, String key, @Nullable Boolean var3) {
      if (var3 != null) {
   ...
   public static class Builder {
      ...
      public DamageSourcePredicate.Builder projectile(Boolean var1) {
         this.isProjectile = var1;
         return this;
      }

      public DamageSourcePredicate.Builder lightning(Boolean var1) {
