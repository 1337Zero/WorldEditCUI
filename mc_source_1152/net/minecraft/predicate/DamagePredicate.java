...
public class DamagePredicate {
   ...
   public static DamagePredicate deserialize(@Nullable JsonElement jsonElement) {
      if (jsonElement != null && !jsonElement.isJsonNull()) {
         ...
         Boolean var4 = jsonObject.has("blocked") ? JsonHelper.getBoolean(jsonObject, "blocked") : null;
         ...
         return new DamagePredicate(floatRange, floatRange2, entityPredicate, var4, damageSourcePredicate);
      } else {
         return ANY;
      }
   }
