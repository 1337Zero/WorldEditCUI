...
public class PacketByteBuf extends ByteBuf {
   ...
   public <T extends Enum<T>> T readEnumConstant(Class<T> var1) {
      return ((Enum[])var1.getEnumConstants())[this.readVarInt()];
   }

   public PacketByteBuf writeEnumConstant(Enum<?> var1) {
   ...
   public PacketByteBuf writeCompoundTag(@Nullable CompoundTag compoundTag) {
      if (compoundTag == null) {
         ...
         try {
            NbtIo.write((CompoundTag)compoundTag, (DataOutput)(new ByteBufOutputStream(this)));
   ...
   public BlockHitResult readBlockHitResult() {
      ...
      return new BlockHitResult(new Vec3d((double)((float)blockPos.getX() + f), (double)((float)blockPos.getY() + g), (double)((float)blockPos.getZ() + h)), direction, blockPos, bl);
   }
