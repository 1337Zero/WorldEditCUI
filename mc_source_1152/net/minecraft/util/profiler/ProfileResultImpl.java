...
public class ProfileResultImpl implements ProfileResult {
   ...
   private static final Comparator<Entry<String, ProfileResultImpl.class_4747>> field_21825 = Entry.comparingByValue(Comparator.comparingLong((arg) -> {
      return arg.field_21828;
   })).reversed();
   ...
   public List<ProfilerTiming> getTimings(String parentTiming) {
      ...
      long o = 0L;
      Iterator var14 = this.field_21826.keySet().iterator();
      ...
      Iterator var26 = this.field_21826.keySet().iterator();
      ...
      list.add(0, new ProfilerTiming(parentTiming, 100.0D, (double)o * 100.0D / (double)l, n));
      return list;
   }
   ...
   private Map<String, ProfileResultImpl.class_4747> method_24264() {
      ...
      this.field_21826.forEach((string, arg) -> {
         ...
         if (!object2LongMap.isEmpty()) {
            ...
            object2LongMap.forEach((stringx, var3) -> {
               ((ProfileResultImpl.class_4747)map.computeIfAbsent(stringx, (string) -> {
                  return new ProfileResultImpl.class_4747();
               })).method_24267(list.iterator(), var3);
            });
         }
   ...
   private void method_24253(int i, String string, ProfileResultImpl.class_4747 arg, int j, StringBuilder stringBuilder) {
      method_24256(stringBuilder, i).append(string).append(" total:").append(arg.field_21827).append('/').append(arg.field_21828).append(" average: ").append(arg.field_21827 / (long)j).append('/').append(arg.field_21828 / (long)j).append('\n');
      arg.field_21829.entrySet().stream().sorted(field_21825).forEach((entry) -> {
         this.method_24253(i + 1, (String)entry.getKey(), (ProfileResultImpl.class_4747)entry.getValue(), j, stringBuilder);
      });
   }
   ...
   static class class_4747 {
      ...
      private final Map<String, ProfileResultImpl.class_4747> field_21829;

      private class_4747() {
         this.field_21829 = Maps.newHashMap();
      }
      ...
      public void method_24267(Iterator<String> iterator, long l) {
         ...
         if (!iterator.hasNext()) {
            ...
            ((ProfileResultImpl.class_4747)this.field_21829.computeIfAbsent(iterator.next(), (string) -> {
               return new ProfileResultImpl.class_4747();
            })).method_24267(iterator, l);
         }
