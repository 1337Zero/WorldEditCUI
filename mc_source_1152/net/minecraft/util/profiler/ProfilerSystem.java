...
public class ProfilerSystem implements ReadableProfiler {
   ...
   private final Map<String, ProfilerSystem.class_4746> field_21818 = Maps.newHashMap();
      ...
      if (!this.tickStarted) {
         ...
         if (!this.location.isEmpty()) {
            LOGGER.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", new Supplier[]{() -> {
               return ProfileResult.method_21721(this.location);
            }});
         }
   ...
   private ProfilerSystem.class_4746 method_24246() {
      if (this.field_21819 == null) {
         this.field_21819 = (ProfilerSystem.class_4746)this.field_21818.computeIfAbsent(this.location, (string) -> {
            return new ProfilerSystem.class_4746();
         });
      }
   ...
   public void method_24271(java.util.function.Supplier<String> supplier) {
   ...
   static class class_4746 implements class_4748 {
      ...
      private Object2LongOpenHashMap<String> field_21822;

      private class_4746() {
         this.field_21822 = new Object2LongOpenHashMap();
      }
