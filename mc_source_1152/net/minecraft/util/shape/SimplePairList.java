      ...
      while(true) {
         ...
         do {
            do {
               ...
               bl3 = bl && (!bl2 || first.getDouble(i) < second.getDouble(j) + 1.0E-7D);
               e = bl3 ? first.getDouble(i++) : second.getDouble(j++);
            } while((i == 0 || !bl) && !bl3 && !includeSecondOnly);
         } while((j == 0 || !bl2) && bl3 && !includeFirstOnly);
