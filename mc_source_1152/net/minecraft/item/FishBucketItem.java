...
public class FishBucketItem extends BucketItem {
   ...
   private void spawnFish(World world, ItemStack stack, BlockPos pos) {
      Entity entity = this.fishType.spawnFromItemStack(world, stack, (PlayerEntity)null, pos, SpawnType.BUCKET, true, false);
      if (entity != null) {
   ...
   public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
      if (this.fishType == EntityType.TROPICAL_FISH) {
         ...
         if (compoundTag != null && compoundTag.contains("BucketVariantTag", 3)) {
            ...
            Text text = new TranslatableText(string, new Object[0]);
            if (!string.equals(string2)) {
               text.append(", ").append((Text)(new TranslatableText(string2, new Object[0])));
            }
