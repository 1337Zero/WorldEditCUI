...
public class Item implements ItemConvertible {
   ...
   private static final ItemPropertyGetter DAMAGED_PROPERTY_GETTER = (stack, world, entity) -> {
      return stack.isDamaged() ? 1.0F : 0.0F;
   };
   private static final ItemPropertyGetter DAMAGE_PROPERTY_GETTER = (stack, world, entity) -> {
      return MathHelper.clamp((float)stack.getDamage() / (float)stack.getMaxDamage(), 0.0F, 1.0F);
   };
   private static final ItemPropertyGetter LEFTHANDED_PROPERTY_GETTER = (stack, world, entity) -> {
      return entity != null && entity.getMainArm() != Arm.RIGHT ? 1.0F : 0.0F;
   };
   private static final ItemPropertyGetter COOLDOWN_PROPERTY_GETTER = (stack, world, entity) -> {
   ...
   private static final ItemPropertyGetter CUSTOM_DATA_PROPERTY_GETTER = (stack, world, entity) -> {
   ...
   public static Item byRawId(int id) {
      return (Item)Registry.ITEM.get(id);
   }
