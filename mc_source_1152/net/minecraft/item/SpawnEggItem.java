...
public class SpawnEggItem extends Item {
   ...
   public ActionResult useOnBlock(ItemUsageContext context) {
      ...
      if (world.isClient) {
         ...
         if (entityType2.spawnFromItemStack(world, itemStack, context.getPlayer(), blockPos3, SpawnType.SPAWN_EGG, true, !Objects.equals(blockPos, blockPos3) && direction == Direction.UP) != null) {
            itemStack.decrement(1);
         }
