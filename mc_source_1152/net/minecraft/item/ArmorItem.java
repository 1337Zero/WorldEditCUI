...
public class ArmorItem extends Item {
   ...
   public static boolean dispenseArmor(BlockPointer pointer, ItemStack armor) {
      ...
      List<LivingEntity> list = pointer.getWorld().getEntities(LivingEntity.class, new Box(blockPos), EntityPredicates.EXCEPT_SPECTATOR.and(new EntityPredicates.CanPickup(armor)));
      if (list.isEmpty()) {
         return false;
      } else {
