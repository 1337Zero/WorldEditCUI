...
public class HoeItem extends ToolItem {
   ...
   public Multimap<String, EntityAttributeModifier> getModifiers(EquipmentSlot slot) {
      ...
      if (slot == EquipmentSlot.MAINHAND) {
         multimap.put(EntityAttributes.ATTACK_DAMAGE.getId(), new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_UUID, "Weapon modifier", 0.0D, EntityAttributeModifier.Operation.ADDITION));
