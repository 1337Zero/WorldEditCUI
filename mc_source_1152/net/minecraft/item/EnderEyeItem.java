   ...
   public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
      ...
      if (hitResult.getType() == HitResult.Type.BLOCK && world.getBlockState(((BlockHitResult)hitResult).getBlockPos()).getBlock() == Blocks.END_PORTAL_FRAME) {
         ...
         if (world instanceof ServerWorld) {
            ...
            if (blockPos != null) {
               EnderEyeEntity enderEyeEntity = new EnderEyeEntity(world, user.getX(), user.getBodyY(0.5D), user.getZ());
               ...
               world.playLevelEvent((PlayerEntity)null, 1003, new BlockPos(user), 0);
