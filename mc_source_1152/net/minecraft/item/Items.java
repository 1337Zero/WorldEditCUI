...
public class Items {
   ...
   static {
      ...
      WOODEN_HOE = register((String)"wooden_hoe", (Item)(new HoeItem(ToolMaterials.WOOD, -3.0F, (new Item.Settings()).group(ItemGroup.TOOLS))));
      STONE_HOE = register((String)"stone_hoe", (Item)(new HoeItem(ToolMaterials.STONE, -2.0F, (new Item.Settings()).group(ItemGroup.TOOLS))));
      IRON_HOE = register((String)"iron_hoe", (Item)(new HoeItem(ToolMaterials.IRON, -1.0F, (new Item.Settings()).group(ItemGroup.TOOLS))));
      DIAMOND_HOE = register((String)"diamond_hoe", (Item)(new HoeItem(ToolMaterials.DIAMOND, 0.0F, (new Item.Settings()).group(ItemGroup.TOOLS))));
      GOLDEN_HOE = register((String)"golden_hoe", (Item)(new HoeItem(ToolMaterials.GOLD, -3.0F, (new Item.Settings()).group(ItemGroup.TOOLS))));
      ...
      CLOCK = register((String)"clock", (Item)(new ClockItem((new Item.Settings()).group(ItemGroup.TOOLS))));
      ...
      ZOMBIE_PIGMAN_SPAWN_EGG = register((String)"zombie_pigman_spawn_egg", (Item)(new SpawnEggItem(EntityType.ZOMBIE_PIGMAN, 15373203, 5009705, (new Item.Settings()).group(ItemGroup.MISC))));
      ...
      CARROT_ON_A_STICK = register((String)"carrot_on_a_stick", (Item)(new CarrotOnAStickItem((new Item.Settings()).maxDamage(25).group(ItemGroup.TRANSPORTATION))));
