      ...
      if (blockState != state) {
         ...
         if (direction.getAxis().isHorizontal() && !(Boolean)state.get(getFacingProperty(direction))) {
            if (this.canGrowAt(world, pos)) {
               ...
               blockState4 = world.getBlockState(blockPos2);
            ...
            if (direction == Direction.UP && pos.getY() < 255) {
               ...
               if (world.isAir(blockPos)) {
                  ...
                  Iterator var18 = Direction.Type.HORIZONTAL.iterator();
                  ...
                  while(true) {
                     do {
                        ...
                        direction5 = (Direction)var18.next();
                     } while(!random.nextBoolean() && shouldConnectTo(world, blockPos.offset(direction5), Direction.UP));

                     blockState3 = (BlockState)blockState3.with(getFacingProperty(direction5), false);
                  }
               }
            }
            ...
            if (pos.getY() > 0) {
               ...
               if (blockState4.isAir() || blockState4.getBlock() == this) {
                  ...
                  BlockState blockState6 = this.getGrownState(state, blockState5, random);
                  if (blockState5 != blockState6 && this.hasHorizontalSide(blockState6)) {
                     world.setBlockState(blockPos2, blockState6, 2);
                  }
               }
            }
