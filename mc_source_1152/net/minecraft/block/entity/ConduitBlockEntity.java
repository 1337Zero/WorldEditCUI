...
public class ConduitBlockEntity extends BlockEntity implements Tickable {
   ...
   private void attackHostileEntity() {
      ...
      if (i < 42) {
         ...
         List<LivingEntity> list = this.world.getEntities(LivingEntity.class, this.getAttackZone(), (livingEntityx) -> {
      ...
      } else if (!this.targetEntity.isAlive() || !this.pos.isWithinDistance(new BlockPos(this.targetEntity), 8.0D)) {
         this.targetEntity = null;
      }
   ...
   private LivingEntity findTargetEntity() {
      List<LivingEntity> list = this.world.getEntities(LivingEntity.class, this.getAttackZone(), (livingEntity) -> {
