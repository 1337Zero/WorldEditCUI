...
public class CommandBlockBlockEntity extends BlockEntity {
   ...
   private final CommandBlockExecutor commandExecutor = new CommandBlockExecutor() {
      ...
      public Vec3d getPos() {
         return new Vec3d((double)CommandBlockBlockEntity.this.pos.getX() + 0.5D, (double)CommandBlockBlockEntity.this.pos.getY() + 0.5D, (double)CommandBlockBlockEntity.this.pos.getZ() + 0.5D);
      }

      public ServerCommandSource getSource() {
         return new ServerCommandSource(this, new Vec3d((double)CommandBlockBlockEntity.this.pos.getX() + 0.5D, (double)CommandBlockBlockEntity.this.pos.getY() + 0.5D, (double)CommandBlockBlockEntity.this.pos.getZ() + 0.5D), Vec2f.ZERO, this.getWorld(), 2, this.getCustomName().getString(), this.getCustomName(), this.getWorld().getServer(), (Entity)null);
      }
   };
