...
public class SignBlockEntity extends BlockEntity {
   ...
   public ServerCommandSource getCommandSource(@Nullable ServerPlayerEntity player) {
      ...
      return new ServerCommandSource(CommandOutput.DUMMY, new Vec3d((double)this.pos.getX() + 0.5D, (double)this.pos.getY() + 0.5D, (double)this.pos.getZ() + 0.5D), Vec2f.ZERO, (ServerWorld)this.world, 2, string, (Text)text, this.world.getServer(), player);
   }
