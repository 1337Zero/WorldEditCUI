...
public class DetectorRailBlock extends AbstractRailBlock {
   ...
   private void updatePoweredStatus(World world, BlockPos pos, BlockState state) {
      ...
      if (bl2 && !bl) {
         ...
         world.checkBlockRerender(pos, state, blockState2);
      }
   ...
   private Box getCartDetectionBox(BlockPos pos) {
      float f = 0.2F;
      return new Box((double)((float)pos.getX() + 0.2F), (double)pos.getY(), (double)((float)pos.getZ() + 0.2F), (double)((float)(pos.getX() + 1) - 0.2F), (double)((float)(pos.getY() + 1) - 0.2F), (double)((float)(pos.getZ() + 1) - 0.2F));
   }
