...
public class GameTest {
   ...
   private final Collection<TimedTaskRunner> field_21452;
   private Object2LongMap<Runnable> field_21453;
   ...
   public GameTest(TestFunction testFunction, ServerWorld serverWorld) {
      ...
      this.field_21452 = Lists.newCopyOnWriteArrayList();
      this.field_21453 = new Object2LongOpenHashMap();
      this.started = false;
         ...
         if (this.field_21455 >= 0L) {
            ...
            if (this.field_21455 > (long)this.ticksLeft) {
               if (this.field_21452.isEmpty()) {
                  ...
                  this.field_21452.forEach((timedTaskRunner) -> {
                     timedTaskRunner.runReported(this.field_21455);
                  });
               ...
               this.field_21452.forEach((timedTaskRunner) -> {
                  timedTaskRunner.runSilently(this.field_21455);
               });
            }
