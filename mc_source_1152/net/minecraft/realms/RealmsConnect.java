      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               Realms.setScreen(new DisconnectedRealmsScreen(RealmsConnect.this.onlineScreen, "connect.failed", new TranslatableText("disconnect.genericReason", new Object[]{"Unknown host '" + string + "'"})));
               ...
               Realms.setScreen(new DisconnectedRealmsScreen(RealmsConnect.this.onlineScreen, "connect.failed", new TranslatableText("disconnect.genericReason", new Object[]{stringx})));
            }
