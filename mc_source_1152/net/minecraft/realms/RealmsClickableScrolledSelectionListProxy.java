...
public class RealmsClickableScrolledSelectionListProxy extends ListWidget {
   ...
   public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
      return this.realmsClickableScrolledSelectionList.mouseDragged(mouseX, mouseY, button, deltaX, deltaY) ? true : super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY);
   }
