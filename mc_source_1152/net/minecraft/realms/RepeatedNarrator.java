...
public class RepeatedNarrator {
   ...
   public void narrate(String string) {
      RepeatedNarrator.Parameters parameters = (RepeatedNarrator.Parameters)this.params.updateAndGet((parametersx) -> {
         return parametersx != null && string.equals(parametersx.message) ? parametersx : new RepeatedNarrator.Parameters(string, RateLimiter.create((double)this.permitsPerSecond));
      });
