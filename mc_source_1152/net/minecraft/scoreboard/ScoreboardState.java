   ...
   protected void deserializeTeams(ListTag listTag) {
      for(int i = 0; i < listTag.size(); ++i) {
         ...
         if (compoundTag.contains("MemberNamePrefix", 8)) {
            text3 = Text.Serializer.fromJson(compoundTag.getString("MemberNamePrefix"));
            if (text3 != null) {
         ...
         if (compoundTag.contains("MemberNameSuffix", 8)) {
            text3 = Text.Serializer.fromJson(compoundTag.getString("MemberNameSuffix"));
            if (text3 != null) {
         ...
         if (compoundTag.contains("NameTagVisibility", 8)) {
            visibilityRule2 = AbstractTeam.VisibilityRule.getRule(compoundTag.getString("NameTagVisibility"));
         ...
         if (compoundTag.contains("DeathMessageVisibility", 8)) {
            visibilityRule2 = AbstractTeam.VisibilityRule.getRule(compoundTag.getString("DeathMessageVisibility"));
            if (visibilityRule2 != null) {
