...
public class ServerScoreboard extends Scoreboard {
   ...
   public void updateScore(ScoreboardPlayerScore score) {
      ...
      if (this.objectives.contains(score.getObjective())) {
         this.server.getPlayerManager().sendToAll((Packet)(new ScoreboardPlayerUpdateS2CPacket(ServerScoreboard.UpdateMode.CHANGE, score.getObjective().getName(), score.getPlayerName(), score.getScore())));
      }
   ...
   public void updatePlayerScore(String playerName) {
      ...
      this.server.getPlayerManager().sendToAll((Packet)(new ScoreboardPlayerUpdateS2CPacket(ServerScoreboard.UpdateMode.REMOVE, (String)null, playerName, 0)));
      this.runUpdateListeners();
   }
   ...
   public void updatePlayerScore(String playerName, ScoreboardObjective objective) {
      ...
      if (this.objectives.contains(objective)) {
         this.server.getPlayerManager().sendToAll((Packet)(new ScoreboardPlayerUpdateS2CPacket(ServerScoreboard.UpdateMode.REMOVE, objective.getName(), playerName, 0)));
      }
   ...
   public void setObjectiveSlot(int slot, @Nullable ScoreboardObjective objective) {
      ...
      if (scoreboardObjective != objective && scoreboardObjective != null) {
         if (this.getSlot(scoreboardObjective) > 0) {
            this.server.getPlayerManager().sendToAll((Packet)(new ScoreboardDisplayS2CPacket(slot, objective)));
         } else {
   ...
   public boolean addPlayerToTeam(String playerName, Team team) {
      if (super.addPlayerToTeam(playerName, team)) {
         this.server.getPlayerManager().sendToAll((Packet)(new TeamS2CPacket(team, Arrays.asList(playerName), 3)));
         this.runUpdateListeners();
         return true;
      } else {
         return false;
   ...
   public void removePlayerFromTeam(String playerName, Team team) {
      ...
      this.server.getPlayerManager().sendToAll((Packet)(new TeamS2CPacket(team, Arrays.asList(playerName), 4)));
      this.runUpdateListeners();
   }
   ...
   public void updateExistingObjective(ScoreboardObjective objective) {
      ...
      if (this.objectives.contains(objective)) {
         this.server.getPlayerManager().sendToAll((Packet)(new ScoreboardObjectiveUpdateS2CPacket(objective, 2)));
      }
   ...
   public void updateScoreboardTeamAndPlayers(Team team) {
      ...
      this.server.getPlayerManager().sendToAll((Packet)(new TeamS2CPacket(team, 0)));
      this.runUpdateListeners();
   }

   public void updateScoreboardTeam(Team team) {
      super.updateScoreboardTeam(team);
      this.server.getPlayerManager().sendToAll((Packet)(new TeamS2CPacket(team, 2)));
      this.runUpdateListeners();
   }

   public void updateRemovedTeam(Team team) {
      super.updateRemovedTeam(team);
      this.server.getPlayerManager().sendToAll((Packet)(new TeamS2CPacket(team, 1)));
      this.runUpdateListeners();
   }
