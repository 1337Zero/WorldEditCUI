...
public class ScoreboardObjective {
   ...
   public Text toHoverableText() {
      return Texts.bracketed(this.displayName.deepCopy().styled((style) -> {
         style.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralText(this.getName())));
      }));
   }
