...
public interface VillagerType {
   ...
   Map<Biome, VillagerType> BIOME_TO_TYPE = (Map)Util.make(Maps.newHashMap(), (hashMap) -> {
   ...
   static VillagerType create(final String id) {
      return (VillagerType)Registry.register(Registry.VILLAGER_TYPE, (Identifier)(new Identifier(id)), new VillagerType() {
