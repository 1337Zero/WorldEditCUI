...
public interface Trader {
   ...
   default void sendOffers(PlayerEntity playerEntity, Text text, int i) {
      OptionalInt optionalInt = playerEntity.openContainer(new ClientDummyContainerProvider((ix, playerInventory, playerEntityx) -> {
         return new MerchantContainer(ix, playerInventory, this);
      }, text));
