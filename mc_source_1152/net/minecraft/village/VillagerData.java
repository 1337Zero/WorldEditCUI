...
public class VillagerData {
   ...
   public VillagerData(Dynamic<?> dynamic) {
      this((VillagerType)Registry.VILLAGER_TYPE.get(Identifier.tryParse(dynamic.get("type").asString(""))), (VillagerProfession)Registry.VILLAGER_PROFESSION.get(Identifier.tryParse(dynamic.get("profession").asString(""))), dynamic.get("level").asInt(1));
   }
