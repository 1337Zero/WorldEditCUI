...
public enum VillageGossipType {
   ...
   private static final Map<String, VillageGossipType> BY_KEY = (Map)Stream.of(values()).collect(ImmutableMap.toImmutableMap((villageGossipType) -> {
      return villageGossipType.key;
   }, Function.identity()));
