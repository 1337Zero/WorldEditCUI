...
public class OceanMonumentGenerator {
   ...
   public static class Penthouse extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         ...
         for(int k = 0; k < 2; ++k) {
            for(int l = 2; l <= 8; l += 3) {
               this.fillWithOutline(world, blockBox, j, 0, l, j, 2, l, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
   ...
   public static class WingRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         if (this.field_14481 == 0) {
            int j;
            for(j = 0; j < 4; ++j) {
               this.fillWithOutline(world, blockBox, 10 - j, 3 - j, 20 - j, 12 + j, 3 - j, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
            ...
            for(j = 18; j >= 7; j -= 3) {
               this.addBlock(world, SEA_LANTERN, 6, 3, j, blockBox);
               this.addBlock(world, SEA_LANTERN, 16, 3, j, blockBox);
            }
            ...
            int p;
            for(p = 0; p < 2; ++p) {
               this.addBlock(world, PRISMARINE_BRICKS, k, 6, 20, blockBox);
               this.addBlock(world, SEA_LANTERN, k, 5, 20, blockBox);
               this.addBlock(world, PRISMARINE_BRICKS, k, 4, 20, blockBox);
               k = 13;
            }
            ...
            for(p = 0; p < 2; ++p) {
               this.fillWithOutline(world, blockBox, k, 0, 10, k, 6, 10, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, blockBox, k, 0, 12, k, 6, 12, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.addBlock(world, SEA_LANTERN, k, 0, 10, blockBox);
               this.addBlock(world, SEA_LANTERN, k, 0, 12, blockBox);
               this.addBlock(world, SEA_LANTERN, k, 4, 10, blockBox);
               this.addBlock(world, SEA_LANTERN, k, 4, 12, blockBox);
               k = 12;
            }
            ...
            for(p = 0; p < 2; ++p) {
               this.fillWithOutline(world, blockBox, k, 0, 7, k, 2, 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(world, blockBox, k, 0, 14, k, 2, 14, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               k = 14;
            }
   ...
   public static class CoreRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         ...
         this.fillWithOutline(world, blockBox, 0, 7, 0, 0, 7, 15, blockState2, blockState2, false);
         this.fillWithOutline(world, blockBox, 15, 7, 0, 15, 7, 15, blockState2, blockState2, false);
         this.fillWithOutline(world, blockBox, 1, 7, 0, 15, 7, 0, blockState2, blockState2, false);
         this.fillWithOutline(world, blockBox, 1, 7, 15, 14, 7, 15, blockState2, blockState2, false);
         ...
         for(l = 1; l <= 6; ++l) {
            ...
            for(int k = 0; k <= 15; k += 15) {
               this.fillWithOutline(world, blockBox, k, l, 0, k, l, 1, blockState2, blockState2, false);
               this.fillWithOutline(world, blockBox, k, l, 6, k, l, 9, blockState2, blockState2, false);
               this.fillWithOutline(world, blockBox, k, l, 14, k, l, 15, blockState2, blockState2, false);
            }

            this.fillWithOutline(world, blockBox, 1, l, 0, 1, l, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, blockBox, 6, l, 0, 9, l, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, blockBox, 14, l, 0, 14, l, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, blockBox, 1, l, 15, 14, l, 15, blockState2, blockState2, false);
         }
         ...
         for(l = 3; l <= 6; l += 3) {
            for(int m = 6; m <= 9; m += 3) {
               this.addBlock(world, SEA_LANTERN, m, l, 6, blockBox);
               this.addBlock(world, SEA_LANTERN, m, l, 9, blockBox);
            }
         }
   ...
   public static class DoubleYZRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         ...
         for(j = 1; j <= 7; ++j) {
            ...
            this.fillWithOutline(world, blockBox, 0, j, 0, 0, j, 15, blockState2, blockState2, false);
            this.fillWithOutline(world, blockBox, 7, j, 0, 7, j, 15, blockState2, blockState2, false);
            this.fillWithOutline(world, blockBox, 1, j, 0, 6, j, 0, blockState2, blockState2, false);
            this.fillWithOutline(world, blockBox, 1, j, 15, 6, j, 15, blockState2, blockState2, false);
         }
         ...
         for(j = 1; j <= 7; ++j) {
            ...
            this.fillWithOutline(world, blockBox, 3, j, 7, 4, j, 8, blockState2, blockState2, false);
         }
   ...
   public static class SimpleRoom extends OceanMonumentGenerator.Piece {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         ...
         boolean bl = this.field_14480 != 0 && random.nextBoolean() && !this.field_14479.field_14482[Direction.DOWN.getId()] && !this.field_14479.field_14482[Direction.UP.getId()] && this.field_14479.method_14781() > 1;
   ...
   public static class Base extends OceanMonumentGenerator.Piece {
      ...
      public Base(Random random, int i, int j, Direction direction) {
         ...
         while(true) {
            while(true) {
               OceanMonumentGenerator.class_3388 lv;
               do {
                  do {
                     if (!var8.hasNext()) {
                     ...
                     lv = (OceanMonumentGenerator.class_3388)var8.next();
                  } while(lv.field_14485);
               } while(lv.method_14785());

               Iterator var10 = list2.iterator();

               while(var10.hasNext()) {
                  OceanMonumentGenerator.class_3375 lv2 = (OceanMonumentGenerator.class_3375)var10.next();
      ...
      private List<OceanMonumentGenerator.class_3388> method_14760(Random random) {
         ...
         for(u = 0; u < 5; ++u) {
            for(v = 0; v < 4; ++v) {
               s = false;
               x = method_14770(u, 0, v);
               lvs[x] = new OceanMonumentGenerator.class_3388(x);
            }
         }
         ...
         OceanMonumentGenerator.class_3388[] var20 = lvs;
         var8 = lvs.length;

         for(var9 = 0; var9 < var8; ++var9) {
            OceanMonumentGenerator.class_3388 lv4 = var20[var9];
            if (lv4 != null) {
               lv4.method_14780();
               list.add(lv4);
            }
         ...
         label95:
         while(var22.hasNext()) {
            OceanMonumentGenerator.class_3388 lv5 = (OceanMonumentGenerator.class_3388)var22.next();
            int ad = 0;
            y = 0;
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         ...
         Iterator var13 = this.field_14465.iterator();

         while(var13.hasNext()) {
            OceanMonumentGenerator.Piece piece = (OceanMonumentGenerator.Piece)var13.next();
      ...
      private void method_14761(boolean bl, int i, IWorld iWorld, Random random, BlockBox blockBox) {
         ...
         if (this.method_14775(blockBox, i, 0, i + 23, 20)) {
            ...
            int l;
            for(l = 0; l < 4; ++l) {
               this.fillWithOutline(iWorld, blockBox, i + l, l + 1, l, i + l, l + 1, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(iWorld, blockBox, i + l + 7, l + 5, l + 7, i + l + 7, l + 5, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(iWorld, blockBox, i + 17 - l, l + 5, l + 7, i + 17 - l, l + 5, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(iWorld, blockBox, i + 24 - l, l + 1, l, i + 24 - l, l + 1, 20, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(iWorld, blockBox, i + l + 1, l + 1, l, i + 23 - l, l + 1, l, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
               this.fillWithOutline(iWorld, blockBox, i + l + 8, l + 5, l + 7, i + 16 - l, l + 5, l + 7, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
            ...
            int p;
            for(p = 20; p >= 5; p -= 3) {
               this.addBlock(iWorld, field_14470, l, 5, p, blockBox);
            }

            for(p = 19; p >= 7; p -= 3) {
               this.addBlock(iWorld, field_14470, m, 5, p, blockBox);
            }
      ...
      private void method_14762(IWorld iWorld, Random random, BlockBox blockBox) {
         if (this.method_14775(blockBox, 15, 20, 42, 21)) {
            ...
            int k;
            for(k = 0; k < 7; ++k) {
               this.addBlock(iWorld, DARK_PRISMARINE, 28 - k, 6 + k, 21, blockBox);
               this.addBlock(iWorld, DARK_PRISMARINE, 29 + k, 6 + k, 21, blockBox);
            }

            for(k = 0; k < 4; ++k) {
               this.addBlock(iWorld, DARK_PRISMARINE, 28 - k, 9 + k, 21, blockBox);
               this.addBlock(iWorld, DARK_PRISMARINE, 29 + k, 9 + k, 21, blockBox);
            }
      ...
      private void method_14764(IWorld iWorld, Random random, BlockBox blockBox) {
         ...
         if (this.method_14775(blockBox, 0, 21, 6, 58)) {
            ...
            for(k = 23; k < 53; k += 3) {
               this.addBlock(iWorld, field_14470, 5, 5, k, blockBox);
            }
         ...
         if (this.method_14775(blockBox, 51, 21, 58, 58)) {
            ...
            for(k = 0; k < 4; ++k) {
               this.fillWithOutline(iWorld, blockBox, 57 - k, k + 1, 21, 57 - k, k + 1, 57 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(k = 23; k < 53; k += 3) {
               this.addBlock(iWorld, field_14470, 52, 5, k, blockBox);
            }
         ...
         if (this.method_14775(blockBox, 0, 51, 57, 57)) {
            ...
            for(k = 0; k < 4; ++k) {
               this.fillWithOutline(iWorld, blockBox, k + 1, k + 1, 57 - k, 56 - k, k + 1, 57 - k, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
         }
      ...
      private void method_14766(IWorld iWorld, Random random, BlockBox blockBox) {
         ...
         if (this.method_14775(blockBox, 7, 21, 13, 50)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(iWorld, blockBox, n + 7, n + 5, 21, n + 7, n + 5, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 21; n <= 45; n += 3) {
               this.addBlock(iWorld, field_14470, 12, 9, n, blockBox);
            }
         }
         ...
         if (this.method_14775(blockBox, 44, 21, 50, 54)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(iWorld, blockBox, 50 - n, n + 5, 21, 50 - n, n + 5, 54, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 21; n <= 45; n += 3) {
               this.addBlock(iWorld, field_14470, 45, 9, n, blockBox);
            }
         }
         ...
         if (this.method_14775(blockBox, 8, 44, 49, 54)) {
            ...
            for(n = 12; n <= 45; n += 3) {
               this.addBlock(iWorld, field_14470, n, 9, 45, blockBox);
               this.addBlock(iWorld, field_14470, n, 9, 52, blockBox);
               if (n == 12 || n == 18 || n == 24 || n == 33 || n == 39 || n == 45) {
                  this.addBlock(iWorld, field_14470, n, 9, 47, blockBox);
                  this.addBlock(iWorld, field_14470, n, 9, 50, blockBox);
                  this.addBlock(iWorld, field_14470, n, 10, 45, blockBox);
                  this.addBlock(iWorld, field_14470, n, 10, 46, blockBox);
                  this.addBlock(iWorld, field_14470, n, 10, 51, blockBox);
                  this.addBlock(iWorld, field_14470, n, 10, 52, blockBox);
                  this.addBlock(iWorld, field_14470, n, 11, 47, blockBox);
                  this.addBlock(iWorld, field_14470, n, 11, 50, blockBox);
                  this.addBlock(iWorld, field_14470, n, 12, 48, blockBox);
                  this.addBlock(iWorld, field_14470, n, 12, 49, blockBox);
               }
            }
      ...
      private void method_14767(IWorld iWorld, Random random, BlockBox blockBox) {
         ...
         if (this.method_14775(blockBox, 14, 21, 20, 43)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(iWorld, blockBox, n + 14, n + 9, 21, n + 14, n + 9, 43 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 23; n <= 39; n += 3) {
               this.addBlock(iWorld, field_14470, 19, 13, n, blockBox);
            }
         }
         ...
         if (this.method_14775(blockBox, 37, 21, 43, 43)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(iWorld, blockBox, 43 - n, n + 9, 21, 43 - n, n + 9, 43 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }

            for(n = 23; n <= 39; n += 3) {
               this.addBlock(iWorld, field_14470, 38, 13, n, blockBox);
            }
         }
         ...
         if (this.method_14775(blockBox, 15, 37, 42, 43)) {
            ...
            for(n = 0; n < 4; ++n) {
               this.fillWithOutline(iWorld, blockBox, 15 + n, n + 9, 43 - n, 42 - n, n + 9, 43 - n, PRISMARINE_BRICKS, PRISMARINE_BRICKS, false);
            }
   ...
   public abstract static class Piece extends StructurePiece {
      ...
      protected static final int field_14469;
      protected static final int field_14468;
      protected static final int field_14478;
      protected static final int field_14477;
      ...
      protected boolean method_14772(IWorld iWorld, BlockBox blockBox, int i, int j, int k) {
         ...
         if (blockBox.contains(new BlockPos(l, m, n))) {
            ElderGuardianEntity elderGuardianEntity = (ElderGuardianEntity)EntityType.ELDER_GUARDIAN.create(iWorld.getWorld());
            ...
            elderGuardianEntity.initialize(iWorld, iWorld.getLocalDifficulty(new BlockPos(elderGuardianEntity)), SpawnType.STRUCTURE, (EntityData)null, (CompoundTag)null);
      ...
      static {
         ...
         field_14469 = method_14770(2, 0, 0);
         field_14468 = method_14770(2, 2, 0);
         field_14478 = method_14770(0, 1, 0);
         field_14477 = method_14770(4, 1, 0);
      }
   }
}
