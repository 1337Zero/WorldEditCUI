...
public interface StructurePoolElementType extends DynamicDeserializer<StructurePoolElement> {
   ...
   StructurePoolElementType EMPTY_POOL_ELEMENT = register("empty_pool_element", (dynamic) -> {
      return EmptyPoolElement.INSTANCE;
   });

   static StructurePoolElementType register(String string, StructurePoolElementType structurePoolElementType) {
      return (StructurePoolElementType)Registry.register(Registry.STRUCTURE_POOL_ELEMENT, (String)string, structurePoolElementType);
   }
}
