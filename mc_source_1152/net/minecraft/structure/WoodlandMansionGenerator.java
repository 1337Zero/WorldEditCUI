...
public class WoodlandMansionGenerator {
   ...
   static class MansionParameters {
      ...
      public boolean method_15039(WoodlandMansionGenerator.class_3478 arg, int i, int j, int k, int l) {
         return (this.field_15443[k].method_15066(i, j) & '\uffff') == l;
      }
      ...
      public Direction method_15040(WoodlandMansionGenerator.class_3478 arg, int i, int j, int k, int l) {
         ...
         } while(!this.method_15039(arg, i + direction.getOffsetX(), j + direction.getOffsetZ(), k, l));
         ...
         if (k > 0) {
            ...
            for(int l = 0; l < 8; ++l) {
               ...
               if (direction2 != direction.getOpposite() && (direction2 != Direction.EAST || !this.random.nextBoolean())) {
                  ...
                  if (arg.method_15066(m + direction2.getOffsetX(), n + direction2.getOffsetZ()) == 0 && arg.method_15066(m + direction2.getOffsetX() * 2, n + direction2.getOffsetZ() * 2) == 0) {
         ...
         for(int i = 0; i < arg.field_15453; ++i) {
            for(int j = 0; j < arg.field_15454; ++j) {
               if (arg.method_15066(j, i) == 0) {
                  int k = 0;
                  int k = k + (method_15047(arg, j + 1, i) ? 1 : 0);
                  ...
                  if (k >= 3) {
                     ...
                     int l = 0;
                     int l = l + (method_15047(arg, j + 1, i + 1) ? 1 : 0);
      ...
      private void method_15048() {
         ...
         for(int i = 0; i < this.field_15439.field_15453; ++i) {
            for(m = 0; m < this.field_15439.field_15454; ++m) {
               int k = lv.method_15066(m, i);
               n = k & 983040;
         ...
         if (list.isEmpty()) {
            ...
            m = lv.method_15066((Integer)pair.getLeft(), (Integer)pair.getRight());
            lv.method_15065((Integer)pair.getLeft(), (Integer)pair.getRight(), m | 4194304);
            ...
            if (list2.isEmpty()) {
               this.field_15439.method_15062(0, 0, this.field_15439.field_15454, this.field_15439.field_15453, 5);
               lv.method_15065((Integer)pair.getLeft(), (Integer)pair.getRight(), m);
            } else {
      ...
      private void method_15042(WoodlandMansionGenerator.class_3478 arg, WoodlandMansionGenerator.class_3478 arg2) {
         ...
         int k;
         for(k = 0; k < arg.field_15453; ++k) {
            for(int j = 0; j < arg.field_15454; ++j) {
               if (arg.method_15066(j, k) == 2) {
         ...
         while(true) {
            ...
            int q = m;
            int r = 65536;
            if (arg2.method_15066(l + 1, m) == 0 && arg2.method_15066(l, m + 1) == 0 && arg2.method_15066(l + 1, m + 1) == 0 && arg.method_15066(l + 1, m) == 2 && arg.method_15066(l, m + 1) == 2 && arg.method_15066(l + 1, m + 1) == 2) {
               o = l + 1;
               q = m + 1;
               r = 262144;
            } else if (arg2.method_15066(l - 1, m) == 0 && arg2.method_15066(l, m + 1) == 0 && arg2.method_15066(l - 1, m + 1) == 0 && arg.method_15066(l - 1, m) == 2 && arg.method_15066(l, m + 1) == 2 && arg.method_15066(l - 1, m + 1) == 2) {
               n = l - 1;
               q = m + 1;
               r = 262144;
            } else if (arg2.method_15066(l - 1, m) == 0 && arg2.method_15066(l, m - 1) == 0 && arg2.method_15066(l - 1, m - 1) == 0 && arg.method_15066(l - 1, m) == 2 && arg.method_15066(l, m - 1) == 2 && arg.method_15066(l - 1, m - 1) == 2) {
   ...
   static class LayoutGenerator {
      ...
      public void generate(BlockPos pos, BlockRotation rotation, List<WoodlandMansionGenerator.Piece> pieces, WoodlandMansionGenerator.MansionParameters mansionParameters) {
         ...
         for(int k = 0; k < lv2.field_15453 && !bl; ++k) {
            for(m = lv2.field_15454 - 1; m >= 0 && !bl; --m) {
               if (WoodlandMansionGenerator.MansionParameters.method_15047(lv2, m, k)) {
                  ...
                  this.addRoof(pieces, generationPiece3, lv2, Direction.SOUTH, m, k, m, k);
                  bl = true;
               }
            }
         }
         ...
         this.method_15055(pieces, pos.up(27), rotation, lv2, (WoodlandMansionGenerator.class_3478)null);
         if (!pieces.isEmpty()) {
         }
                  ...
                  if (lv4.method_15066(q, p) == 2 || bl2) {
                     ...
                     if (s == 65536) {
                        ...
                        if (s == 131072 && direction2 != null) {
                           direction4 = mansionParameters.method_15040(lv4, q, p, m, t);
      ...
      private void addRoof(List<WoodlandMansionGenerator.Piece> list, WoodlandMansionGenerator.GenerationPiece generationPiece, WoodlandMansionGenerator.class_3478 arg, Direction direction, int i, int j, int k, int l) {
         int m = i;
         int n = j;
         ...
         do {
            ...
            } else if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, m + direction.getOffsetX(), n + direction.getOffsetZ()) && WoodlandMansionGenerator.MansionParameters.method_15047(arg, m + direction.getOffsetX() + direction.rotateYCounterclockwise().getOffsetX(), n + direction.getOffsetZ() + direction.rotateYCounterclockwise().getOffsetZ())) {
      ...
      private void method_15055(List<WoodlandMansionGenerator.Piece> list, BlockPos blockPos, BlockRotation blockRotation, WoodlandMansionGenerator.class_3478 arg, @Nullable WoodlandMansionGenerator.class_3478 arg2) {
         int k;
         int l;
         BlockPos blockPos7;
         boolean bl3;
         ...
         for(k = 0; k < arg.field_15453; ++k) {
            for(l = 0; l < arg.field_15454; ++l) {
               ...
               bl3 = arg2 != null && WoodlandMansionGenerator.MansionParameters.method_15047(arg2, l, k);
               if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, l, k) && !bl3) {
         ...
         if (arg2 != null) {
            for(k = 0; k < arg.field_15453; ++k) {
               for(l = 0; l < arg.field_15454; ++l) {
                  blockPos7 = blockPos.offset(blockRotation.rotate(Direction.SOUTH), 8 + (k - this.field_15445) * 8);
                  blockPos7 = blockPos7.offset(blockRotation.rotate(Direction.EAST), (l - this.field_15446) * 8);
                  bl3 = WoodlandMansionGenerator.MansionParameters.method_15047(arg2, l, k);
                  if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, l, k) && bl3) {
                     if (!WoodlandMansionGenerator.MansionParameters.method_15047(arg, l + 1, k)) {
            ...
            for(l = 0; l < arg.field_15454; ++l) {
               ...
               if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, l, k) && !bl3) {
                  ...
                  if (!WoodlandMansionGenerator.MansionParameters.method_15047(arg, l + 1, k)) {
                     ...
                     } else if (WoodlandMansionGenerator.MansionParameters.method_15047(arg, l + 1, k + 1)) {
      ...
      private void method_15052(List<WoodlandMansionGenerator.Piece> list, WoodlandMansionGenerator.GenerationPiece generationPiece) {
         list.add(new WoodlandMansionGenerator.Piece(this.manager, generationPiece.template, generationPiece.position.offset(generationPiece.rotation.rotate(Direction.EAST), 7), generationPiece.rotation));
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      protected void handleMetadata(String metadata, BlockPos pos, IWorld world, Random random, BlockBox boundingBox) {
         if (metadata.startsWith("Chest")) {
            ...
            switch(var8) {
            case 0:
               illagerEntity3 = (IllagerEntity)EntityType.EVOKER.create(world.getWorld());
               break;
            case 1:
               illagerEntity3 = (IllagerEntity)EntityType.VINDICATOR.create(world.getWorld());
               break;
            default:
               return;
            }
            ...
            illagerEntity3.initialize(world, world.getLocalDifficulty(new BlockPos(illagerEntity3)), SpawnType.STRUCTURE, (EntityData)null, (CompoundTag)null);
            world.spawnEntity(illagerEntity3);
