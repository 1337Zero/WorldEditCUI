...
public abstract class StructurePiece {
   ...
   protected void fillWithOutline(IWorld iWorld, BlockBox blockBox, int minX, int minY, int minZ, int maxX, int maxY, int maxZ, boolean replaceBlocks, Random random, StructurePiece.BlockRandomizer blockRandomizer) {
   ...
   public static BlockState method_14916(BlockView blockView, BlockPos blockPos, BlockState blockState) {
      ...
      if (direction != null) {
         ...
         Direction direction3 = (Direction)blockState.get(HorizontalFacingBlock.FACING);
