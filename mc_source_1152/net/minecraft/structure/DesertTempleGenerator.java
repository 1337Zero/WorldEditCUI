...
public class DesertTempleGenerator extends StructurePieceWithDimensions {
   ...
   public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
      this.fillWithOutline(world, blockBox, 0, -4, 0, this.width - 1, 0, this.depth - 1, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);

      int j;
      for(j = 1; j <= 9; ++j) {
         this.fillWithOutline(world, blockBox, j, j, j, this.width - 1 - j, j, this.depth - 1 - j, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
         this.fillWithOutline(world, blockBox, j + 1, j, j + 1, this.width - 2 - j, j, this.depth - 2 - j, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
      }

      for(j = 0; j < this.width; ++j) {
         for(int k = 0; k < this.depth; ++k) {
            int l = true;
            this.method_14936(world, Blocks.SANDSTONE.getDefaultState(), j, -5, k, blockBox);
         }
      }
      ...
      this.fillWithOutline(world, blockBox, this.width - 4, 10, 1, this.width - 2, 10, 3, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, blockBox, 5, 4, 5, this.width - 6, 4, this.depth - 6, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, blockBox, this.width - 5, 1, 5, this.width - 2, 4, 11, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      this.fillWithOutline(world, blockBox, 6, 7, 9, 6, 7, 11, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      this.fillWithOutline(world, blockBox, this.width - 7, 7, 9, this.width - 7, 7, 11, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, blockBox, this.width - 6, 5, 9, this.width - 6, 7, 11, Blocks.CUT_SANDSTONE.getDefaultState(), Blocks.CUT_SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, blockBox, this.width - 3, 1, 3, this.width - 2, 2, 3, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      this.fillWithOutline(world, blockBox, this.width - 5, 3, 5, this.width - 5, 3, 17, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
      ...
      int o;
      for(o = 5; o <= 17; o += 2) {
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, o, blockBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, o, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, o, blockBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, o, blockBox);
      }
      ...
      for(o = 0; o <= this.width - 1; o += this.width - 1) {
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 2, 1, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 2, 2, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 2, 3, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 3, 1, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 3, 2, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 3, 3, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 4, 1, blockBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 4, 2, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 4, 3, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 5, 1, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 5, 2, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 5, 3, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 6, 1, blockBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 6, 2, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 6, 3, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 1, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 2, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 3, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 1, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 2, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 3, blockBox);
      }

      for(o = 2; o <= this.width - 3; o += this.width - 3 - 2) {
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 2, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 2, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 2, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 3, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 3, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 3, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 4, 0, blockBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 4, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 4, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 5, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 5, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 5, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 6, 0, blockBox);
         this.addBlock(world, Blocks.CHISELED_SANDSTONE.getDefaultState(), o, 6, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 6, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o - 1, 7, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o, 7, 0, blockBox);
         this.addBlock(world, Blocks.ORANGE_TERRACOTTA.getDefaultState(), o + 1, 7, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o - 1, 8, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o, 8, 0, blockBox);
         this.addBlock(world, Blocks.CUT_SANDSTONE.getDefaultState(), o + 1, 8, 0, blockBox);
      }
      ...
      while(var17.hasNext()) {
         Direction direction = (Direction)var17.next();
         if (!this.hasPlacedChest[direction.getHorizontal()]) {
            int p = direction.getOffsetX() * 2;
            int q = direction.getOffsetZ() * 2;
            this.hasPlacedChest[direction.getHorizontal()] = this.addChest(world, blockBox, random, 10 + p, -11, 10 + q, LootTables.DESERT_PYRAMID_CHEST);
         }
      }
