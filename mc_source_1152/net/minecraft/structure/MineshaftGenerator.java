...
public class MineshaftGenerator {
   private static MineshaftGenerator.MineshaftPart method_14712(List<StructurePiece> list, Random random, int i, int j, int k, @Nullable Direction direction, int l, MineshaftFeature.Type type) {
      int m = random.nextInt(100);
      BlockBox blockBox2;
      if (m >= 80) {
         blockBox2 = MineshaftGenerator.MineshaftCrossing.method_14717(list, random, i, j, k, direction);
         if (blockBox2 != null) {
            return new MineshaftGenerator.MineshaftCrossing(l, blockBox2, direction, type);
         }
      } else if (m >= 70) {
         blockBox2 = MineshaftGenerator.MineshaftStairs.method_14720(list, random, i, j, k, direction);
         if (blockBox2 != null) {
            return new MineshaftGenerator.MineshaftStairs(l, blockBox2, direction, type);
         }
      } else {
         blockBox2 = MineshaftGenerator.MineshaftCorridor.method_14714(list, random, i, j, k, direction);
         if (blockBox2 != null) {
            return new MineshaftGenerator.MineshaftCorridor(l, random, blockBox2, direction, type);
         }
      }
   ...
   private static MineshaftGenerator.MineshaftPart method_14711(StructurePiece structurePiece, List<StructurePiece> list, Random random, int i, int j, int k, Direction direction, int l) {
      if (l > 8) {
         return null;
   ...
   public static class MineshaftStairs extends MineshaftGenerator.MineshaftPart {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         if (this.method_14937(world, blockBox)) {
            return false;
         } else {
            this.fillWithOutline(world, blockBox, 0, 5, 0, 2, 7, 1, AIR, AIR, false);
            this.fillWithOutline(world, blockBox, 0, 0, 7, 2, 2, 8, AIR, AIR, false);

            for(int i = 0; i < 5; ++i) {
               this.fillWithOutline(world, blockBox, 0, 5 - i - (i < 4 ? 1 : 0), 2 + i, 2, 7 - i, 2 + i, AIR, AIR, false);
            }
   ...
   public static class MineshaftCrossing extends MineshaftGenerator.MineshaftPart {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         if (this.method_14937(world, blockBox)) {
            ...
            if (this.twoFloors) {
               this.fillWithOutline(world, blockBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX - 1, this.boundingBox.minY + 3 - 1, this.boundingBox.maxZ, AIR, AIR, false);
               this.fillWithOutline(world, blockBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX, this.boundingBox.minY + 3 - 1, this.boundingBox.maxZ - 1, AIR, AIR, false);
               this.fillWithOutline(world, blockBox, this.boundingBox.minX + 1, this.boundingBox.maxY - 2, this.boundingBox.minZ, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ, AIR, AIR, false);
               this.fillWithOutline(world, blockBox, this.boundingBox.minX, this.boundingBox.maxY - 2, this.boundingBox.minZ + 1, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ - 1, AIR, AIR, false);
               this.fillWithOutline(world, blockBox, this.boundingBox.minX + 1, this.boundingBox.minY + 3, this.boundingBox.minZ + 1, this.boundingBox.maxX - 1, this.boundingBox.minY + 3, this.boundingBox.maxZ - 1, AIR, AIR, false);
            } else {
               this.fillWithOutline(world, blockBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX - 1, this.boundingBox.maxY, this.boundingBox.maxZ, AIR, AIR, false);
               this.fillWithOutline(world, blockBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ - 1, AIR, AIR, false);
            }

            this.method_14716(world, blockBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxY);
            this.method_14716(world, blockBox, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.maxY);
            this.method_14716(world, blockBox, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, this.boundingBox.maxY);
            this.method_14716(world, blockBox, this.boundingBox.maxX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 1, this.boundingBox.maxY);

            for(int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i) {
               for(int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
                  if (this.getBlockAt(world, i, this.boundingBox.minY - 1, j, blockBox).isAir() && this.isUnderSeaLevel(world, i, this.boundingBox.minY - 1, j, blockBox)) {
                     this.addBlock(world, blockState, i, this.boundingBox.minY - 1, j, blockBox);
                  }
               }
            }
   ...
   public static class MineshaftCorridor extends MineshaftGenerator.MineshaftPart {
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         if (this.method_14937(world, blockBox)) {
            ...
            BlockState blockState = this.method_16443();
            this.fillWithOutline(world, blockBox, 0, 0, 0, 2, 1, m, AIR, AIR, false);
            this.fillWithOutlineUnderSealevel(world, blockBox, random, 0.8F, 0, 2, 0, 2, 2, m, AIR, AIR, false, false);
            if (this.hasCobwebs) {
               this.fillWithOutlineUnderSealevel(world, blockBox, random, 0.6F, 0, 0, 0, 2, 1, m, Blocks.COBWEB.getDefaultState(), AIR, false, true);
            }
            ...
            for(t = 0; t < this.length; ++t) {
               x = 2 + t * 5;
               this.method_14713(world, blockBox, 0, 0, x, 2, 2, random);
               this.method_14715(world, blockBox, random, 0.1F, 0, 2, x - 1);
               this.method_14715(world, blockBox, random, 0.1F, 2, 2, x - 1);
               this.method_14715(world, blockBox, random, 0.1F, 0, 2, x + 1);
               this.method_14715(world, blockBox, random, 0.1F, 2, 2, x + 1);
               this.method_14715(world, blockBox, random, 0.05F, 0, 2, x - 2);
               this.method_14715(world, blockBox, random, 0.05F, 2, 2, x - 2);
               this.method_14715(world, blockBox, random, 0.05F, 0, 2, x + 2);
               this.method_14715(world, blockBox, random, 0.05F, 2, 2, x + 2);
               if (random.nextInt(100) == 0) {
                  this.addChest(world, blockBox, random, 2, 0, x - 1, LootTables.ABANDONED_MINESHAFT_CHEST);
               }

               if (random.nextInt(100) == 0) {
                  this.addChest(world, blockBox, random, 0, 0, x + 1, LootTables.ABANDONED_MINESHAFT_CHEST);
               }
               ...
               if (this.hasCobwebs && !this.hasSpawner) {
                  ...
                  if (blockBox.contains(blockPos) && this.isUnderSeaLevel(world, 1, 0, q, blockBox)) {
            ...
            for(t = 0; t <= 2; ++t) {
               for(x = 0; x <= m; ++x) {
                  int v = true;
                  BlockState blockState2 = this.getBlockAt(world, t, -1, x, blockBox);
                  if (blockState2.isAir() && this.isUnderSeaLevel(world, t, -1, x, blockBox)) {
                     int w = true;
                     this.addBlock(world, blockState, t, -1, x, blockBox);
                  }
               }
            }
            ...
            if (this.hasRails) {
               ...
               for(x = 0; x <= m; ++x) {
                  BlockState blockState4 = this.getBlockAt(world, 1, -1, x, blockBox);
                  if (!blockState4.isAir() && blockState4.isFullOpaque(world, new BlockPos(this.applyXTransform(1, x), this.applyYTransform(-1), this.applyZTransform(1, x)))) {
                     float f = this.isUnderSeaLevel(world, 1, 0, x, blockBox) ? 0.7F : 0.9F;
                     this.addBlockWithRandomThreshold(world, blockBox, random, f, 1, 0, x, blockState3);
                  }
               }
            }
   ...
   public static class MineshaftRoom extends MineshaftGenerator.MineshaftPart {
      ...
      public void method_14918(StructurePiece structurePiece, List<StructurePiece> list, Random random) {
         ...
         int k;
         MineshaftGenerator.MineshaftPart structurePiece2;
         BlockBox blockBox4;
         for(k = 0; k < this.boundingBox.getBlockCountX(); k += 4) {
            ...
            structurePiece2 = MineshaftGenerator.method_14711(structurePiece, list, random, this.boundingBox.minX + k, this.boundingBox.minY + random.nextInt(j) + 1, this.boundingBox.minZ - 1, Direction.NORTH, i);
         ...
         for(k = 0; k < this.boundingBox.getBlockCountX(); k += 4) {
            ...
            structurePiece2 = MineshaftGenerator.method_14711(structurePiece, list, random, this.boundingBox.minX + k, this.boundingBox.minY + random.nextInt(j) + 1, this.boundingBox.maxZ + 1, Direction.SOUTH, i);
            if (structurePiece2 != null) {
               blockBox4 = structurePiece2.getBoundingBox();
         ...
         for(k = 0; k < this.boundingBox.getBlockCountZ(); k += 4) {
            ...
            structurePiece2 = MineshaftGenerator.method_14711(structurePiece, list, random, this.boundingBox.minX - 1, this.boundingBox.minY + random.nextInt(j) + 1, this.boundingBox.minZ + k, Direction.WEST, i);
            if (structurePiece2 != null) {
               blockBox4 = structurePiece2.getBoundingBox();
         ...
         for(k = 0; k < this.boundingBox.getBlockCountZ(); k += 4) {
            ...
            structurePiece2 = MineshaftGenerator.method_14711(structurePiece, list, random, this.boundingBox.maxX + 1, this.boundingBox.minY + random.nextInt(j) + 1, this.boundingBox.minZ + k, Direction.EAST, i);
            if (structurePiece2 != null) {
               blockBox4 = structurePiece2.getBoundingBox();
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         if (this.method_14937(world, blockBox)) {
            ...
            this.fillWithOutline(world, blockBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.minY, this.boundingBox.maxZ, Blocks.DIRT.getDefaultState(), AIR, true);
            this.fillWithOutline(world, blockBox, this.boundingBox.minX, this.boundingBox.minY + 1, this.boundingBox.minZ, this.boundingBox.maxX, Math.min(this.boundingBox.minY + 3, this.boundingBox.maxY), this.boundingBox.maxZ, AIR, AIR, false);
            Iterator var6 = this.entrances.iterator();

            while(var6.hasNext()) {
               BlockBox blockBox2 = (BlockBox)var6.next();
               this.fillWithOutline(world, blockBox, blockBox2.minX, blockBox2.maxY - 2, blockBox2.minZ, blockBox2.maxX, blockBox2.maxY, blockBox2.maxZ, AIR, AIR, false);
            }

            this.method_14919(world, blockBox, this.boundingBox.minX, this.boundingBox.minY + 4, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ, AIR, false);
            return true;
         }
      }
