...
public class ShipwreckGenerator {
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      private void initializeStructureData(StructureManager manager) {
         ...
         StructurePlacementData structurePlacementData = (new StructurePlacementData()).setRotation(this.rotation).setMirrored(BlockMirror.NONE).setPosition(ShipwreckGenerator.field_14536).addProcessor(BlockIgnoreStructureProcessor.IGNORE_AIR_AND_STRUCTURE_BLOCKS);
      ...
      public boolean generate(IWorld world, ChunkGenerator<?> chunkGenerator, Random random, BlockBox blockBox, ChunkPos chunkPos) {
         ...
         if (k == 0) {
            ...
            int l;
            for(Iterator var12 = BlockPos.iterate(this.pos, blockPos2).iterator(); var12.hasNext(); i = Math.min(i, l)) {
               BlockPos blockPos3 = (BlockPos)var12.next();
               l = world.getTopY(type, blockPos3.getX(), blockPos3.getZ());
               j += l;
            }
