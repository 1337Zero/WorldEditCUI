...
public class JigsawReplacementStructureProcessor extends StructureProcessor {
   ...
   public Structure.StructureBlockInfo process(WorldView worldView, BlockPos pos, Structure.StructureBlockInfo structureBlockInfo, Structure.StructureBlockInfo structureBlockInfo2, StructurePlacementData placementData) {
      ...
      if (block != Blocks.JIGSAW) {
         ...
         return blockArgumentParser.getBlockState().getBlock() == Blocks.STRUCTURE_VOID ? null : new Structure.StructureBlockInfo(structureBlockInfo2.pos, blockArgumentParser.getBlockState(), (CompoundTag)null);
      }
   }
