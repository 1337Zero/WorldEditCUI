      ...
      if (depth > 8) {
         ...
         if (piece.create(manager, depth, parent, pos, list, random)) {
            ...
            while(var10.hasNext()) {
               ...
               if (structurePiece2 != null && structurePiece2.field_15316 != parent.field_15316) {
                  bl = true;
                  break;
               }
            }
   ...
   public static class Piece extends SimpleStructurePiece {
      ...
      protected void handleMetadata(String metadata, BlockPos pos, IWorld world, Random random, BlockBox boundingBox) {
         if (metadata.startsWith("Chest")) {
            ...
            ShulkerEntity shulkerEntity = (ShulkerEntity)EntityType.SHULKER.create(world.getWorld());
