...
public final class ProjectileUtil {
   public static HitResult getCollision(Entity entity, boolean bl, boolean bl2, @Nullable Entity entity2, RayTraceContext.ShapeType shapeType) {
      return getCollision(entity, bl, bl2, entity2, shapeType, true, (entity2x) -> {
         return !entity2x.isSpectator() && entity2x.collides() && (bl2 || !entity2x.isPartOf(entity2)) && !entity2x.noClip;
      }, entity.getBoundingBox().stretch(entity.getVelocity()).expand(1.0D));
   }
   ...
   public static HitResult getCollision(Entity entity, Box box, Predicate<Entity> entityCollisionPredicate, RayTraceContext.ShapeType shapeType, boolean bl) {
      return getCollision(entity, bl, false, (Entity)null, shapeType, false, entityCollisionPredicate, box);
   }
   ...
   private static HitResult getCollision(Entity entity, boolean bl, boolean bl2, @Nullable Entity entity2, RayTraceContext.ShapeType shapeType, boolean bl3, Predicate<Entity> entityCollisionPredicate, Box boz) {
      ...
      if (bl3 && !world.doesNotCollide(entity, entity.getBoundingBox(), (Set)(!bl2 && entity2 != null ? getEntityAndRidingEntity(entity2) : ImmutableSet.of()))) {
   ...
   public static EntityHitResult getEntityCollision(World world, Entity entity, Vec3d vec3d, Vec3d vec3d2, Box box, Predicate<Entity> predicate, double d) {
      double e = d;
      Entity entity2 = null;
      Iterator var11 = world.getEntities(entity, box, predicate).iterator();
