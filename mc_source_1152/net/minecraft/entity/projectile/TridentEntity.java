...
public class TridentEntity extends ProjectileEntity {
   ...
   private static final TrackedData<Boolean> field_21514;
   ...
   public boolean method_23751() {
      return (Boolean)this.dataTracker.get(field_21514);
   }
   ...
   static {
      ...
      field_21514 = DataTracker.registerData(TridentEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   }
}
