...
public class LlamaSpitEntity extends Entity implements Projectile {
   ...
   public void setVelocity(double x, double y, double z, float speed, float divergence) {
      ...
      this.yaw = (float)(MathHelper.atan2(vec3d.x, z) * 57.2957763671875D);
   ...
   private void readTag() {
      if (this.tag != null && this.tag.containsUuid("OwnerUUID")) {
         ...
         List<LlamaEntity> list = this.world.getNonSpectatingEntities(LlamaEntity.class, this.getBoundingBox().expand(15.0D));
         Iterator var3 = list.iterator();

         while(var3.hasNext()) {
            LlamaEntity llamaEntity = (LlamaEntity)var3.next();
