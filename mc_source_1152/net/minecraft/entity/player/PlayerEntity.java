...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public PlayerEntity(World world, GameProfile profile) {
      ...
      this.refreshPositionAndAngles((double)blockPos.getX() + 0.5D, (double)(blockPos.getY() + 1), (double)blockPos.getZ() + 0.5D, 0.0F, 0.0F);
   ...
   protected void initAttributes() {
      ...
      this.getAttributes().register(EntityAttributes.ATTACK_DAMAGE).setBaseValue(1.0D);
   ...
   private void method_7313() {
      ...
      this.field_7500 += d * 0.25D;
      this.field_7499 += f * 0.25D;
      this.field_7521 += e * 0.25D;
   }
   ...
   public void tickMovement() {
      ...
      if (this.getHealth() > 0.0F && !this.isSpectator()) {
         ...
         List<Entity> list = this.world.getEntities(this, box2);
   ...
   private void updateShoulderEntity(@Nullable CompoundTag entityTag) {
      if (entityTag != null && !entityTag.contains("Silent") || !entityTag.getBoolean("Silent")) {
         ...
         EntityType.get(string).filter((entityType) -> {
            ...
            ParrotEntity.playMobSound(this.world, this);
         });
      }
   ...
   protected Vec3d adjustMovementForSneaking(Vec3d movement, MovementType type) {
      if ((type == MovementType.SELF || type == MovementType.PLAYER) && this.onGround && this.clipAtLedge()) {
         ...
         while(true) {
            while(d != 0.0D && this.world.doesNotCollide(this, this.getBoundingBox().offset(d, (double)(-this.stepHeight), 0.0D))) {
               if (d < 0.05D && d >= -0.05D) {
                  d = 0.0D;
               } else if (d > 0.0D) {
                  d -= 0.05D;
            ...
            while(true) {
               while(e != 0.0D && this.world.doesNotCollide(this, this.getBoundingBox().offset(0.0D, (double)(-this.stepHeight), e))) {
                  if (e < 0.05D && e >= -0.05D) {
                     e = 0.0D;
                  } else if (e > 0.0D) {
                     e -= 0.05D;
               ...
               while(true) {
                  while(d != 0.0D && e != 0.0D && this.world.doesNotCollide(this, this.getBoundingBox().offset(d, (double)(-this.stepHeight), e))) {
                     if (d < 0.05D && d >= -0.05D) {
                        d = 0.0D;
                     } else if (d > 0.0D) {
                        d -= 0.05D;
         ...
         if (!target.handleAttack(this)) {
            ...
            if (f > 0.0F || h > 0.0F) {
               ...
               if (bl6) {
                  if (j > 0) {
                     if (target instanceof LivingEntity) {
                        ((LivingEntity)target).takeKnockback(this, (float)j * 0.5F, (double)MathHelper.sin(this.yaw * 0.017453292F), (double)(-MathHelper.cos(this.yaw * 0.017453292F)));
                     } else {
                  ...
                  if (bl4) {
                     ...
                     while(true) {
                        ...
                        if (this.squaredDistanceTo(livingEntity) < 9.0D) {
                           livingEntity.takeKnockback(this, 0.4F, (double)MathHelper.sin(this.yaw * 0.017453292F), (double)(-MathHelper.cos(this.yaw * 0.017453292F)));
   ...
   public static Optional<Vec3d> findRespawnPosition(WorldView world, BlockPos spawnPos, boolean allowNonBed) {
      ...
      if (!(block instanceof BedBlock)) {
         if (!allowNonBed) {
            ...
            return bl && bl2 ? Optional.of(new Vec3d((double)spawnPos.getX() + 0.5D, (double)spawnPos.getY() + 0.1D, (double)spawnPos.getZ() + 0.5D)) : Optional.empty();
         }
      } else {
   ...
   public void method_7282(double d, double e, double f) {
      if (!this.hasVehicle()) {
         int l;
         if (this.isSwimming()) {
            l = Math.round(MathHelper.sqrt(d * d + e * e + f * f) * 100.0F);
            if (l > 0) {
            ...
            l = Math.round(MathHelper.sqrt(d * d + f * f) * 100.0F);
            if (l > 0) {
            ...
            if (e > 0.0D) {
               this.increaseStat(Stats.CLIMB_ONE_CM, (int)Math.round(e * 100.0D));
            }
   ...
   private Text addTellClickEvent(Text component) {
      ...
      return component.styled((style) -> {
         style.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/tell " + string + " ")).setHoverEvent(this.getHoverEvent()).setInsertion(string);
      });
   }
   ...
   public boolean equip(int slot, ItemStack item) {
      if (slot >= 0 && slot < this.inventory.main.size()) {
         ...
         if (slot == 98) {
            ...
            this.inventory.setInvStack(equipmentSlot5.getEntitySlotId() + this.inventory.main.size(), item);
            return true;
         }
      }
   }
