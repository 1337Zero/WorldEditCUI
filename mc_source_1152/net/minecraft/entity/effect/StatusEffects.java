...
public class StatusEffects {
   ...
   private static StatusEffect register(int i, String string, StatusEffect statusEffect) {
      return (StatusEffect)Registry.register(Registry.STATUS_EFFECT, i, string, statusEffect);
   }

   static {
      SPEED = register(1, "speed", (new StatusEffect(StatusEffectType.BENEFICIAL, 8171462)).addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 0.20000000298023224D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
      SLOWNESS = register(2, "slowness", (new StatusEffect(StatusEffectType.HARMFUL, 5926017)).addAttributeModifier(EntityAttributes.MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.15000000596046448D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
      HASTE = register(3, "haste", (new StatusEffect(StatusEffectType.BENEFICIAL, 14270531)).addAttributeModifier(EntityAttributes.ATTACK_SPEED, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", 0.10000000149011612D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
      MINING_FATIGUE = register(4, "mining_fatigue", (new StatusEffect(StatusEffectType.HARMFUL, 4866583)).addAttributeModifier(EntityAttributes.ATTACK_SPEED, "55FCED67-E92A-486E-9800-B47F202C4386", -0.10000000149011612D, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
      STRENGTH = register(5, "strength", (new DamageModifierStatusEffect(StatusEffectType.BENEFICIAL, 9643043, 3.0D)).addAttributeModifier(EntityAttributes.ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 0.0D, EntityAttributeModifier.Operation.ADDITION));
      ...
      WEAKNESS = register(18, "weakness", (new DamageModifierStatusEffect(StatusEffectType.HARMFUL, 4738376, -4.0D)).addAttributeModifier(EntityAttributes.ATTACK_DAMAGE, "22653B89-116E-49DC-9B6B-9971489B5BE5", 0.0D, EntityAttributeModifier.Operation.ADDITION));
      ...
      HEALTH_BOOST = register(21, "health_boost", (new HealthBoostStatusEffect(StatusEffectType.BENEFICIAL, 16284963)).addAttributeModifier(EntityAttributes.MAX_HEALTH, "5D6F0BA2-1186-46AC-B896-C61C5CEE99CC", 4.0D, EntityAttributeModifier.Operation.ADDITION));
      ...
      LUCK = register(26, "luck", (new StatusEffect(StatusEffectType.BENEFICIAL, 3381504)).addAttributeModifier(EntityAttributes.LUCK, "03C3C89D-7037-4B42-869F-B146BCB64D2E", 1.0D, EntityAttributeModifier.Operation.ADDITION));
      UNLUCK = register(27, "unluck", (new StatusEffect(StatusEffectType.HARMFUL, 12624973)).addAttributeModifier(EntityAttributes.LUCK, "CC5AF142-2BD2-4215-B636-2605AED11727", -1.0D, EntityAttributeModifier.Operation.ADDITION));
