   ...
   public void tick() {
      if (this.block.isAir()) {
         ...
         if (this.timeFalling++ == 0) {
            ...
            if (this.world.getBlockState(blockPos2).getBlock() == block) {
         ...
         if (!this.world.isClient) {
            ...
            if (bl && d > 1.0D) {
               BlockHitResult blockHitResult = this.world.rayTrace(new RayTraceContext(new Vec3d(this.prevX, this.prevY, this.prevZ), this.getPos(), RayTraceContext.ShapeType.COLLIDER, RayTraceContext.FluidHandling.SOURCE_ONLY, this));
