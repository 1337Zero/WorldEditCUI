   ...
   public void tick() {
      ...
      if (this.ambientTick >= 0) {
         if (this.world.isClient) {
            ...
            double d = 3.0D;
            List<Entity> list = this.world.getEntities((Entity)this, new Box(this.getX() - 3.0D, this.getY() - 3.0D, this.getZ() - 3.0D, this.getX() + 3.0D, this.getY() + 6.0D + 3.0D, this.getZ() + 3.0D), Entity::isAlive);
