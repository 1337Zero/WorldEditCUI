...
public class ProjectileDamageSource extends EntityDamageSource {
   ...
   public Text getDeathMessage(LivingEntity livingEntity) {
      ...
      return !itemStack.isEmpty() && itemStack.hasCustomName() ? new TranslatableText(string2, new Object[]{livingEntity.getDisplayName(), text, itemStack.toHoverableText()}) : new TranslatableText(string, new Object[]{livingEntity.getDisplayName(), text});
   }
}
