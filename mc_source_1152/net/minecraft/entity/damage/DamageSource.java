...
public class DamageSource {
   ...
   public static DamageSource explosiveProjectile(ExplosiveProjectileEntity projectile, @Nullable Entity attacker) {
      return attacker == null ? (new ProjectileDamageSource("onFire", projectile, projectile)).setFire().setProjectile() : (new ProjectileDamageSource("fireball", projectile, attacker)).setFire().setProjectile();
   }
   ...
   public static DamageSource explosion(@Nullable Explosion explosion) {
      return explosion != null && explosion.getCausingEntity() != null ? (new EntityDamageSource("explosion.player", explosion.getCausingEntity())).setScaledWithDifficulty().setExplosive() : (new DamageSource("explosion")).setScaledWithDifficulty().setExplosive();
   }

   public static DamageSource explosion(@Nullable LivingEntity attacker) {
      return attacker != null ? (new EntityDamageSource("explosion.player", attacker)).setScaledWithDifficulty().setExplosive() : (new DamageSource("explosion")).setScaledWithDifficulty().setExplosive();
   }
   ...
   public Text getDeathMessage(LivingEntity livingEntity) {
      ...
      return livingEntity2 != null ? new TranslatableText(string2, new Object[]{livingEntity.getDisplayName(), livingEntity2.getDisplayName()}) : new TranslatableText(string, new Object[]{livingEntity.getDisplayName()});
   }
