...
public class EntityDamageSource extends DamageSource {
   ...
   public Text getDeathMessage(LivingEntity livingEntity) {
      ...
      return !itemStack.isEmpty() && itemStack.hasCustomName() ? new TranslatableText(string + ".item", new Object[]{livingEntity.getDisplayName(), this.source.getDisplayName(), itemStack.toHoverableText()}) : new TranslatableText(string, new Object[]{livingEntity.getDisplayName(), this.source.getDisplayName()});
   }
