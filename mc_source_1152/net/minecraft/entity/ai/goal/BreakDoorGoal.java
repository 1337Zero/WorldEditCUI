...
public class BreakDoorGoal extends DoorInteractGoal {
   ...
   public boolean shouldContinue() {
      return this.breakProgress <= this.getMaxProgress() && !this.isDoorOpen() && this.doorPos.isWithinDistance(this.mob.getPos(), 2.0D) && this.isDifficultySufficient(this.mob.world.getDifficulty());
   }
