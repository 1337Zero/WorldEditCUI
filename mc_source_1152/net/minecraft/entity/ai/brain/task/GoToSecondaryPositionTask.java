   ...
   protected boolean shouldRun(ServerWorld serverWorld, VillagerEntity villagerEntity) {
      ...
      if (optional.isPresent() && optional2.isPresent()) {
         ...
         if (!list.isEmpty()) {
            ...
            return this.chosenPosition != null && Objects.equals(serverWorld.getDimension().getType(), this.chosenPosition.getDimension()) && ((GlobalPos)optional2.get()).getPos().isWithinDistance(villagerEntity.getPos(), (double)this.primaryPositionActivationDistance);
         }
      }
