   ...
   protected void run(ServerWorld serverWorld, VillagerEntity villagerEntity, long l) {
      ...
      brain.getOptionalMemory(this.destination).ifPresent((globalPos) -> {
         if (this.shouldGiveUp(serverWorld, villagerEntity)) {
            ...
            for(boolean var9 = true; i < 1000 && (vec3d == null || this.exceedsMaxRange(serverWorld, villagerEntity, GlobalPos.create(villagerEntity.dimension, new BlockPos(vec3d)))); ++i) {
