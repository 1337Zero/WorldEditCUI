...
public class FollowCustomerTask extends Task<VillagerEntity> {
   ...
   protected boolean shouldRun(ServerWorld serverWorld, VillagerEntity villagerEntity) {
      ...
      return villagerEntity.isAlive() && playerEntity != null && !villagerEntity.isTouchingWater() && !villagerEntity.velocityModified && villagerEntity.squaredDistanceTo(playerEntity) <= 16.0D && playerEntity.container != null;
   }
