...
public class PufferfishEntity extends FishEntity {
   ...
   public void tickMovement() {
      ...
      if (this.isAlive() && this.getPuffState() > 0) {
         List<MobEntity> list = this.world.getEntities(MobEntity.class, this.getBoundingBox().expand(0.3D), BLOW_UP_FILTER);
   ...
   static class InflateGoal extends Goal {
      ...
      public boolean canStart() {
         List<LivingEntity> list = this.pufferfish.world.getEntities(LivingEntity.class, this.pufferfish.getBoundingBox().expand(2.0D), PufferfishEntity.BLOW_UP_FILTER);
         return !list.isEmpty();
      }
