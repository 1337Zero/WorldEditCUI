...
public class CatEntity extends TameableEntity {
   ...
   public CatEntity createChild(PassiveEntity passiveEntity) {
      CatEntity catEntity = (CatEntity)EntityType.CAT.create(this.world);
         ...
         if (this.isTamed()) {
            if (this.isOwner(player)) {
               if (!(item instanceof DyeItem)) {
                  ...
                  bl = super.interactMob(player, hand);
                  if (!bl || this.isBaby()) {
   ...
   static class SleepWithOwnerGoal extends Goal {
      ...
      private void dropMorningGifts() {
         ...
         while(var6.hasNext()) {
            ...
            this.cat.world.spawnEntity(new ItemEntity(this.cat.world, (double)((float)mutable.getX() - MathHelper.sin(this.cat.bodyYaw * 0.017453292F)), (double)mutable.getY(), (double)((float)mutable.getZ() + MathHelper.cos(this.cat.bodyYaw * 0.017453292F)), itemStack));
         }
