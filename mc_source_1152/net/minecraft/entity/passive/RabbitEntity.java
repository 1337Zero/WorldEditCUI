...
public class RabbitEntity extends AnimalEntity {
   ...
   protected void initGoals() {
      ...
      this.goalSelector.add(4, new RabbitEntity.FleeGoal(this, PlayerEntity.class, 8.0F, 2.2D, 2.2D));
      this.goalSelector.add(4, new RabbitEntity.FleeGoal(this, WolfEntity.class, 10.0F, 2.2D, 2.2D));
      this.goalSelector.add(4, new RabbitEntity.FleeGoal(this, HostileEntity.class, 4.0F, 2.2D, 2.2D));
   ...
   protected void initAttributes() {
      ...
      this.getAttributeInstance(EntityAttributes.MAX_HEALTH).setBaseValue(3.0D);
   ...
   public void setRabbitType(int rabbitType) {
      if (rabbitType == 99) {
         this.getAttributeInstance(EntityAttributes.ARMOR).setBaseValue(8.0D);
   ...
   static class EatCarrotCropGoal extends MoveToTargetPosGoal {
      ...
      public void tick() {
         super.tick();
         this.rabbit.getLookControl().lookAt((double)this.targetPos.getX() + 0.5D, (double)(this.targetPos.getY() + 1), (double)this.targetPos.getZ() + 0.5D, 10.0F, (float)this.rabbit.getLookPitchSpeed());
         if (this.hasReached()) {
