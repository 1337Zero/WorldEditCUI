...
public class EnderCrystalEntity extends Entity {
   ...
   static {
      BEAM_TARGET = DataTracker.registerData(EnderCrystalEntity.class, TrackedDataHandlerRegistry.OPTIONA_BLOCK_POS);
      SHOW_BOTTOM = DataTracker.registerData(EnderCrystalEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
   }
}
