...
public class ItemFrameEntity extends AbstractDecorationEntity {
   ...
   protected void method_6895() {
      if (this.facing != null) {
         double d = 0.46875D;
         double e = (double)this.blockPos.getX() + 0.5D - (double)this.facing.getOffsetX() * 0.46875D;
         double f = (double)this.blockPos.getY() + 0.5D - (double)this.facing.getOffsetY() * 0.46875D;
         double g = (double)this.blockPos.getZ() + 0.5D - (double)this.facing.getOffsetZ() * 0.46875D;
         this.setPos(e, f, g);
   ...
   public boolean method_6888() {
      if (!this.world.doesNotCollide(this)) {
         ...
         return blockState.getMaterial().isSolid() || this.facing.getAxis().isHorizontal() && AbstractRedstoneGateBlock.isRedstoneGate(blockState) ? this.world.getEntities((Entity)this, this.getBoundingBox(), PREDICATE).isEmpty() : false;
      }
   }
   ...
   private void removeFromFrame(ItemStack map) {
      ...
      map.setFrame((ItemFrameEntity)null);
   }
