   ...
   public Raid startRaid(ServerPlayerEntity player) {
      if (player.isSpectator()) {
         ...
         if (dimensionType == DimensionType.THE_NETHER) {
            ...
            List<PointOfInterest> list = (List)this.world.getPointOfInterestStorage().get(PointOfInterestType.ALWAYS_TRUE, blockPos, 64, PointOfInterestStorage.OccupationStatus.IS_OCCUPIED).collect(Collectors.toList());
            int i = 0;
