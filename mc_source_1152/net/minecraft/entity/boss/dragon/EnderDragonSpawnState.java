...
public enum EnderDragonSpawnState {
   START {
      public void run(ServerWorld world, EnderDragonFight fight, List<EnderCrystalEntity> crystals, int i, BlockPos blockPos) {
         ...
         while(var7.hasNext()) {
            EnderCrystalEntity enderCrystalEntity = (EnderCrystalEntity)var7.next();
         ...
         if (bl || bl2) {
            ...
            if (k < list.size()) {
               ...
               if (bl) {
                  ...
                  while(var12.hasNext()) {
                     EnderCrystalEntity enderCrystalEntity = (EnderCrystalEntity)var12.next();
   ...
   SUMMONING_DRAGON {
      public void run(ServerWorld world, EnderDragonFight fight, List<EnderCrystalEntity> crystals, int i, BlockPos blockPos) {
         ...
         if (i >= 100) {
            ...
            while(var6.hasNext()) {
               enderCrystalEntity2 = (EnderCrystalEntity)var6.next();
               enderCrystalEntity2.setBeamTarget((BlockPos)null);
               world.createExplosion(enderCrystalEntity2, enderCrystalEntity2.getX(), enderCrystalEntity2.getY(), enderCrystalEntity2.getZ(), 6.0F, Explosion.DestructionType.NONE);
               enderCrystalEntity2.remove();
            }
         } else if (i >= 80) {
            world.playLevelEvent(3001, new BlockPos(0, 128, 0), 0);
         } else if (i == 0) {
