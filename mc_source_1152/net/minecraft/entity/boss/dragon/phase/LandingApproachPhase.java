...
public class LandingApproachPhase extends AbstractPhase {
   ...
   public void serverTick() {
      double d = this.field_7048 == null ? 0.0D : this.field_7048.squaredDistanceTo(this.dragon.getX(), this.dragon.getY(), this.dragon.getZ());
   ...
   private void method_6844() {
      if (this.field_7047 == null || this.field_7047.isFinished()) {
         ...
         if (playerEntity != null) {
            ...
            k = this.dragon.method_6822(-vec3d.x * 40.0D, 105.0D, -vec3d.z * 40.0D);
         } else {
            k = this.dragon.method_6822(40.0D, (double)blockPos.getY(), 0.0D);
         }

         PathNode pathNode = new PathNode(blockPos.getX(), blockPos.getY(), blockPos.getZ());
         this.field_7047 = this.dragon.method_6833(i, k, pathNode);
