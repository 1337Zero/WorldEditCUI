...
public class WitherEntity extends HostileEntity implements SkinOverlayOwner, RangedAttackMob {
      ...
      if (this.getInvulnerableTimer() > 0) {
         ...
         if (this.field_7082 > 0) {
            ...
            if (this.field_7082 == 0 && this.world.getGameRules().getBoolean(GameRules.MOB_GRIEFING)) {
               ...
               if (bl) {
                  this.world.playLevelEvent((PlayerEntity)null, 1022, new BlockPos(this), 0);
               }
            }
         }
   ...
   private void method_6877(int headIndex, double d, double e, double f, boolean bl) {
      this.world.playLevelEvent((PlayerEntity)null, 1024, new BlockPos(this), 0);
   ...
   protected void initAttributes() {
      ...
      this.getAttributeInstance(EntityAttributes.MAX_HEALTH).setBaseValue(300.0D);
      this.getAttributeInstance(EntityAttributes.MOVEMENT_SPEED).setBaseValue(0.6000000238418579D);
