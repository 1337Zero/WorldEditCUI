...
public class SlimeEntity extends MobEntity implements Monster {
   ...
   public void remove() {
      ...
      if (!this.world.isClient && i > 1 && this.getHealth() <= 0.0F) {
         ...
         for(int k = 0; k < j; ++k) {
            ...
            slimeEntity.refreshPositionAndAngles(this.getX() + (double)f, this.getY() + 0.5D, this.getZ() + (double)g, this.random.nextFloat() * 360.0F, 0.0F);
   ...
   static class SwimmingGoal extends Goal {
      ...
      public void tick() {
         ...
         ((SlimeEntity.SlimeMoveControl)this.slime.getMoveControl()).move(1.2D);
      }
   }
   ...
   static class RandomLookGoal extends Goal {
      ...
      public boolean canStart() {
         return this.slime.getTarget() == null && (this.slime.onGround || this.slime.isTouchingWater() || this.slime.isInLava() || this.slime.hasStatusEffect(StatusEffects.LEVITATION)) && this.slime.getMoveControl() instanceof SlimeEntity.SlimeMoveControl;
      }
   ...
   static class FaceTowardTargetGoal extends Goal {
      ...
      public boolean canStart() {
         ...
         if (livingEntity == null) {
            ...
            return livingEntity instanceof PlayerEntity && ((PlayerEntity)livingEntity).abilities.invulnerable ? false : this.slime.getMoveControl() instanceof SlimeEntity.SlimeMoveControl;
         }
      }
