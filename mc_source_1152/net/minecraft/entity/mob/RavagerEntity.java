...
public class RavagerEntity extends RaiderEntity {
   ...
   public void tickMovement() {
      ...
      if (this.isAlive()) {
         if (this.isImmobile()) {
            ...
            this.getAttributeInstance(EntityAttributes.MOVEMENT_SPEED).setBaseValue(MathHelper.lerp(0.1D, e, d));
         }
   ...
   private void roar() {
      if (this.isAlive()) {
         List<Entity> list = this.world.getEntities(LivingEntity.class, this.getBoundingBox().expand(4.0D), IS_NOT_RAVAGER);
