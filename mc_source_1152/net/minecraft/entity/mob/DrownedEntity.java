...
public class DrownedEntity extends ZombieEntity implements RangedAttackMob {
   ...
   protected void initCustomGoals() {
      this.goalSelector.add(1, new DrownedEntity.WanderAroundOnSurfaceGoal(this, 1.0D));
      this.goalSelector.add(2, new DrownedEntity.TridentAttackGoal(this, 1.0D, 40, 10.0F));
      this.goalSelector.add(2, new DrownedEntity.DrownedAttackGoal(this, 1.0D, false));
      this.goalSelector.add(5, new DrownedEntity.LeaveWaterGoal(this, 1.0D));
      this.goalSelector.add(6, new DrownedEntity.TargetAboveWaterGoal(this, 1.0D, this.world.getSeaLevel()));
   ...
   public static boolean canSpawn(EntityType<DrownedEntity> type, IWorld world, SpawnType spawnType, BlockPos pos, Random random) {
      ...
      boolean bl = world.getDifficulty() != Difficulty.PEACEFUL && isSpawnDark(world, pos, random) && (spawnType == SpawnType.SPAWNER || world.getFluidState(pos).matches(FluidTags.WATER));
   ...
   public void attack(LivingEntity target, float f) {
      ...
      tridentEntity.setVelocity(d, e + h * 0.20000000298023224D, g, 1.6F, (float)(14 - this.world.getDifficulty().getId() * 4));
   ...
   static class DrownedMoveControl extends MoveControl {
      ...
      public void tick() {
         ...
         if (this.drowned.isTargetingUnderwater() && this.drowned.isTouchingWater()) {
            ...
            this.drowned.setVelocity(this.drowned.getVelocity().add((double)j * d * 0.005D, (double)j * e * 0.1D, (double)j * f * 0.005D));
         } else {
