   ...
   class SummonVexGoal extends SpellcastingIllagerEntity.CastSpellGoal {
      ...
      protected void castSpell() {
         for(int i = 0; i < 3; ++i) {
            ...
            vexEntity.initialize(EvokerEntity.this.world, EvokerEntity.this.world.getLocalDifficulty(blockPos), SpawnType.MOB_SUMMONED, (EntityData)null, (CompoundTag)null);
