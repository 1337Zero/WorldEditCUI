...
public class ZombieVillagerEntity extends ZombieEntity implements VillagerDataContainer {
   ...
   private void finishConversion(ServerWorld world) {
      VillagerEntity villagerEntity = (VillagerEntity)EntityType.VILLAGER.create(world);
      ...
      villagerEntity.initialize(world, world.getLocalDifficulty(new BlockPos(villagerEntity)), SpawnType.CONVERSION, (EntityData)null, (CompoundTag)null);
      if (this.isBaby()) {
      ...
      world.playLevelEvent((PlayerEntity)null, 1027, new BlockPos(this), 0);
   }
