...
public class FillCommand {
   ...
   static {
      AIR_BLOCK_ARGUMENT = new BlockStateArgument(Blocks.AIR.getDefaultState(), Collections.emptySet(), (CompoundTag)null);
      FAILED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.fill.failed", new Object[0]));
   }
