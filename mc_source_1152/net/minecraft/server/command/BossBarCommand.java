...
public class BossBarCommand {
   ...
   private static final SimpleCommandExceptionType SET_PLAYERS_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.players.unchanged", new Object[0]));
   private static final SimpleCommandExceptionType SET_NAME_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.name.unchanged", new Object[0]));
   private static final SimpleCommandExceptionType SET_COLOR_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.color.unchanged", new Object[0]));
   private static final SimpleCommandExceptionType SET_STYLE_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.style.unchanged", new Object[0]));
   private static final SimpleCommandExceptionType SET_VALUE_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.value.unchanged", new Object[0]));
   private static final SimpleCommandExceptionType SETMAX_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.max.unchanged", new Object[0]));
   private static final SimpleCommandExceptionType SET_VISIBILITY_UNCHANGED_HIDDEN_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.visibility.unchanged.hidden", new Object[0]));
   private static final SimpleCommandExceptionType SET_VISIBILITY_UNCHANGED_VISIBLE_EXCEPTION = new SimpleCommandExceptionType(new TranslatableText("commands.bossbar.set.visibility.unchanged.visible", new Object[0]));
   public static final SuggestionProvider<ServerCommandSource> suggestionProvider = (commandContext, suggestionsBuilder) -> {
   ...
   public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
      dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal("bossbar").requires((serverCommandSource) -> {
      ...
      }))))).then(CommandManager.literal("remove").then(CommandManager.argument("id", IdentifierArgumentType.identifier()).suggests(suggestionProvider).executes((commandContext) -> {
         return removeBossBar((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext));
      })))).then(CommandManager.literal("list").executes((commandContext) -> {
         return listBossBars((ServerCommandSource)commandContext.getSource());
      }))).then(CommandManager.literal("set").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument("id", IdentifierArgumentType.identifier()).suggests(suggestionProvider).then(CommandManager.literal("name").then(CommandManager.argument("name", TextArgumentType.text()).executes((commandContext) -> {
         return setName((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), TextArgumentType.getTextArgument(commandContext, "name"));
         ...
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.PINK);
      }))).then(CommandManager.literal("blue").executes((commandContext) -> {
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.BLUE);
      }))).then(CommandManager.literal("red").executes((commandContext) -> {
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.RED);
      }))).then(CommandManager.literal("green").executes((commandContext) -> {
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.GREEN);
      }))).then(CommandManager.literal("yellow").executes((commandContext) -> {
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.YELLOW);
      }))).then(CommandManager.literal("purple").executes((commandContext) -> {
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.PURPLE);
      }))).then(CommandManager.literal("white").executes((commandContext) -> {
         return setColor((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Color.WHITE);
         ...
         return setStyle((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Style.PROGRESS);
      }))).then(CommandManager.literal("notched_6").executes((commandContext) -> {
         return setStyle((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Style.NOTCHED_6);
      }))).then(CommandManager.literal("notched_10").executes((commandContext) -> {
         return setStyle((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Style.NOTCHED_10);
      }))).then(CommandManager.literal("notched_12").executes((commandContext) -> {
         return setStyle((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Style.NOTCHED_12);
      }))).then(CommandManager.literal("notched_20").executes((commandContext) -> {
         return setStyle((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BossBar.Style.NOTCHED_20);
         ...
         return setValue((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), IntegerArgumentType.getInteger(commandContext, "value"));
      })))).then(CommandManager.literal("max").then(CommandManager.argument("max", IntegerArgumentType.integer(1)).executes((commandContext) -> {
         return setMaxValue((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), IntegerArgumentType.getInteger(commandContext, "max"));
      })))).then(CommandManager.literal("visible").then(CommandManager.argument("visible", BoolArgumentType.bool()).executes((commandContext) -> {
         return setVisible((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), BoolArgumentType.getBool(commandContext, "visible"));
      })))).then(((LiteralArgumentBuilder)CommandManager.literal("players").executes((commandContext) -> {
         return setPlayers((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), Collections.emptyList());
      })).then(CommandManager.argument("targets", EntityArgumentType.players()).executes((commandContext) -> {
         return setPlayers((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext), EntityArgumentType.getOptionalPlayers(commandContext, "targets"));
      })))))).then(CommandManager.literal("get").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandManager.argument("id", IdentifierArgumentType.identifier()).suggests(suggestionProvider).then(CommandManager.literal("value").executes((commandContext) -> {
         return getValue((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext));
      }))).then(CommandManager.literal("max").executes((commandContext) -> {
         return getMaxValue((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext));
      }))).then(CommandManager.literal("visible").executes((commandContext) -> {
         return isVisible((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext));
      }))).then(CommandManager.literal("players").executes((commandContext) -> {
         return getPlayers((ServerCommandSource)commandContext.getSource(), createBossBar(commandContext));
      })))));
   }
   ...
   private static int listBossBars(ServerCommandSource source) {
      ...
      if (collection.isEmpty()) {
         source.sendFeedback(new TranslatableText("commands.bossbar.list.bars.none", new Object[0]), false);
      } else {
