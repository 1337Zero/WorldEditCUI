...
public class ServerChunkManager extends ChunkManager {
   private static final int CHUNKS_ELIGIBLE_FOR_SPAWNING = (int)Math.pow(17.0D, 2.0D);
   ...
   public WorldChunk getWorldChunk(int chunkX, int chunkZ) {
      if (Thread.currentThread() != this.serverThread) {
         ...
         if (chunkHolder == null) {
            ...
            Either<Chunk, ChunkHolder.Unloaded> either = (Either)chunkHolder.method_21737(ChunkStatus.FULL).getNow((Object)null);
            if (either == null) {
               return null;
            } else {
            ...
            if (optional.isPresent()) {
               ...
               if (!this.threadedAnvilChunkStorage.isTooFarFromPlayersToSpawnMobs(chunkPos)) {
                  ...
                  if (bl2 && (this.spawnMonsters || this.spawnAnimals) && this.world.getWorldBorder().contains(worldChunk.getPos())) {
                     ...
                     EntityCategory[] var14 = entityCategorys;
                     int var15 = entityCategorys.length;

                     for(int var16 = 0; var16 < var15; ++var16) {
                        EntityCategory entityCategory = var14[var16];
                        if (entityCategory != EntityCategory.MISC && (!entityCategory.isPeaceful() || this.spawnAnimals) && (entityCategory.isPeaceful() || this.spawnMonsters) && (!entityCategory.isAnimal() || bl3)) {
