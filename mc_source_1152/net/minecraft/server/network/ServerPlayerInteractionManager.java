...
public class ServerPlayerInteractionManager {
   ...
   public void setGameMode(GameMode gameMode) {
      ...
      this.player.server.getPlayerManager().sendToAll((Packet)(new PlayerListS2CPacket(PlayerListS2CPacket.Action.UPDATE_GAME_MODE, new ServerPlayerEntity[]{this.player})));
      ...
      if (this.gameMode == GameMode.SPECTATOR) {
         ...
         if (itemStack2 == itemStack && itemStack2.getCount() == i && itemStack2.getMaxUseTime() <= 0 && itemStack2.getDamage() == j) {
            ...
            if (!playerEntity.isUsingItem()) {
               ((ServerPlayerEntity)playerEntity).openContainer((Container)playerEntity.playerContainer);
            }
