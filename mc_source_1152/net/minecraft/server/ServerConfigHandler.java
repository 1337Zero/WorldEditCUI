...
public class ServerConfigHandler {
            ...
            ProfileLookupCallback profileLookupCallback = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile profile) {
                  ...
                  if (strings == null) {
                     ...
                     Date date = strings.length > 1 ? ServerConfigHandler.stringToDate(strings[1], (Date)null) : null;
                     String string = strings.length > 2 ? strings[2] : null;
                     Date date2 = strings.length > 3 ? ServerConfigHandler.stringToDate(strings[3], (Date)null) : null;
      ...
      if (BANNED_IPS_FILE.exists() && BANNED_IPS_FILE.isFile()) {
         ...
         try {
            ...
            while(var3.hasNext()) {
               ...
               Date date = strings.length > 1 ? stringToDate(strings[1], (Date)null) : null;
               String string2 = strings.length > 2 ? strings[2] : null;
               Date date2 = strings.length > 3 ? stringToDate(strings[3], (Date)null) : null;
   ...
   public static boolean checkSuccess(MinecraftServer minecraftServer) {
      ...
      bl = bl && checkPlayerConversionSuccess(minecraftServer);
      return bl;
   }
