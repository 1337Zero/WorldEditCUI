...
public class PlayerStatsGui extends JComponent {
   ...
   private void update() {
      ...
      this.lines[1] = "Avg tick: " + AVG_TICK_FORMAT.format(this.average(this.server.lastTickLengths) * 1.0E-6D) + " ms";
   ...
   public void paint(Graphics graphics) {
      ...
      int k;
      for(k = 0; k < 256; ++k) {
         int j = this.memoryUsePercentage[k + this.memoryusePctPos & 255];
         graphics.setColor(new Color(j + 28 << 16));
         graphics.fillRect(k, 100 - j, 1, j);
      }
