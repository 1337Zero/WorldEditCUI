...
public class ServerConfigList<K, V extends ServerConfigEntry<K>> {
   ...
   public V get(K object) {
      ...
      return (ServerConfigEntry)this.map.get(this.toString(object));
   }
   ...
   public void load() throws FileNotFoundException {
      if (this.file.exists()) {
         ...
         try {
            ...
            Collection<ServerConfigEntry<K>> collection = (Collection)JsonHelper.deserialize(this.GSON, (Reader)bufferedReader, (Type)field_14369);
            if (collection != null) {
               this.map.clear();
               Iterator var3 = collection.iterator();

               while(var3.hasNext()) {
                  ServerConfigEntry<K> serverConfigEntry = (ServerConfigEntry)var3.next();
