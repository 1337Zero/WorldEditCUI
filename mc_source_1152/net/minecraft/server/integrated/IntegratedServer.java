...
public class IntegratedServer extends MinecraftServer {
   ...
   public CrashReport populateCrashReport(CrashReport crashReport) {
      ...
      crashReport.getSystemDetailsSection().add("Type", (Object)"Integrated Server (map_client.txt)");
      crashReport.getSystemDetailsSection().add("Is Modded", () -> {
         return (String)this.method_24307().orElse("Probably not. Jar signature remains and both client + server brands are untouched.");
      });
      return crashReport;
   }
   ...
   public void stop(boolean bl) {
      this.submitAndJoin(() -> {
         List<ServerPlayerEntity> list = Lists.newArrayList(this.getPlayerManager().getPlayerList());
