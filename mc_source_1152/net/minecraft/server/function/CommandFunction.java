...
public class CommandFunction {
   ...
   public static CommandFunction create(Identifier id, CommandFunctionManager commandFunctionManager, List<String> fileLines) {
      List<CommandFunction.Element> list = Lists.newArrayListWithCapacity(fileLines.size());
   ...
   public interface Element {
      void execute(CommandFunctionManager commandFunctionManager, ServerCommandSource serverCommandSource, ArrayDeque<CommandFunctionManager.Entry> arrayDeque, int i) throws CommandSyntaxException;
   }
}
