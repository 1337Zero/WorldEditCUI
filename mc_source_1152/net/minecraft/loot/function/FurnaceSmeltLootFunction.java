...
public class FurnaceSmeltLootFunction extends ConditionalLootFunction {
   ...
   public ItemStack process(ItemStack stack, LootContext context) {
      if (stack.isEmpty()) {
         ...
         Optional<SmeltingRecipe> optional = context.getWorld().getRecipeManager().getFirstMatch(RecipeType.SMELTING, new BasicInventory(new ItemStack[]{stack}), context.getWorld());
