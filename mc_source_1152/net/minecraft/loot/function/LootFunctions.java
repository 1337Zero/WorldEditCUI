...
public class LootFunctions {
   ...
   public static final BiFunction<ItemStack, LootContext, ItemStack> NOOP = (stack, context) -> {
      return stack;
   };
   ...
   public static <T extends LootFunction> void register(LootFunction.Factory<? extends T> function) {
      ...
      Class<T> var2 = function.getFunctionClass();
   ...
   public static BiFunction<ItemStack, LootContext, ItemStack> join(BiFunction<ItemStack, LootContext, ItemStack>[] lootFunctions) {
      ...
      case 2:
         ...
         return (stack, context) -> {
            return (ItemStack)biFunction2.apply(biFunction.apply(stack, context), context);
         };
      default:
         return (stack, context) -> {
            ...
            for(int var5 = 0; var5 < var4; ++var5) {
               BiFunction<ItemStack, LootContext, ItemStack> biFunction = var3[var5];
   ...
   public static class Factory implements JsonDeserializer<LootFunction>, JsonSerializer<LootFunction> {
      public LootFunction deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
         ...
         LootFunction.Factory factory2;
         try {
            factory2 = LootFunctions.get(identifier);
