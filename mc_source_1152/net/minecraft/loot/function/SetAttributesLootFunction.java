   ...
   static class Attribute {
      ...
      public static SetAttributesLootFunction.Attribute deserialize(JsonObject json, JsonDeserializationContext context) {
         ...
         if (JsonHelper.hasString(json, "slot")) {
            ...
            for(Iterator var10 = jsonArray.iterator(); var10.hasNext(); equipmentSlots2[i++] = EquipmentSlot.byName(JsonHelper.asString(jsonElement, "slot"))) {
         ...
         return new SetAttributesLootFunction.Attribute(string, string2, operation, uniformLootTableRange, equipmentSlots2, uUID);
      }
