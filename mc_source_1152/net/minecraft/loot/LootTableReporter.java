...
public class LootTableReporter {
   ...
   public LootTableReporter(LootContextType lootContextType, Function<Identifier, LootCondition> function, Function<Identifier, LootTable> function2) {
      this(HashMultimap.create(), () -> {
         return "";
      }, lootContextType, function, ImmutableSet.of(), function2, ImmutableSet.of());
   }
   ...
   public LootTableReporter makeChild(String name) {
      ...
      }, this.contextType, this.conditionGetter, this.conditions, this.supplierGetter, this.suppliers);
   }

   public LootTableReporter withSupplier(String name, Identifier id) {
      ImmutableSet<Identifier> immutableSet = ImmutableSet.builder().addAll(this.suppliers).add(id).build();
      return new LootTableReporter(this.messages, () -> {
         return this.getContext() + name;
      }, this.contextType, this.conditionGetter, this.conditions, this.supplierGetter, immutableSet);
   }
   ...
   public LootTableReporter withCondition(String name, Identifier id) {
      ...
      return new LootTableReporter(this.messages, () -> {
         return this.getContext() + name;
      }, this.contextType, this.conditionGetter, immutableSet, this.supplierGetter, this.suppliers);
   }
