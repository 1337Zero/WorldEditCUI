...
public class LocationCheckLootCondition implements LootCondition {
   ...
   public boolean test(LootContext lootContext) {
      ...
      return blockPos != null && this.predicate.test(lootContext.getWorld(), (float)(blockPos.getX() + this.offset.getX()), (float)(blockPos.getY() + this.offset.getY()), (float)(blockPos.getZ() + this.offset.getZ()));
   }
