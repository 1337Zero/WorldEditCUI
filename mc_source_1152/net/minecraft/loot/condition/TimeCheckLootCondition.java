...
public class TimeCheckLootCondition implements LootCondition {
   ...
   public static class Factory extends LootCondition.Factory<TimeCheckLootCondition> {
      ...
      public TimeCheckLootCondition fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext) {
         Long var3 = jsonObject.has("period") ? JsonHelper.getLong(jsonObject, "period") : null;
         UniformLootTableRange uniformLootTableRange = (UniformLootTableRange)JsonHelper.deserialize(jsonObject, "value", jsonDeserializationContext, UniformLootTableRange.class);
         return new TimeCheckLootCondition(var3, uniformLootTableRange);
      }
   }
}
