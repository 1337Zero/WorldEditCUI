...
public class LootContext {
   ...
   private final Set<LootTable> suppliers;
   ...
   private LootContext(Random random, float f, ServerWorld serverWorld, Function<Identifier, LootTable> function, Function<Identifier, LootCondition> function2, Map<LootContextParameter<?>, Object> map, Map<Identifier, LootContext.Dropper> map2) {
      this.suppliers = Sets.newLinkedHashSet();
      this.conditions = Sets.newLinkedHashSet();
      this.random = random;
      this.luck = f;
   ...
   public static enum EntityTarget {
      ...
      public static LootContext.EntityTarget fromString(String type) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            LootContext.EntityTarget entityTarget = var1[var3];
   ...
   public static class Builder {
      ...
      public <T> T get(LootContextParameter<T> parameter) {
         T object = this.parameters.get(parameter);
         if (object == null) {
