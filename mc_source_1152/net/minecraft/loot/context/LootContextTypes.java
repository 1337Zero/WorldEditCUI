...
public class LootContextTypes {
   ...
   public static final LootContextType CHEST = register("chest", (builder) -> {
      builder.require(LootContextParameters.POSITION).allow(LootContextParameters.THIS_ENTITY);
   });
   ...
   public static final LootContextType SELECTOR = register("selector", (builder) -> {
      builder.require(LootContextParameters.POSITION).require(LootContextParameters.THIS_ENTITY);
   });
   public static final LootContextType FISHING = register("fishing", (builder) -> {
      builder.require(LootContextParameters.POSITION).require(LootContextParameters.TOOL);
   });
   public static final LootContextType ENTITY = register("entity", (builder) -> {
      builder.require(LootContextParameters.THIS_ENTITY).require(LootContextParameters.POSITION).require(LootContextParameters.DAMAGE_SOURCE).allow(LootContextParameters.KILLER_ENTITY).allow(LootContextParameters.DIRECT_KILLER_ENTITY).allow(LootContextParameters.LAST_DAMAGE_PLAYER);
   });
   ...
   public static final LootContextType ADVANCEMENT_REWARD = register("advancement_reward", (builder) -> {
      builder.require(LootContextParameters.THIS_ENTITY).require(LootContextParameters.POSITION);
   });
   ...
   public static final LootContextType BLOCK = register("block", (builder) -> {
      builder.require(LootContextParameters.BLOCK_STATE).require(LootContextParameters.POSITION).require(LootContextParameters.TOOL).allow(LootContextParameters.THIS_ENTITY).allow(LootContextParameters.BLOCK_ENTITY).allow(LootContextParameters.EXPLOSION_RADIUS);
   });
