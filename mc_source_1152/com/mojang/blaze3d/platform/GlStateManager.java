...
public class GlStateManager {
   ...
   private static final GlStateManager.CapabilityTracker[] LIGHT_ENABLE = (GlStateManager.CapabilityTracker[])IntStream.range(0, 8).mapToObj((i) -> {
      return new GlStateManager.CapabilityTracker(16384 + i);
   }).toArray((i) -> {
      return new GlStateManager.CapabilityTracker[i];
   });
   ...
   private static final Vector3f DIFFUSE_LIGHT_0_POSITION = (Vector3f)Util.make(new Vector3f(0.2F, 1.0F, -0.7F), Vector3f::normalize);
   private static final Vector3f DIFFUSE_LIGHT_1_POSITION = (Vector3f)Util.make(new Vector3f(-0.2F, 1.0F, 0.7F), Vector3f::normalize);
   private static int activeTexture;
   private static final GlStateManager.Texture2DState[] TEXTURES = (GlStateManager.Texture2DState[])IntStream.range(0, 8).mapToObj((i) -> {
      return new GlStateManager.Texture2DState();
   }).toArray((i) -> {
      return new GlStateManager.Texture2DState[i];
   });
   ...
   public static void deleteTexture(int texture) {
      ...
      GlStateManager.Texture2DState[] var1 = TEXTURES;
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         GlStateManager.Texture2DState texture2DState = var1[var3];
   ...
   static class TexGenState {
      public final GlStateManager.TexGenCoordState s;
      public final GlStateManager.TexGenCoordState t;
      public final GlStateManager.TexGenCoordState r;
      public final GlStateManager.TexGenCoordState q;

      private TexGenState() {
         this.s = new GlStateManager.TexGenCoordState(8192, 3168);
         this.t = new GlStateManager.TexGenCoordState(8193, 3169);
         this.r = new GlStateManager.TexGenCoordState(8194, 3170);
         this.q = new GlStateManager.TexGenCoordState(8195, 3171);
      }
   }

   @Environment(EnvType.CLIENT)
   static class StencilState {
      public final GlStateManager.StencilSubState subState;
      public int mask;
      public int sfail;
      public int dpfail;
      public int dppass;
      ...
      private StencilState() {
         this.subState = new GlStateManager.StencilSubState();
         this.mask = -1;
         this.sfail = 7680;
         this.dpfail = 7680;
         this.dppass = 7680;
   ...
   static class ClearState {
      ...
      public final GlStateManager.Color4 clearColor;
      public int clearStencil;

      private ClearState() {
         this.clearDepth = 1.0D;
         this.clearColor = new GlStateManager.Color4(0.0F, 0.0F, 0.0F, 0.0F);
      }
   }
   ...
   static class LogicOpState {
      ...
      private LogicOpState() {
         this.capState = new GlStateManager.CapabilityTracker(3058);
         this.op = 5379;
      }
   }
   ...
   static class PolygonOffsetState {
      public final GlStateManager.CapabilityTracker capFill;
      public final GlStateManager.CapabilityTracker capLine;
      public float factor;
      public float units;

      private PolygonOffsetState() {
         this.capFill = new GlStateManager.CapabilityTracker(32823);
         this.capLine = new GlStateManager.CapabilityTracker(10754);
      }
   }
   ...
   static class CullFaceState {
      ...
      private CullFaceState() {
         this.capState = new GlStateManager.CapabilityTracker(2884);
         this.mode = 1029;
      }
   }
   ...
   static class FogState {
      ...
      private FogState() {
         this.capState = new GlStateManager.CapabilityTracker(2912);
         this.mode = 2048;
         this.density = 1.0F;
         this.end = 1.0F;
      }
   ...
   static class DepthTestState {
      ...
      private DepthTestState() {
         this.capState = new GlStateManager.CapabilityTracker(2929);
         this.mask = true;
         this.func = 513;
      }
   }
   ...
   static class BlendFuncState {
      ...
      private BlendFuncState() {
         this.capState = new GlStateManager.CapabilityTracker(3042);
         this.srcFactorRGB = 1;
         this.dstFactorRGB = 0;
   ...
   static class ColorMaterialState {
      ...
      private ColorMaterialState() {
         this.capState = new GlStateManager.CapabilityTracker(2903);
         this.face = 1032;
         this.mode = 5634;
      }
   }
   ...
   static class AlphaTestState {
      ...
      private AlphaTestState() {
         this.capState = new GlStateManager.CapabilityTracker(3008);
         this.func = 519;
         this.ref = -1.0F;
      }
   }
   ...
   static class Texture2DState {
      ...
      private Texture2DState() {
         this.capState = new GlStateManager.CapabilityTracker(3553);
      }
   }
