   ...
   public void init() {
      ...
      if (this.worldType.equals(RealmsServer.WorldType.NORMAL)) {
         ...
         if (this.worldType.equals(RealmsServer.WorldType.ADVENTUREMAP)) {
            string3 = getLocalizedString("mco.configure.world.edit.subscreen.adventuremap");
         } else if (this.worldType.equals(RealmsServer.WorldType.INSPIRATION)) {
            string3 = getLocalizedString("mco.configure.world.edit.subscreen.inspiration");
         } else {
            string3 = getLocalizedString("mco.configure.world.edit.subscreen.experience");
         }

         this.field_20502 = new RealmsLabel(string3, this.width() / 2, 26, 16711680);
         this.pvp = true;
