...
public class RealmsBackupScreen extends RealmsScreen {
         ...
         public void run() {
            ...
            try {
               ...
               Realms.execute(() -> {
                  ...
                  while(var2.hasNext()) {
                     Backup backup = (Backup)var2.next();
   ...
   private void downloadWorldData() {
      RealmsTasks.DownloadTask downloadTask = new RealmsTasks.DownloadTask(this.serverData.id, this.slotId, this.serverData.name + " (" + ((RealmsWorldOptions)this.serverData.slots.get(this.serverData.activeSlot)).getSlotName(this.serverData.activeSlot) + ")", this);
