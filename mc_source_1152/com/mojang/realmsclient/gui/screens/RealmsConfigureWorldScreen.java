...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback<WorldTemplate> implements RealmsWorldSlotButton.Listener {
   ...
   public void init() {
      ...
      this.buttonsAdd(this.subscriptionButton = new RealmsButton(4, this.centerButton(2, 3), RealmsConstants.row(0), 100, 20, getLocalizedString("mco.configure.world.buttons.subscription")) {
         public void onPress() {
            Realms.setScreen(new RealmsSubscriptionInfoScreen(RealmsConfigureWorldScreen.this, RealmsConfigureWorldScreen.this.field_20493.clone(), RealmsConfigureWorldScreen.this.lastScreen));
         }
      });
      ...
      this.buttonsAdd(this.optionsButton = new RealmsButton(5, this.leftButton(0), RealmsConstants.row(13) - 5, 90, 20, getLocalizedString("mco.configure.world.buttons.options")) {
         public void onPress() {
            Realms.setScreen(new RealmsSlotOptionsScreen(RealmsConfigureWorldScreen.this, ((RealmsWorldOptions)RealmsConfigureWorldScreen.this.field_20493.slots.get(RealmsConfigureWorldScreen.this.field_20493.activeSlot)).clone(), RealmsConfigureWorldScreen.this.field_20493.worldType, RealmsConfigureWorldScreen.this.field_20493.activeSlot));
         }
      });
      this.buttonsAdd(this.backupButton = new RealmsButton(6, this.leftButton(1), RealmsConstants.row(13) - 5, 90, 20, getLocalizedString("mco.configure.world.backup")) {
         public void onPress() {
            Realms.setScreen(new RealmsBackupScreen(RealmsConfigureWorldScreen.this, RealmsConfigureWorldScreen.this.field_20493.clone(), RealmsConfigureWorldScreen.this.field_20493.activeSlot));
         }
      });
      this.buttonsAdd(this.resetWorldButton = new RealmsButton(7, this.leftButton(2), RealmsConstants.row(13) - 5, 90, 20, getLocalizedString("mco.configure.world.buttons.resetworld")) {
         public void onPress() {
            Realms.setScreen(new RealmsResetWorldScreen(RealmsConfigureWorldScreen.this, RealmsConfigureWorldScreen.this.field_20493.clone(), RealmsConfigureWorldScreen.this.getNewScreen()));
         }
      });
   ...
   private void addSlotButton(int i) {
      ...
      int l = 100 + i;
      RealmsWorldSlotButton realmsWorldSlotButton = new RealmsWorldSlotButton(j, k, 80, 80, () -> {
   ...
   public void render(int xm, int ym, float a) {
      ...
      if (this.field_20493 == null) {
         ...
         if (this.isMinigame()) {
            this.drawString(getLocalizedString("mco.configure.current.minigame") + ": " + this.field_20493.getMinigameName(), this.left_x + 80 + 20 + 10, RealmsConstants.row(13), 16777215);
         }
   ...
   private void switchToEmptySlot(int selectedSlot, RealmsServer serverData) {
      ...
      Realms.setScreen(new RealmsLongConfirmationScreen((bl, j) -> {
         if (bl) {
            RealmsResetWorldScreen realmsResetWorldScreen = new RealmsResetWorldScreen(this, serverData, this.getNewScreen(), getLocalizedString("mco.configure.world.switch.slot"), getLocalizedString("mco.configure.world.switch.slot.subtitle"), 10526880, getLocalizedString("gui.cancel"));
   ...
   private void switchSlot(long worldId, int selectedSlot) {
      ...
      RealmsTasks.SwitchSlotTask switchSlotTask = new RealmsTasks.SwitchSlotTask(worldId, selectedSlot, (bl, i) -> {
