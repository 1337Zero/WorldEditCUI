...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   private void drawProgressBar() {
      double d = this.uploadStatus.bytesWritten.doubleValue() / this.uploadStatus.totalBytes.doubleValue() * 100.0D;
      if (d > 100.0D) {
         d = 100.0D;
      }
      ...
      tezzelator.vertex(e - 0.5D, 95.5D, 0.0D).color(217, 210, 210, 255).endVertex();
      tezzelator.vertex(e + 200.0D * d / 100.0D + 0.5D, 95.5D, 0.0D).color(217, 210, 210, 255).endVertex();
      tezzelator.vertex(e + 200.0D * d / 100.0D + 0.5D, 79.5D, 0.0D).color(217, 210, 210, 255).endVertex();
      tezzelator.vertex(e - 0.5D, 79.5D, 0.0D).color(217, 210, 210, 255).endVertex();
      tezzelator.vertex(e, 95.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      tezzelator.vertex(e + 200.0D * d / 100.0D, 95.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      tezzelator.vertex(e + 200.0D * d / 100.0D, 80.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      tezzelator.vertex(e, 80.0D, 0.0D).color(128, 128, 128, 255).endVertex();
      tezzelator.end();
   ...
   public static String humanReadableByteCount(long bytes) {
      ...
      if (bytes < 1024L) {
         ...
         return String.format(Locale.ROOT, "%.1f %sB/s", (double)bytes / Math.pow(1024.0D, (double)j), string);
      }
   }
   ...
   public static double convertToUnit(long bytes, RealmsUploadScreen.Unit unit) {
      return unit.equals(RealmsUploadScreen.Unit.B) ? (double)bytes : (double)bytes / Math.pow(1024.0D, (double)unit.ordinal());
   }
